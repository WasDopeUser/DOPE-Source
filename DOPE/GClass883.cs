...
public class GClass883 : StatisticsCategory
{
	...
	public GClass883(Dictionary<string, GClass883.GStruct0> dictionary_1)
	{
	...
	public override void Update()
	{
		...
		lock (deathLog)
		{
			foreach (KeyValuePair<string, GClass883.GStruct0> keyValuePair in this.DeathLog)
			{
				GClass883.<>c__DisplayClass8_0 CS$<>8__locals1 = new GClass883.<>c__DisplayClass8_0();
	...
	[CompilerGenerated]
	private Dictionary<string, GClass883.GStruct0> dictionary_0;
