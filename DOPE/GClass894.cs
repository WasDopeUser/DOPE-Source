...
public abstract class GClass894 : GClass891
{
	...
	public GClass894(GClass889 gclass889_1, TargetMap targetMap_1, string string_1, int int_2 = -2147483648)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor(gclass889_1, string_1 + "_" + targetMap_1.GetName(), int_2);
		this.Map = targetMap_1;
	}

	public override MapProfile UpdateProfile(BotProfile botProfile_1)
	{
		GClass894.<>c__DisplayClass5_0 CS$<>8__locals1 = new GClass894.<>c__DisplayClass5_0();
