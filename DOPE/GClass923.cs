...
public class GClass923 : EntangledHostedObjectBase, INotifyPropertyChanged, GInterface8
{
	...
	private Task<hhXl8M2rvypufCIejJb> method_5<hhXl8M2rvypufCIejJb>(string string_2, Func<GClass922, Task<hhXl8M2rvypufCIejJb>> func_0)
	{
		GClass922 gclass = this.Bot(string_2);
		if (gclass == null)
		{
			return Task.FromResult<hhXl8M2rvypufCIejJb>(default(hhXl8M2rvypufCIejJb));
		}
