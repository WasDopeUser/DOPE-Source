...
public abstract class GClass837
{
	public GClass824 Context { get; protected set; }
	...
	public GClass837(GClass824 gclass824_1)
	{
	...
	{
		GClass837.<>c__DisplayClass13_0 CS$<>8__locals1;
	...
	{
		GClass837.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass837_0 = this;
	...
	public virtual void vmethod_11(NpcShip npcShip_0)
	{
		...
		npcShip_0.Range = SecurityManager.smethod_2(npcShip_0);
	}
	...
	public virtual bool vmethod_19(GClass826 gclass826_0)
	{
		return true;
	}
	...
	{
		GClass837.<>c__DisplayClass33_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass33_0();
		...
		if (bool_3)
		{
			GClass837.<>c__DisplayClass33_1 CS$<>8__locals2 = new GClass837.<>c__DisplayClass33_1();
			...
			if (ship != null)
			{
				...
				gate_0 = CS$<>8__locals2.<>c__DisplayClass33_0_0.map_0.Gates.Where(new Func<KeyValuePair<int, Gate>, bool>(GClass837.<>c.<>c_0.method_0)).OrderByDescending(new Func<KeyValuePair<int, Gate>, float>(CS$<>8__locals2.method_1)).FirstOrDefault<KeyValuePair<int, Gate>>().Value;
				Gate gate = gate_0;
	...
	{
		GClass837.<>c__DisplayClass35_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass35_0();
		CS$<>8__locals1.hero_0 = this.C.Hero;
	...
	{
		GClass837.<>c__DisplayClass38_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass38_0();
		CS$<>8__locals1.gclass837_0 = this;
		...
		if (flag)
		{
			return this.Map.Gates.FirstOrDefault(new Func<KeyValuePair<int, Gate>, bool>(CS$<>8__locals1.deMokIpYlYf)).Value;
		}
	...
	{
		GClass837.<>c__DisplayClass44_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass44_0();
		CS$<>8__locals1.gclass837_0 = this;
		int_1 = 0;
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		...
		using (IEnumerator<SelectedNpcModel> enumerator = this.C.MapProfile.NpcWhitelist.GetEnumerator())
		{
			...
			{
				GClass837.<>c__DisplayClass44_1 CS$<>8__locals2 = new GClass837.<>c__DisplayClass44_1();
		...
		int_1 = list.OrderByDescending(new Func<ValueTuple<int, int>, bool>(CS$<>8__locals1.method_0)).ThenBy(new Func<ValueTuple<int, int>, DateTimeOffset>(CS$<>8__locals1.method_1)).ThenByDescending(new Func<ValueTuple<int, int>, int>(GClass837.<>c.<>c_0.method_1)).FirstOrDefault<ValueTuple<int, int>>().Item1;
		return int_1 != 0;
	}

	protected virtual bool vmethod_32()
	{
		GClass837.<>c__DisplayClass45_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass45_0();
		CS$<>8__locals1.gclass837_0 = this;
		...
		if (enemyLocatorResult_ != null && enemyLocatorResult_.Found)
		{
			...
			{
				CS$<>8__locals1.vector2_0 = this.Hero.Position;
				if (this.Map.method_7<NpcShip>(CS$<>8__locals1.vector2_0, new Func<NpcShip, bool>(CS$<>8__locals1.GwKokyOgdIX), null, 0).Any<ValueTuple<NpcShip, float, int>>())
				{
					return false;
				}
				...
				NpcShip npcShip = this.Map.method_5<NpcShip>(CS$<>8__locals1.vector2_1, new Func<NpcShip, bool>(CS$<>8__locals1.method_0), null, 0);
	...
	{
		GClass837.<>c__DisplayClass56_0 CS$<>8__locals1 = new GClass837.<>c__DisplayClass56_0();
		CS$<>8__locals1.gclass837_0 = this;
		this.method_8(false);
		this.method_1(GroupAttackMode.Disabled);
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		List<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>> source = CS$<>8__locals1.method_0().OrderByDescending(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, int>(GClass837.<>c.<>c_0.method_2)).ToList<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>>();
		ValueTuple<GroupManager.GroupMember, SelectedNpcModel> valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass837.<>c.<>c_0.method_3));
		...
		IL_112:
		valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass837.<>c.<>c_0.method_4));
		if (valueTuple.Item2 != null)
		{
			this.method_8(true);
			this.method_3(valueTuple.Item1.Position);
	...
	})] List<ValueTuple<Vector2, int>> npcs)
	{
		...
		foreach (ValueTuple<Vector2, int> valueTuple in npcs)
		{
			float num2 = Math.Max(0f, (float)((double)valueTuple.Item2 - GClass812.smethod_13(vector2_1, vector2_2, valueTuple.Item1, true)));
	...
	{
		Vector2 vector2_3 = GClass807.smethod_0(vector2_1, vector2_2, float_0, nullable_0, float_1);
	...
	{
		GClass837.<>c__DisplayClass62_0 CS$<>8__locals1;
	...
	public virtual Vector2? vmethod_45(Vector2 vector2_1)
	{
		...
		if ((lastControlDisabled > this.Hero.LastTookDamage || (this.Hero.LastTookDamage - lastControlDisabled).TotalMilliseconds <= (double)num) && (npcShip == null || !this.vmethod_12(npcShip)))
		{
			...
			Vector2 vector2_3 = GClass807.smethod_8(position, 100f, num2 + 0.6f);
	...
	{
		GClass837.<>c__DisplayClass69_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass837_0 = this;
	...
	{
		this.method_12(-1);
		this.method_6(!this.C.method_72());
		this.method_4();
	...
	public virtual IEnumerable<string> vmethod_49()
	{
	...
	[CompilerGenerated]
	private void method_17(double double_0, ref GClass837.<>c__DisplayClass13_0 <>c__DisplayClass13_0_0)
	{
		this.C.NpcLockout.method_1(<>c__DisplayClass13_0_0.ship_0.Id, double_0 * 10000.0);
	}

	[CompilerGenerated]
	private Vector2 method_18(float float_0, ref GClass837.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return GClass807.smethod_8(<>c__DisplayClass62_0_0.vector2_0, <>c__DisplayClass62_0_0.float_0, <>c__DisplayClass62_0_0.float_1 + float_0);
	}

	[CompilerGenerated]
	private float method_19(Vector2 vector2_1, ref GClass837.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return this.vmethod_35(vector2_1) + this.vmethod_36(vector2_1, <>c__DisplayClass62_0_0.list_0);
	}

	[CompilerGenerated]
	private float method_20(ref GClass837.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
	...
	[CompilerGenerated]
	private void method_21(ref GClass837.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
