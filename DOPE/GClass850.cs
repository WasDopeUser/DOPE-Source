...
public class GClass850 : GClass847
{
	[CompilerGenerated]
	...
	public GClass850(GClass823 gclass823_1)
	{
		Class13.Gj4N3WdzaR1LY();
		base..ctor(gclass823_1, "GgSpinner");
	}
	...
	protected void method_4()
	{
		foreach (DarkOrbitWebAPI.jumpgateGate jumpgateGate in this.method_2().gates)
		{
			if (jumpgateGate.current == jumpgateGate.total && !jumpgateGate.prepared)
			{
				bool argument = false;
				string text;
				string argument2 = GClass850.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
	...
	protected bool method_6(out string string_0, out int int_0)
	{
		...
		if (account != null && account.Spinner_StopABG)
		{
			...
			{
				string text;
				string a = GClass850.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
		...
		{
			string text3;
			string text2 = GClass850.dictionary_0.TryGetValue(jumpgateGate2.id, out text3) ? text3 : "unknown";
			bool flag2;
	...
	public int method_7()
	{
		...
		GClass823 context = base.Context;
	...
	{
		GClass850.<>c__DisplayClass12_0 CS$<>8__locals1 = new GClass850.<>c__DisplayClass12_0();
		int_0 = 0;
		int num;
		...
		{
			GClass813.smethod_6(web.Server, web.Uid, web.Sid, "multiEnergy"),
	...
	{
		DarkOrbitWebAPI web = base.Context.Game.Web;
		return web.Get(GClass813.smethod_6(web.Server, web.Uid, web.Sid, "setupGate") + "&gateID=" + int_0.ToString(), null).Data.IsSuccessStatusCode;
	}
	...
	protected bool method_11(DarkOrbitWebAPI.GalaxyGatesInfoUpdate galaxyGatesInfoUpdate_0)
	{
		...
		{
			GClass850.<>c__DisplayClass15_0 CS$<>8__locals1 = new GClass850.<>c__DisplayClass15_0();
		...
		{
			GClass850.<>c__DisplayClass15_1 CS$<>8__locals2 = new GClass850.<>c__DisplayClass15_1();
	...
	public override bool vmethod_0()
	{
		...
		AccountSettings account = base.Context.Account;
		return account == null || !account.Spinner_UsePhoenix || GClass826.list_0.Contains(activeHangarName);
	}
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass850.dictionary_0 = new Dictionary<int, string>
		{
			{
				1,
				"alpha"
