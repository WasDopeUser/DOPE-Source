...
public class GClass914 : GClass904
{
	...
	{
		return base.vmethod_22() && !base.Map.Gates.Any<KeyValuePair<int, Gate>>();
	}
	...
	public virtual int sLujkngyrgj()
	{
		if (base.Map.GG != (GEnum5)300)
		{
			return 100;
	...
	public override bool udVjkhArbOf(NpcShip npcShip_0)
	{
		bool flag;
		return npcShip_0 != null && (npcShip_0.HpPercentage <= 24.75f || base.Map.method_8(npcShip_0, out flag));
	}

	protected virtual bool vmethod_47(Ship ship_0, Ship ship_1)
	{
		int num = this.sLujkngyrgj();
		bool flag = ship_1 != null && this.udVjkhArbOf(ship_0 as NpcShip) && !this.udVjkhArbOf(ship_1 as NpcShip);
	...
	public override bool vmethod_1(Ship ship_0, out Ship ship_1)
	{
		...
		if (ship_0 != null)
		{
			NpcShip npcShip = base.Context.IqfQqchDeZQ(200);
			CooldownTracker<BotAction> cooldowns = base.Context.Cooldowns;
			if (npcShip != null && cooldowns.method_0(BotAction.SelectShip) && cooldowns.method_0(BotAction.TargetQuickSwitch) && npcShip != ship_0 && this.vmethod_47(ship_0, npcShip))
			{
		...
		if (base.C.AttackingId == ship_0.Id && this.vmethod_46(ship_0 as NpcShip) && ship_0.HpPercentage < 24.75f && base.C.float_0 >= 24.75f && base.C.method_73().Any(new Func<NpcShip, bool>(this.method_39)))
		{
	...
	{
		return base.JrfjkaWvhk8(collectible_0) && !this.method_23();
	}

	public override bool vmethod_12()
	{
		return !base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass914.<>c.<>c_0.method_0)) && base.C.Map.Gates.Any<KeyValuePair<int, Gate>>() && !base.C.method_75() && base.C.DormantTargets.Count == 0 && base.C.Game.Web.GgInfo != null;
	}

	public override bool vmethod_20(out Vector2? nullable_0)
	{
		...
		return base.vmethod_20(out nullable_0);
	}
	...
	public override Vector2? vmethod_16(Vector2 vector2_1, out Gate gate_0, bool bool_8 = false, bool bool_9 = true)
	{
	...
	public override Vector2? vmethod_17(bool bool_8)
	{
		...
		{
			vector = this.vmethod_34(CS$<>8__locals1.vector2_0, base.C.Map.Center, (float)base.C.Map.MapSize.Height * 0.4f, null, this.method_31() ? -0.5f : 0.5f);
		}
		else
		{
			CS$<>8__locals1.vector2_1 = (this.vmethod_36(CS$<>8__locals1.vector2_0, 2250) ?? base.C.Map.Center);
		...
		return new Vector2?(vector ?? base.C.Game.Security.method_5(base.Map, this.vmethod_13()));
	}
	...
	public override SelectedNpcModel RvcjkXariys(Ship ship_0)
	{
	...
	{
		return !this.udVjkhArbOf(npcShip_0) && Vector2.Distance(npcShip_0.method_1(50), vector2_1) < Vector2.Distance(npcShip_0.MovementSource, vector2_1);
	}
	...
	public override bool vmethod_26()
	{
		...
		bool flag = false;
		SelectedNpcModel selectedNpcModel = this.RvcjkXariys(enemyTarget);
	...
	protected virtual bool vmethod_49()
	{
	...
	protected override KamikazeState vmethod_25()
	{
		KamikazeState kamikazeState = base.vmethod_25();
	...
	public override bool vmethod_27(out int int_1)
	{
		int_1 = 0;
		return false;
	}

	public override Vector2? vmethod_41(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		if (!this.method_27())
		{
			return base.vmethod_41(vector2_1, npcShip_0, nullable_0, float_0);
		}
		Vector2? vector = this.vmethod_36(vector2_1, 1100);
		Vector2 vector2;
		int num = this.vmethod_38(vector2_1, npcShip_0, out vector2);
		...
		{
			return base.vmethod_41(vector2_1, npcShip_0, new Vector2?(value2), 0.5f);
		}
		return base.vmethod_41(vector2_1, npcShip_0, null, 0.5f);
	}
	...
	protected virtual bool vmethod_50()
	{
	...
	{
		this.method_36(this.vmethod_49());
		base.Update();
		this.method_28(this.vmethod_50());
