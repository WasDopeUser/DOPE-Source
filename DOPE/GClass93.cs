...
public class GClass93
{
	...
	[CompilerGenerated]
	private void PrdjGptpo1(int int_1)
	{
		this.int_0 = int_1;
	}
	...
	[CompilerGenerated]
	public GClass84<GClass854> method_3()
	{
		return this.gclass84_0;
	}

	[CompilerGenerated]
	private void method_4(GClass84<GClass854> gclass84_1)
	{
	...
	public GClass93(ConnectionManager connectionManager_1)
	{
		...
		this.method_4(new GClass84<GClass854>(connectionManager_1));
		this.method_3().method_1(new Action<GInterface0>(GClass82.smethod_3));
		GClass82.smethod_2();
	}
	...
	public void Connect(string host, int port, bool forceNonLoopback = true, ProxySettings proxy = null)
	{
		...
		{
			this.Host = host;
			this.PrdjGptpo1(port);
			this.method_6(forceNonLoopback, proxy);
		}
	}

	private void method_6(bool bool_2, ProxySettings proxySettings_0)
	{
	...
	{
		this.Socket.Connected += this.method_10;
		this.Socket.method_1(new GClass91.GClass92.GDelegate7(this.method_9));
		this.Socket.Disconnected += this.method_8;
	}

	private void method_8(GClass91 gclass91_1, ErrorReason errorReason_0, Exception exception_0)
	{
		if (!this.bool_1)
		{
	...
	private void method_9(GClass91 gclass91_1, BinaryStream binaryStream_0, byte[] byte_0, int int_1)
	{
		if (!this.bjDjnuEhBy())
		{
			this.method_3().method_12(binaryStream_0, byte_0, int_1);
		}
	}

	private void method_10(GClass91 gclass91_1)
	{
		this.bool_1 = false;
	...
	{
		this.method_3().method_9(this.Socket, new GClass855());
	}
	...
	{
		this.Socket.Connected -= this.method_10;
		this.Socket.method_2(new GClass91.GClass92.GDelegate7(this.method_9));
		this.Socket.Disconnected -= this.method_8;
	}

	public void method_13(GInterface0 ginterface0_0)
	{
		if (this.method_1())
		{
			this.method_3().SendMessage(ginterface0_0);
		}
	}
	...
	[CompilerGenerated]
	private GClass84<GClass854> gclass84_0;
