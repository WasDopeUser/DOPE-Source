...
public class GClass93
{
	...
	[CompilerGenerated]
	public GClass84<GClass790> method_5()
	{
		return this.gclass84_0;
	}

	[CompilerGenerated]
	private void method_6(GClass84<GClass790> gclass84_1)
	{
	...
	public GClass93(ConnectionManager connectionManager_1)
	{
		...
		this.method_6(new GClass84<GClass790>(connectionManager_1));
	...
	private void LttLiihyYn()
	{
		this.Socket.Connected += this.method_11;
		this.Socket.method_1(new GClass91.GClass92.GDelegate7(this.method_10));
		this.Socket.Disconnected += this.method_9;
	}

	private void method_9(GClass91 gclass91_1, ErrorReason errorReason_0, Exception exception_0)
	{
		if (!this.bool_1)
		{
	...
	private void method_10(GClass91 gclass91_1, BinaryStream binaryStream_0, byte[] byte_0, int int_1)
	{
		if (!this.method_3())
		{
	...
	private void method_11(GClass91 gclass91_1)
	{
		this.bool_1 = false;
	...
	{
		this.method_5().method_9(this.Socket, new GClass791());
	}
	...
	{
		this.Socket.Connected -= this.method_11;
		this.Socket.method_2(new GClass91.GClass92.GDelegate7(this.method_10));
		this.Socket.Disconnected -= this.method_9;
	}

	public void method_14(GInterface0 ginterface0_0)
	{
		if (this.method_2())
		{
	...
	[CompilerGenerated]
	private GClass84<GClass790> gclass84_0;
