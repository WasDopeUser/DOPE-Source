...
public class GClass93
{
	...
	{
		return this.VbefrOdwde;
	}

	[CompilerGenerated]
	private void method_4(bool bool_1)
	{
		this.VbefrOdwde = bool_1;
	}

	[CompilerGenerated]
	public GClass84<GClass789> method_5()
	{
		return this.gclass84_0;
	}

	[CompilerGenerated]
	private void method_6(GClass84<GClass789> gclass84_1)
	{
	...
	public GClass93(ConnectionManager connectionManager_1)
	{
		...
		this.method_6(new GClass84<GClass789>(connectionManager_1));
	...
	private void method_8(bool bool_1, ProxySettings proxySettings_0)
	{
		...
		try
		{
			...
			this.method_13();
			this.method_9();
			this.Socket.Connect(this.Host, this.method_0(), bool_1, proxySettings_0);
		}
		catch (Exception)
		{
			GClass91 socket = this.Socket;
	...
	{
		this.method_5().method_9(this.Socket, new GClass790());
	}
	...
	[CompilerGenerated]
	private bool VbefrOdwde;

	[CompilerGenerated]
	private GClass84<GClass789> gclass84_0;
