...
public class GClass882 : StatisticsCategory
{
	...
	public GClass882(string string_0, Dictionary<string, int> dictionary_1)
	{
	...
	public override void Update()
	{
		...
		lock (count)
		{
			...
			{
				GClass882.<>c__DisplayClass6_0 CS$<>8__locals1 = new GClass882.<>c__DisplayClass6_0();
