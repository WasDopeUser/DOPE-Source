...
public class GClass932 : INotifyPropertyChanged
{
	...
	protected void method_3<xVMPI6DETZ68IZGcf6G>(ref xVMPI6DETZ68IZGcf6G gparam_0, xVMPI6DETZ68IZGcf6G VDJ3OCDtk4UhoZwsaOH, string string_1 = null, [CallerMemberName] string name = null)
	{
		if (!EqualityComparer<xVMPI6DETZ68IZGcf6G>.Default.Equals(gparam_0, VDJ3OCDtk4UhoZwsaOH))
		{
			gparam_0 = VDJ3OCDtk4UhoZwsaOH;
	...
	public void method_4(TcpClient tcpClient_0)
	{
		...
		this.bool_0 = false;
		this.bool_3 = true;
		this.gclass84_0.method_9(this.gclass91_0, new GClass857());
		this.gclass91_0.Connected += this.method_5;
		this.gclass91_0.Disconnected += this.method_6;
		this.gclass91_0.method_1(new GClass91.GClass92.GDelegate7(this.method_10));
	...
	private void method_6(GClass91 gclass91_1, ErrorReason errorReason_0, Exception exception_0)
	{
		...
		this.gameManager_0.Connection.Socket.method_3().method_1(new Action<GInterface0>(GClass82.smethod_3));
	...
	private void method_10(GClass91 gclass91_1, BinaryStream binaryStream_0, byte[] byte_0, int int_0)
	{
	...
	private void method_11()
	{
		if (this.commandDispatcher_0 == null)
		{
			...
			this.commandDispatcher_0.method_1<GClass278>(new Action<GClass278>(this.method_17));
			this.commandDispatcher_0.method_1<GClass238>(new Action<GClass238>(this.method_14));
			this.commandDispatcher_0.method_1<GClass146>(new Action<GClass146>(this.method_18));
			this.commandDispatcher_0.method_1<GClass235>(new Action<GClass235>(this.method_19));
	...
	private void method_12()
	{
		if (this.commandDispatcher_1 == null)
		{
			...
			this.commandDispatcher_1.method_1<GClass260>(new Action<GClass260>(this.method_24));
			this.commandDispatcher_1.method_1<GClass279>(new Action<GClass279>(this.method_25));
			this.commandDispatcher_1.method_1<GClass268>(new Action<GClass268>(this.method_13));
		}
		GameManager gameManager = this.gameManager_0;
		...
		if (gameManager != null)
		{
			...
			if (connection != null)
			{
				...
				if (socket != null)
				{
					GClass84<GClass854> gclass = socket.method_3();
					if (gclass != null)
					{
		...
		{
			this.gameManager_0.Connection.Socket.method_3().method_1(new Action<GInterface0>(this.method_8));
			this.method_16();
		}
	}

	private void method_13(GClass268 gclass268_0)
	{
		string[] array;
	...
	private void method_14(GClass238 gclass238_0)
	{
		this.bool_2 = false;
		IPErkavaBotController iperkavaBotController;
	...
	private void method_15(GClass91 gclass91_1, ErrorReason errorReason_0, Exception exception_0 = null)
	{
	...
	private void method_17(GClass278 gclass278_0)
	{
		GClass279 gclass = new GClass279("2288b5adc1b3377c217c9e212e024300", false);
		if (gclass278_0.string_0 != "2288b5adc1b3377c217c9e212e024300")
		{
			gclass.bool_0 = false;
		}
		else
	...
	[CompilerGenerated]
	private void method_19(GClass235 gclass235_0)
	{
		this.bool_2 = false;
	...
	private void method_20(GClass147 gclass147_0)
	{
		...
		GClass268 ginterface0_ = new GClass268(gclass147_0.string_0.Substring(3));
	...
	{
		this.Game.Hero.Pet.Mode = (PetMode)gclass163_0.gclass256_0.Mode;
	...
	private void method_23(GClass172 gclass172_0)
	{
		...
		{
			gclass172_0.CsyIaJbmBQ + "-type-" + gclass172_0.int_0.ToString()
		});
	}

	[CompilerGenerated]
	private void method_24(GClass260 gclass260_0)
	{
		this.bool_1 = false;
	}

	[CompilerGenerated]
	private void method_25(GClass279 gclass279_0)
	{
		this.bool_1 = false;
	}
