...
public sealed class GClass878 : IDisposable
{
	...
	public GClass878()
	{
		...
		this.window_0 = new GClass878.Window();
		base..ctor();
	...
	private GClass878.Window window_0;
	...
	private class Window : NativeWindow, IDisposable
	{
		...
		{
			base.WndProc(ref m);
			if (m.Msg == GClass878.Window.int_0)
			{
