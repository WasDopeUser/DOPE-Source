...
public class GClass853 : GClass848
{
	...
	public GClass853(GClass824 gclass824_1)
	{
		Class13.igxcIukzfpare();
		this.bool_1 = true;
		base..ctor(gclass824_1, "SkylabWorker");
	}
	...
	public void method_4()
	{
		...
		DateTimeOffset? dateTimeOffset = skylab.fTpxXpfta4().method_5();
		skylab.method_0().GetAwaiter().GetResult();
		DateTimeOffset? dateTimeOffset2 = skylab.fTpxXpfta4().method_5();
		if (dateTimeOffset != null && dateTimeOffset2 == null)
		{
			base.Log.Info("Transfer complete. Refreshing");
			base.Context.method_61<GClass852>().imethod_1();
			return;
		}
		...
		int num3 = Math.Min(Math.Max(0, skylab_KeepPromerium - num), skylab.fTpxXpfta4().method_2("resource_ore_promerium"));
		int num4 = Math.Min(Math.Max(0, skylab_KeepSeprom - num2), skylab.fTpxXpfta4().method_2("resource_ore_seprom"));
		...
		bool result = skylab.method_1(num3, num4).GetAwaiter().GetResult();
