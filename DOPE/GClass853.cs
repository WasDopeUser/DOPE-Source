...
{
	public GClass839 Context { get; protected set; }
	...
	public Logger Log
	{
		get
		{
			return this.Context.method_69("Behavior");
		}
	}
	...
	{
		GClass853.<>c__DisplayClass13_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass853_0 = this;
	...
	{
		GClass853.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass853_0 = this;
	...
	{
		return this.vmethod_6(npcShip_0) || npcShip_0.LeashedBy <= 0 || this.Hero.Group.jYrndIqmin(npcShip_0.LeashedBy);
	}
	...
	public virtual bool vmethod_19(GClass841 gclass841_0)
	{
		return true;
	}
	...
	{
		GClass853.<>c__DisplayClass33_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass33_0();
		...
		if (bool_3)
		{
			GClass853.<>c__DisplayClass33_1 CS$<>8__locals2 = new GClass853.<>c__DisplayClass33_1();
			...
			if (ship != null)
			{
				...
				gate_0 = CS$<>8__locals2.<>c__DisplayClass33_0_0.map_0.Gates.Where(new Func<KeyValuePair<int, Gate>, bool>(GClass853.<>c.<>c_0.method_0)).OrderByDescending(new Func<KeyValuePair<int, Gate>, float>(CS$<>8__locals2.method_1)).FirstOrDefault<KeyValuePair<int, Gate>>().Value;
				Gate gate = gate_0;
	...
	{
		GClass853.<>c__DisplayClass35_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass35_0();
		CS$<>8__locals1.hero_0 = this.C.Hero;
	...
	public virtual bool vmethod_24(out Vector2? nullable_0)
	{
		...
		foreach (Vector2 vector in this.vmethod_23())
		{
			...
			if (this.Map.Grid.method_12(position, vector, 30, 0) != null)
			{
				return true;
			}
		}
	...
	{
		GClass853.<>c__DisplayClass38_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass38_0();
		CS$<>8__locals1.gclass853_0 = this;
	...
	public virtual bool vmethod_28()
	{
		...
		int num;
		if (state == BotState.Logout || state == BotState.Travel || state == BotState.Repair || state == BotState.Default || this.C.method_76(out num))
		{
			result = false;
		}
		return result;
	...
	{
		GClass853.<>c__DisplayClass44_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass44_0();
		CS$<>8__locals1.gclass853_0 = this;
		int_1 = 0;
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		...
		using (IEnumerator<SelectedNpcModel> enumerator = this.C.MapProfile.NpcWhitelist.GetEnumerator())
		{
			...
			{
				GClass853.<>c__DisplayClass44_1 CS$<>8__locals2 = new GClass853.<>c__DisplayClass44_1();
		...
		int_1 = list.OrderByDescending(new Func<ValueTuple<int, int>, bool>(CS$<>8__locals1.method_0)).ThenBy(new Func<ValueTuple<int, int>, DateTimeOffset>(CS$<>8__locals1.method_1)).ThenByDescending(new Func<ValueTuple<int, int>, int>(GClass853.<>c.<>c_0.method_1)).FirstOrDefault<ValueTuple<int, int>>().Item1;
		return int_1 != 0;
	}

	protected virtual bool vmethod_32()
	{
		GClass853.<>c__DisplayClass45_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass45_0();
		CS$<>8__locals1.gclass853_0 = this;
		...
		if (enemyLocatorResult_ != null && enemyLocatorResult_.Found)
		{
			...
			{
				CS$<>8__locals1.ECRHNWZAJEL = this.Hero.Position;
				if (this.Map.method_7<NpcShip>(CS$<>8__locals1.ECRHNWZAJEL, new Func<NpcShip, bool>(CS$<>8__locals1.method_0), null, 0).Any<ValueTuple<NpcShip, float, int>>())
				{
					return false;
				}
				...
				if (this.method_14().method_2(CS$<>8__locals1.vector2_0, out objectEntry, 1700))
				{
					objectEntry.method_1(CS$<>8__locals1.vector2_0);
					return false;
				}
				NpcShip npcShip = this.Map.method_5<NpcShip>(CS$<>8__locals1.vector2_0, new Func<NpcShip, bool>(CS$<>8__locals1.method_1), null, 0);
				if (npcShip != null && (!this.vmethod_7(npcShip) || !this.vmethod_8(npcShip)))
				{
					...
					this.method_14().method_1(CS$<>8__locals1.vector2_0, 1700);
					return false;
				}
				this.method_9(true);
				if (this.method_12() == -1)
	...
	{
		GClass853.<>c__DisplayClass56_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass56_0();
		CS$<>8__locals1.gclass853_0 = this;
		this.method_9(false);
		this.method_1(GroupAttackMode.Disabled);
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		List<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>> source = CS$<>8__locals1.method_0().OrderByDescending(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, int>(GClass853.<>c.<>c_0.method_2)).ToList<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>>();
		ValueTuple<GroupManager.GroupMember, SelectedNpcModel> valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass853.<>c.<>c_0.method_3));
		...
		IL_112:
		valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass853.<>c.<>c_0.method_4));
		if (valueTuple.Item2 != null)
		{
			this.method_9(true);
			this.method_3(valueTuple.Item1.Position);
	...
	})] List<ValueTuple<Vector2, int>> npcs)
	{
		...
		foreach (ValueTuple<Vector2, int> valueTuple in npcs)
		{
			float num2 = Math.Max(0f, (float)((double)valueTuple.Item2 - GClass827.smethod_13(vector2_1, vector2_2, valueTuple.Item1, true)));
	...
	{
		Vector2 vector2_3 = GClass822.smethod_0(vector2_1, vector2_2, float_0, nullable_0, float_1);
	...
	{
		GClass853.<>c__DisplayClass62_0 CS$<>8__locals1;
		...
		foreach (KeyValuePair<int, Ship> keyValuePair in this.Map.Ships)
		{
			...
			if (npcShip != null)
			{
				CS$<>8__locals1.list_0.Add(new ValueTuple<Vector2, int>(npcShip.VvOumUkog6(200), npcShip.Range));
			}
		}
	...
	public virtual Vector2? vmethod_41(Vector2 vector2_1, int int_1 = 1100)
	{
		...
		foreach (ValueTuple<NpcShip, float, int> valueTuple in this.Map.method_7<NpcShip>(vector2_1, new Func<NpcShip, bool>(this.vmethod_10), null, 200))
		{
			...
			{
				Vector2 vector = valueTuple.Item1.VvOumUkog6(200);
				num += vector.X;
				num2 += vector.Y;
				num3++;
			}
	...
	{
		vector2_2 = npcShip_0.VvOumUkog6(Math.Min(225, 100 + this.C.Game.Connection.PingMs));
		float num = Vector2.Distance(vector2_1, vector2_2);
		int num2 = this.Hero.method_28();
	...
	public virtual Vector2? vmethod_45(Vector2 vector2_1)
	{
		...
		if ((lastControlDisabled > this.Hero.LastTookDamage || (this.Hero.LastTookDamage - lastControlDisabled).TotalMilliseconds <= (double)num) && (npcShip == null || !this.vmethod_12(npcShip)))
		{
			...
			Vector2 vector2_3 = GClass822.smethod_8(position, 100f, num2 + 0.6f);
	...
	{
		GClass853.<>c__DisplayClass69_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass853_0 = this;
		...
		foreach (KeyValuePair<int, Ship> keyValuePair in this.Map.Ships)
		{
			...
			{
				CS$<>8__locals1.list_0.Add(new ValueTuple<Vector2, int>(keyValuePair.Value.VvOumUkog6(200), (keyValuePair.Value as NpcShip).Range));
			}
		}
		...
		for (double num4 = 0.0; num4 < 6.2831853071795862; num4 += num)
		{
			...
			int num5;
			int num6;
			if (this.Map.Grid.afXuUuplYy(CS$<>8__locals1.vector2_0.X, CS$<>8__locals1.vector2_0.Y, out num5, out num6) && (num5 != num2 || num6 != num3))
			{
				num2 = num5;
				num3 = num6;
				if (!this.Map.Grid.method_7(num2, num3))
				{
	...
	{
		GClass853.<>c__DisplayClass70_0 CS$<>8__locals1 = new GClass853.<>c__DisplayClass70_0();
		CS$<>8__locals1.gclass853_0 = this;
		if (this.method_12() != -1)
		{
			return;
		...
		{
			NpcUtils.NpcType.qnTuMsYlVx(NpcUtils.N_Styxus),
			NpcUtils.NpcType.qnTuMsYlVx(NpcUtils.N_Charopos)
		}.Select(new Func<NpcUtils.NpcType, int>(GClass853.<>c.<>c_0.method_5)).ToList<int>();
	...
	public virtual uint vmethod_48()
	{
		MapProfile mapProfile = this.C.MapProfile;
	...
	[CompilerGenerated]
	private void method_18(double double_0, ref GClass853.<>c__DisplayClass13_0 <>c__DisplayClass13_0_0)
	{
		this.C.NpcLockout.method_1(<>c__DisplayClass13_0_0.ship_0.Id, double_0 * 10000.0);
	}

	[CompilerGenerated]
	private Vector2 method_19(float float_0, ref GClass853.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return GClass822.smethod_8(<>c__DisplayClass62_0_0.vector2_0, <>c__DisplayClass62_0_0.float_0, <>c__DisplayClass62_0_0.float_1 + float_0);
	}

	[CompilerGenerated]
	private float method_20(Vector2 vector2_1, ref GClass853.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return this.vmethod_35(vector2_1) + this.vmethod_36(vector2_1, <>c__DisplayClass62_0_0.list_0);
	}

	[CompilerGenerated]
	private float method_21(ref GClass853.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
		return this.vmethod_35(<>c__DisplayClass69_0_0.vector2_0) + this.vmethod_37(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0, <>c__DisplayClass69_0_0.list_0) - Vector2.Distance(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0) * 2f;
	}

	[CompilerGenerated]
	private void method_22(ref GClass853.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
