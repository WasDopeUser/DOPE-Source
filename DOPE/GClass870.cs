...
public class GClass870 : GClass865
{
	...
	public GClass870(GClass839 gclass839_1)
	{
		Class13.NP5bWyNzLwONS();
		this.bool_1 = true;
		base..ctor(gclass839_1, "SkylabWorker");
	}
	...
	public void method_4()
	{
		...
		DateTimeOffset? dateTimeOffset = skylab.method_0().method_4();
		skylab.method_1().GetAwaiter().GetResult();
		DateTimeOffset? dateTimeOffset2 = skylab.method_0().method_4();
		if (dateTimeOffset != null && dateTimeOffset2 == null)
		{
			base.Log.Info("Transfer complete. Refreshing");
			base.Context.method_60<GClass869>().imethod_1();
			return;
		}
		...
		{
			num = (int)hangar.method_1("resource_ore_promerium");
			num2 = (int)hangar.method_1("resource_ore_seprom");
		}
		...
		int num3 = Math.Min(Math.Max(0, skylab_KeepPromerium - num), skylab.method_0().method_1("resource_ore_promerium"));
		int num4 = Math.Min(Math.Max(0, skylab_KeepSeprom - num2), skylab.method_0().method_1("resource_ore_seprom"));
