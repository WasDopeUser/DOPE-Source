...
public class GClass852 : EntangledHostedObjectBase, INotifyPropertyChanged, IBotController
{
	...
	public Task<BasicBotStateInfo> GetBasicBotStateInfo()
	{
		...
		if (botControlState == BotControlState.Running)
		{
			...
			else if (this.Context.Scheduler.Module is GClass825)
			{
	...
	public Task<bool> Start()
	{
		...
		this.method_0();
		foreach (GClass824 gclass in this.Context.Scheduler.list_0)
		{
	...
	{
		GClass852.<>c__DisplayClass27_0 CS$<>8__locals1 = new GClass852.<>c__DisplayClass27_0();
		CS$<>8__locals1.gclass852_0 = this;
		CS$<>8__locals1.float_0 = float_0;
		CS$<>8__locals1.float_1 = float_1;
		CS$<>8__locals1.gclass822_0 = this.Context;
		if (CS$<>8__locals1.gclass822_0.Map.Grid.method_8(CS$<>8__locals1.float_0, CS$<>8__locals1.float_1))
		{
			return false;
		}
		if (Map.Navigators.method_4(new Action<MapNavigator>(CS$<>8__locals1.method_0), -1) && this.Context.CurrentPath != null)
		{
			...
			CS$<>8__locals1.gclass822_0.Server.method_5(vector.X, vector.Y, true);
		}
		return true;
	}
