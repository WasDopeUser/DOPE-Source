...
public class GClass921 : GClass916
{
	...
	public void method_4()
	{
		...
		if (dateTimeOffset != null && dateTimeOffset2 == null)
		{
			...
			base.Context.method_61<GClass920>().imethod_1();
			return;
		}
		...
		if (!base.Context.Game.Connection.Socket.method_1() || !base.Context.Hero.IsInitialized)
		{
		...
		int num3 = Math.Min(Math.Max(0, skylab_KeepPromerium - num), skylab.method_0().opxUviAkXU("resource_ore_promerium"));
		int num4 = Math.Min(Math.Max(0, skylab_KeepSeprom - num2), skylab.method_0().opxUviAkXU("resource_ore_seprom"));
