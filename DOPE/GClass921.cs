...
public class GClass921 : EntangledHostedObjectBase, INotifyPropertyChanged, IBotController
{
	...
	public Task<BasicBotStateInfo> GetBasicBotStateInfo()
	{
		...
		if (botControlState == BotControlState.Running)
		{
			...
			else if (this.Context.Scheduler.Module is GClass892)
			{
	...
	public Task<bool> Start()
	{
		...
		this.method_0();
		foreach (GClass891 gclass in this.Context.Scheduler.list_0)
		{
	...
	public GClass921(Guid guid_0, InterfaceDescriptor interfaceDescriptor_0, ICommon icommon_0)
	{
	...
	{
		MapViewData spacemap = GClass890.smethod_24(this.Context, bool_0 | this.Context.Map.MapId != int_0);
	...
	{
		GClass921.<OnSpacemapClicked>d__26 <OnSpacemapClicked>d__;
		...
		<OnSpacemapClicked>d__.<>t__builder.Start<GClass921.<OnSpacemapClicked>d__26>(ref <OnSpacemapClicked>d__);
		return <OnSpacemapClicked>d__.<>t__builder.Task;
	}

	private bool method_5(float float_0, float float_1)
	{
		GClass921.<>c__DisplayClass27_0 CS$<>8__locals1 = new GClass921.<>c__DisplayClass27_0();
		CS$<>8__locals1.gclass921_0 = this;
		CS$<>8__locals1.float_0 = float_0;
		CS$<>8__locals1.float_1 = float_1;
		CS$<>8__locals1.gclass889_0 = this.Context;
		if (CS$<>8__locals1.gclass889_0.Map.Grid.method_8(CS$<>8__locals1.float_0, CS$<>8__locals1.float_1))
		{
			return false;
		}
		if (Map.Navigators.method_3(new Action<MapNavigator>(CS$<>8__locals1.method_0), -1) && this.Context.CurrentPath != null)
		{
			Vector2 vector = this.Context.CurrentPath.Path.Skip(1).FirstOrDefault<Vector2>();
			CS$<>8__locals1.gclass889_0.Server.method_6(vector.X, vector.Y, true);
		}
		return true;
	}
