...
public class GClass818 : StatisticsCategory
{
	...
	public GClass818(Dictionary<string, GClass818.GStruct0> dictionary_1)
	{
	...
	public override void Update()
	{
		...
		lock (deathLog)
		{
			foreach (KeyValuePair<string, GClass818.GStruct0> keyValuePair in this.DeathLog)
			{
				GClass818.<>c__DisplayClass8_0 CS$<>8__locals1 = new GClass818.<>c__DisplayClass8_0();
	...
	[CompilerGenerated]
	private Dictionary<string, GClass818.GStruct0> dictionary_0;
