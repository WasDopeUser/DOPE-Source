...
public class GClass818 : StatisticsCategory
{
	...
	public GClass818(DarkOrbitWebAPI darkOrbitWebAPI_1)
	{
	...
	public override void Update()
	{
		...
		{
			GClass818.<>c__DisplayClass4_0 CS$<>8__locals1 = new GClass818.<>c__DisplayClass4_0();
			CS$<>8__locals1.jumpgateGate_0 = gates[i];
			string key;
			if (GClass850.dictionary_0.TryGetValue(CS$<>8__locals1.jumpgateGate_0.id, out key))
			{
