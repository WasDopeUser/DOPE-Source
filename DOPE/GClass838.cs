...
{
	public GClass838(GClass823 gclass823_1)
	{
		Class13.Gj4N3WdzaR1LY();
		this.list_0 = new List<Rectangle>();
		base..ctor(gclass823_1);
		this.list_0.Add(GClass838.rectangle_0);
	}
	...
	public override List<Rectangle> vmethod_17()
	{
		...
		if (GClass838.rectangle_0.Contains(pt))
		{
			this.list_0[0] = GClass838.rectangle_0;
		}
		else if (GClass838.rectangle_1.Contains(pt))
		{
			this.list_0[0] = GClass838.rectangle_1;
		}
		else if (GClass838.rectangle_2.Contains(pt))
		{
			this.list_0[0] = GClass838.rectangle_2;
		}
		else
		{
			this.list_0[0] = GClass838.rectangle_3;
		}
		return this.list_0;
	}
	...
	{
		GClass838.<>c__DisplayClass9_0 CS$<>8__locals1 = new GClass838.<>c__DisplayClass9_0();
		CS$<>8__locals1.gclass838_0 = this;
		CS$<>8__locals1.vector2_0 = base.Hero.Position;
		CS$<>8__locals1.vector2_1 = (this.vmethod_40(CS$<>8__locals1.vector2_0, 2250) ?? this.vmethod_17()[0].smethod_4());
	...
	public override bool vmethod_4(bool bool_3 = false, bool bool_4 = false)
	{
		...
		Ship ship = base.C.Map.method_5<Ship>(heroPosition, new Func<Ship, bool>(GClass838.<>c.<>c_0.method_0), null, 0);
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass838.size_0 = new Size(MapUtils.LargeMapSize.Width / 2, MapUtils.LargeMapSize.Height / 2);
		GClass838.rectangle_0 = new Rectangle(new Point(0, 0), GClass838.size_0);
		GClass838.rectangle_1 = new Rectangle(new Point(GClass838.size_0.Width, 0), GClass838.size_0);
		GClass838.rectangle_2 = new Rectangle(new Point(0, GClass838.size_0.Height), GClass838.size_0);
		GClass838.rectangle_3 = new Rectangle(new Point(GClass838.size_0.Width, GClass838.size_0.Height), GClass838.size_0);
	}
