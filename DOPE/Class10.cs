...
internal static class Class10
{
	...
	static Class10()
	{
		...
		Class10.lBfoxdApVpM = new PropertyChangedEventArgs("DarkorbitAPI.Licensing.IDopeServiceProxy.Service");
		...
		Class10.ThyoxToKkYS = new PropertyChangedEventArgs("EnemyLocated");
		...
		Class10.hahoxIyVbok = new PropertyChangedEventArgs("GalaxyGateType");
		Class10.Game = new PropertyChangedEventArgs("Game");
		Class10.propertyChangedEventArgs_21 = new PropertyChangedEventArgs("GameServer");
		Class10.Hero = new PropertyChangedEventArgs("Hero");
		Class10.propertyChangedEventArgs_22 = new PropertyChangedEventArgs("HeroPosition");
		Class10.propertyChangedEventArgs_23 = new PropertyChangedEventArgs("ignoreShields");
		Class10.propertyChangedEventArgs_24 = new PropertyChangedEventArgs("IsAttacking");
		Class10.propertyChangedEventArgs_25 = new PropertyChangedEventArgs("IsCollecting");
		Class10.propertyChangedEventArgs_26 = new PropertyChangedEventArgs("IsEnabled");
		Class10.IsPaused = new PropertyChangedEventArgs("IsPaused");
		Class10.propertyChangedEventArgs_27 = new PropertyChangedEventArgs("IsStopping");
		Class10.WiLoxwZhvaL = new PropertyChangedEventArgs("Key");
		Class10.propertyChangedEventArgs_28 = new PropertyChangedEventArgs("LastBackgroundAction");
		Class10.propertyChangedEventArgs_29 = new PropertyChangedEventArgs("LastBackgroundHandlerAction");
		Class10.LastDisconnectReason = new PropertyChangedEventArgs("LastDisconnectReason");
		Class10.propertyChangedEventArgs_30 = new PropertyChangedEventArgs("LastLogin");
		Class10.propertyChangedEventArgs_31 = new PropertyChangedEventArgs("LastMapLogin");
		Class10.propertyChangedEventArgs_32 = new PropertyChangedEventArgs("LastStates");
		Class10.propertyChangedEventArgs_33 = new PropertyChangedEventArgs("Log");
		Class10.propertyChangedEventArgs_34 = new PropertyChangedEventArgs("LoginTask");
		Class10.hrGoxrgiOdy = new PropertyChangedEventArgs("MainController");
		Class10.Map = new PropertyChangedEventArgs("Map");
		Class10.propertyChangedEventArgs_35 = new PropertyChangedEventArgs("MapProfile");
		Class10.Module = new PropertyChangedEventArgs("Module");
		Class10.Name = new PropertyChangedEventArgs("Name");
		Class10.propertyChangedEventArgs_36 = new PropertyChangedEventArgs("NextBot");
		Class10.propertyChangedEventArgs_37 = new PropertyChangedEventArgs("NpcLockout");
		Class10.propertyChangedEventArgs_38 = new PropertyChangedEventArgs("Priority");
		Class10.propertyChangedEventArgs_39 = new PropertyChangedEventArgs("Profile");
		Class10.propertyChangedEventArgs_40 = new PropertyChangedEventArgs("RealDist");
		Class10.propertyChangedEventArgs_41 = new PropertyChangedEventArgs("ReturnState");
		Class10.propertyChangedEventArgs_42 = new PropertyChangedEventArgs("RoamTarget");
		Class10.propertyChangedEventArgs_43 = new PropertyChangedEventArgs("Run");
		Class10.RunTime = new PropertyChangedEventArgs("RunTime");
		Class10.Scheduler = new PropertyChangedEventArgs("Scheduler");
		Class10.propertyChangedEventArgs_44 = new PropertyChangedEventArgs("SelectedAmmo");
		Class10.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("SelectedHS");
		Class10.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("SelectedRockets");
		Class10.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("SellProfile");
		Class10.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("Server");
		Class10.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("Service");
		Class10.ServiceStatus = new PropertyChangedEventArgs("ServiceStatus");
		Class10.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("ShouldBeDisabled");
		Class10.Started = new PropertyChangedEventArgs("Started");
		Class10.State = new PropertyChangedEventArgs("State");
		Class10.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("StateIters");
		...
		Class10.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("Timeout");
		Class10.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("TimeTableActive");
		Class10.propertyChangedEventArgs_54 = new PropertyChangedEventArgs("TimeTableProfile");
		Class10.propertyChangedEventArgs_55 = new PropertyChangedEventArgs("TravelTarget");
	...
	internal static readonly PropertyChangedEventArgs lBfoxdApVpM;
	...
	internal static readonly PropertyChangedEventArgs ThyoxToKkYS;
	...
	internal static readonly PropertyChangedEventArgs hahoxIyVbok;
	...
	internal static readonly PropertyChangedEventArgs WiLoxwZhvaL;
	...
	internal static readonly PropertyChangedEventArgs hrGoxrgiOdy;
