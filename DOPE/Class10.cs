...
internal static class Class10
{
	...
	static Class10()
	{
		...
		Class10.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("ReturnState");
		Class10.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("RoamTarget");
		Class10.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("Run");
		Class10.RunTime = new PropertyChangedEventArgs("RunTime");
		Class10.Scheduler = new PropertyChangedEventArgs("Scheduler");
		Class10.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("SelectedAmmo");
		Class10.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("SelectedHS");
		Class10.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("SelectedRockets");
		Class10.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("SellProfile");
		Class10.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("Server");
		Class10.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("Service");
