...
public class GClass187 : GInterface0
{
	...
	public GClass187(int int_3 = 0, int int_4 = 0, int int_5 = 0, string string_1 = "", int int_6 = 0, bool bool_0 = false)
	{
	...
	public virtual void imethod_1(BinaryStream binaryStream_0)
	{
		...
		this.aJyunkjqRa = binaryStream_0.ReadBoolean();
	}
	...
	public virtual void imethod_2(BinaryStream binaryStream_0)
	{
		...
		binaryStream_0.WriteBoolean(this.aJyunkjqRa);
	}
