...
public class GClass889 : INotifyPropertyChanged, ILogManager, IPErkavaBotController
{
	...
	public void Cloak()
	{
		...
		{
			this.BackgroundQueue.Enqueue(new Func<DarkOrbitWebAPI, object>(GClass889.<>c.<>c_0.method_0));
		}
	}
	...
	public void method_3(Collectible collectible_1)
	{
		...
		{
			this.FmowrcKoFu8 = collectible_1.Hash;
			UsageCounter<string>.UsageEntry usageEntry = this.BoxTracker.YwdwTharpER(collectible_1.Hash, TimeSpan.FromSeconds(60000.0), true);
	...
	{
		GClass889.<>c__DisplayClass13_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass13_0();
	...
	public void method_6(Ship ship_1, bool bool_12 = false)
	{
		...
		{
			this.Game.Connection.Server.method_9(ship_1, bool_12);
	...
	public void method_7(Ship ship_1)
	{
		...
		if (laserType > LaserType.LCB_10 && this.Hero.method_20(Ammo.smethod_1(laserType)) < 100.0)
		{
	...
	public bool method_10<dr9pVe5Bqx8Lh4gZjfE>(string string_3, Func<DarkOrbitWebAPI, dr9pVe5Bqx8Lh4gZjfE> func_0, out dr9pVe5Bqx8Lh4gZjfE gparam_0)
	{
		GClass889.<>c__DisplayClass33_0<dr9pVe5Bqx8Lh4gZjfE> CS$<>8__locals1 = new GClass889.<>c__DisplayClass33_0<dr9pVe5Bqx8Lh4gZjfE>();
		CS$<>8__locals1.f = func_0;
		CS$<>8__locals1.<>4__this = this;
		CS$<>8__locals1.key = string_3;
		gparam_0 = default(dr9pVe5Bqx8Lh4gZjfE);
		object obj;
		...
		if (obj is dr9pVe5Bqx8Lh4gZjfE)
		{
			dr9pVe5Bqx8Lh4gZjfE dr9pVe5Bqx8Lh4gZjfE = (dr9pVe5Bqx8Lh4gZjfE)((object)obj);
			object obj2;
			this.concurrentDictionary_0.TryRemove(CS$<>8__locals1.key, out obj2);
			gparam_0 = dr9pVe5Bqx8Lh4gZjfE;
			return true;
		}
		return false;
	}
	...
	public void RcYwDksnwv7(bool bool_12, bool bool_13 = false)
	{
		int num;
		int num2;
		GEnum4 genum;
		...
		if (this.State == BotState.Flee || (this.State == BotState.Travel && this.DnewrsRmokS) || this.State == BotState.Repair)
		{
		...
		if (!bool_13)
		{
			GClass899 gclass = this.Module as GClass899;
			if (gclass != null)
			{
				int num4 = this.Map.Ships.Count(new Func<KeyValuePair<int, Ship>, bool>(GClass889.<>c.<>c_0.method_1));
				if (gclass.vmethod_1() && num4 == 0)
				{
					genum3 = GEnum4.Veteran;
				}
				else if (this.MapProfile.UseMothToKillCorners && this.Hero.method_15(GEnum4.Moth.smethod_0()) && this.method_84())
				{
					genum3 = GEnum4.Moth;
				}
			}
	...
	public bool method_12(bool bool_12, bool bool_13 = false)
	{
		if (this.Behavior is GClass907)
		{
			bool_12 = false;
		}
		Gate gate_;
		Vector2? vector = this.Behavior.vmethod_20(this.Map.Hero.Position, out gate_, bool_13, bool_12);
		if (vector == null)
		{
			return false;
		}
		if (!bool_12 && Vector2.Distance(vector.Value, this.Hero.Position) < 100f)
		{
			vector = this.Behavior.vmethod_20(this.Map.Hero.Position, out gate_, bool_13, true);
		}
		return vector != null && this.method_35(vector.Value, gate_, 15, bool_13);
	}
	...
	public void AutoRefine()
	{
		...
		foreach (ResourceType resourceType_ in GClass889.IsMwrusUmiJ)
		{
			int num = this.Hero.method_26(resourceType_);
			if (num > 0)
			{
				this.Server.method_20(resourceType_, (double)num);
	...
	protected bool method_13()
	{
		...
		{
			Vector2 vector = this.Map.Grid.isTzeKvmAG(this.HeroPosition);
	...
	{
		return this.method_16(GClass889.list_0);
	}

	public bool method_19()
	{
		return this.method_16(GClass889.list_2);
	}

	public bool dnAwDrVahuU()
	{
	...
	{
		if (this.method_17(GClass889.list_0) == "ability_solace")
		{
			using (IEnumerator<GroupManager.GroupMember> enumerator = this.Hero.Group.caKbcCjAjJ().GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					GroupManager.GroupMember groupMember = enumerator.Current;
					GClass197 shipInfo = groupMember.ShipInfo;
					if (shipInfo != null)
					{
	...
	{
		Ship ship = this.Map.method_5<Ship>(this.HeroPosition, new Func<Ship, bool>(this.method_85), null, 0);
		...
		if (this.IsAttacking && selectedShip != null && this.AttackingId == selectedShip.Id)
		{
			...
			{
				string text2 = this.method_17(GClass889.list_1);
	...
	public GClass887 Scheduler
	{
		[CompilerGenerated]
		get
		{
			return this.gclass887_0;
		}
		[CompilerGenerated]
		set
		{
			if (object.Equals(this.gclass887_0, value))
			{
				return;
			}
			this.gclass887_0 = value;
	...
	public int RealDist
	{
		...
		set
		{
			...
			this.int_1 = value;
			this.method_92(Class10.propertyChangedEventArgs_44);
		}
	}
	...
	public void method_23(string string_3)
	{
		...
		propertyChanged(this, new PropertyChangedEventArgs(string_3));
	}
	...
	public void method_24()
	{
		...
		this.RcYwDksnwv7(bool_, false);
	}

	private bool method_25(PetState petState_0)
	{
	...
	private bool method_26(PetMode petMode_0, int int_11 = 0)
	{
		if (this.Hero.Pet.IsControlDisabled)
		{
			return false;
	...
	public void method_27()
	{
		...
		if (petMode <= PetMode.Off)
		{
			...
			{
				this.method_26(PetMode.Passive, 0);
				this.method_25(PetState.Deactivate);
			}
			return;
		}
		if (this.Hero.Pet.IsEnabled)
		{
			...
			{
				bool flag;
				this.method_10<bool>("BuyPetFuel", new Func<DarkOrbitWebAPI, bool>(GClass889.<>c.<>c_0.method_2), out flag);
			}
			bool flag2;
			...
			flag2 = this.Hero.Pet.method_14(petMode);
			IL_185:
			if (flag2)
			{
				this.method_26(petMode, num);
			}
			return;
		}
		...
		this.method_25(PetState.Activate);
	...
	{
		if (this.WwQwrdiwwtN.Cooldown(5000))
		{
			this.method_80();
		}
		this.method_15();
		...
		{
			if (GClass889.botState_2.HasFlag(this.State))
			{
				this.method_66(BotState.Flee);
			}
		}
		else if (this.Game.Hero.HpPercentage < (float)this.MapProfile.MinHp && this.Behavior.vmethod_27() && GClass889.botState_2.HasFlag(this.State))
		{
	...
	{
		bool flag = this.method_76();
		bool flag2 = this.method_75();
		BotState botState_;
		if (flag ^ flag2)
		{
			if (flag)
	...
	public void method_30()
	{
		...
		if (this.Behavior.vmethod_26() && ((this.Game.Hero.HpPercentage < 98f && this.Hero.method_15("equipment_extra_repbot_rep")) || (!this.ignoreShields && this.Game.Hero.ShieldPercentage < 90f)) && this.dateTimeOffset_2.Cooldown(10000))
		{
			this.method_66(BotState.Repair);
			return;
		}
		...
		if (gate != null)
		{
			this.method_35(gate.Position, gate, 15, false);
			return;
		}
		int num2 = this.int_2;
		this.int_2 = num2 + 1;
		if (num2 > 400)
		{
			this.method_64((GClass891.GEnum10)2);
			return;
		}
	}
	...
	private bool method_31(GEnum4 genum4_0)
	{
		MenuItem menuItem;
	...
	private bool ignoreShields
	{
		get
		{
			return this.method_31(GEnum4.Wheel) || this.method_31(GEnum4.Moth);
		}
	}
	...
	public void method_32()
	{
		...
		if (!this.Behavior.vmethod_4(true, false))
		{
			...
			{
				this.RcYwDksnwv7(false, bool_);
			}
			if (this.Map.IsGG || !this.method_12(false, false))
			{
	...
	public bool method_35(Vector2 vector2_2, Gate gate_1 = null, int int_11 = 15, bool bool_12 = false)
	{
		GClass889.<>c__DisplayClass173_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass173_0();
		CS$<>8__locals1.gclass889_0 = this;
		CS$<>8__locals1.vector2_0 = vector2_2;
		if (gate_1 != null)
		{
		...
		bool flag = Map.Navigators.method_3(new Action<MapNavigator>(CS$<>8__locals1.method_0), 30);
		if (flag && this.pathSequence_0 != null)
		{
			this.TravelTarget = new Vector2?(CS$<>8__locals1.vector2_0);
			this.DnewrsRmokS = bool_12;
			this.gate_0 = gate_1;
			this.int_6 = int_11;
	...
	public void method_36()
	{
		...
		if (!this.MapProfile.FleeStopOnEnemyLost || !this.DnewrsRmokS || !this.Behavior.vmethod_4(false, false))
		{
			...
			if (this.gate_0 != null)
			{
				...
				if (gate.Activatable)
				{
					if (!this.DnewrsRmokS || !this.Behavior.vmethod_4(true, false) || this.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(this.method_90)))
					{
	...
	{
		GClass889.<>c__DisplayClass185_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass185_0();
		CS$<>8__locals1.gclass889_0 = this;
		...
		if (this.Behavior.vmethod_49(npcShip))
		{
			return;
		}
		Func<bool> func = this.Behavior.vmethod_49(npcShip) ? new Func<bool>(CS$<>8__locals1.method_0) : new Func<bool>(CS$<>8__locals1.method_1);
		if (selectedShip != null)
		{
			if (selectedShip.Id == CS$<>8__locals1.ship_0.Id)
			{
				...
				Vector2? vector = null;
				bool flag;
				if ((flag = this.Behavior.vmethod_2(npcShip)) && this.Behavior.vmethod_3(npcShip) && this.method_76())
				{
	...
	{
		Rectangle rectangle = GClass910.list_0.First<Rectangle>();
		if (!rectangle.Contains((int)this.HeroPosition.X, (int)this.HeroPosition.Y))
		{
			...
			if (this.method_35(vector2_, null, 15, false))
			{
				return;
			}
		}
		...
		Asset value = this.Map.Assets.FirstOrDefault(new Func<KeyValuePair<int, Asset>, bool>(GClass889.<>c.<>c_0.method_3)).Value;
		if (value == null)
		{
			this.method_66(BotState.Default);
			return;
		...
		{
			foreach (ResourceType resourceType in GClass889.list_3)
			{
	...
	public void method_42()
	{
		...
		if (!this.Behavior.vmethod_4(true, false) && this.method_12(false, false))
		{
			return;
		}
		this.method_66(BotState.Default);
	...
	public GClass922 MainController
	{
		get
		{
			GClass921 controller = this.Controller;
			if (controller == null)
			{
				return null;
			}
	...
	public GClass921 Controller
	{
		[CompilerGenerated]
		get
		{
			return this.gclass921_0;
		}
		[CompilerGenerated]
		internal set
		{
			if (object.Equals(this.gclass921_0, value))
			{
				return;
			}
			this.gclass921_0 = value;
		...
		for (;;)
		{
			...
			while (this.Game.Connection.Socket.method_2() && !this.IsPaused && this.Run && this.Hero.IsInitialized)
			{
				...
				lock (obj)
				{
					...
					GClass891 gclass = this.Scheduler.method_13();
	...
	private void method_44(object object_1, GClass194 gclass194_0)
	{
		if (gclass194_0.int_0 == this.Hero.Id)
		{
			GClass889.<>c__DisplayClass204_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass204_0();
			CS$<>8__locals1.string_0 = gclass194_0.FromId.ToString();
			if (this.MainController.Bots.Any(new Func<GClass921, bool>(CS$<>8__locals1.method_0)))
			{
				this.Server.method_22(gclass194_0.FromId);
			}
		}
	}
	...
	private void method_46(GameManager gameManager_0, GClass268 gclass268_0)
	{
		string[] array = gclass268_0.string_0.Split(new char[]
		{
			'|'
		});
		if (gameManager_0.Connection.ProxySocket != null)
		{
			this.method_47(array);
		}
		if (array.Length >= 4 && array[1] == "A" && array[2] == "STM" && array[3] == "msg_pet_out_of_fuel")
		{
			...
			this.Cooldowns.method_1(BotAction.BuyPetFuel, 60000.0);
			bool flag;
			this.method_10<bool>("BuyPetFuel", new Func<DarkOrbitWebAPI, bool>(GClass889.<>c.<>c_0.method_4), out flag);
		}
	}

	private void method_47(string[] string_3)
	{
		if (string_3.Length == 0 || string_3[0] != "69")
		{
			return;
		}
		int num;
		if (string_3.Length != 3 || !(string_3[1] == "range") || !int.TryParse(string_3[2], out num))
		{
			if (string_3.Length == 2 && string_3[1] == "distance")
			{
				Ship ship = this.Map.SelectedShip;
				NpcShip npcShip = this.Map.method_5<NpcShip>(this.Hero.Position, new Func<NpcShip, bool>(GClass889.<>c.<>c_0.method_5), null, 0);
				if (npcShip != null)
				{
					ship = npcShip;
				}
				if (ship != null)
				{
					this.method_91(string.Format("Distance to {0}: {1}", ship.Name, Vector2.Distance(this.Map.Hero.Position, ship.Position)));
					return;
				}
			}
			else
			{
				int num2;
				double num3;
				if (string_3.Length == 4 && string_3[1] == "trade" && int.TryParse(string_3[2], out num2) && double.TryParse(string_3[3], out num3))
				{
					ResourceType resourceType_ = (ResourceType)num2;
					this.method_91(string.Format("Attempting to sell {0} of {1}", num3, num2));
					this.Server.method_21(resourceType_, num3);
					return;
				}
				if (string_3.Length == 2 && string_3[1] == "help")
				{
				...
				if (string_3.Length == 2 && string_3[1] == "portals")
				{
					...
					for (int i = 1; i < 100; i++)
					{
						...
						if (proxySocket != null)
						{
							proxySocket.SendMessage(new GClass263(15161615 + i, "ship_goliath", 0, "", string.Format("{0}", i), int_, int_2, 0, 0, 0, false, null, 0, false, true, false, 0, 0, "", null, null));
						}
					}
					return;
				}
				if (string_3.Length == 2 && string_3[1] == "position")
				{
					this.method_91(this.Game.Hero.Position.ToString());
					return;
				}
				int num4;
				if (string_3.Length == 3 && string_3[1] == "close" && int.TryParse(string_3[2], out num4))
				{
					this.Game.Connection.SendMessage(new GClass145(num4 > 0));
					return;
				}
				if (string_3.Length == 5 && string_3[1] == "box")
				{
					bool flag = string_3[2] == "add";
					string text = string_3[3];
					...
					if (flag)
					{
						proxySocket2.SendMessage(new GClass180(text, this.Game.Hero.PosX, this.Game.Hero.PosY, string_3[4]));
						return;
					}
					proxySocket2.SendMessage(new HjlsnuKxjUgfkCoFhrD(text, true));
					return;
				}
				else if (string_3.Length == 4 && string_3[1] == "res")
				{
					bool flag2 = string_3[2] == "add";
					string text2 = string_3[3];
					...
					if (flag2)
					{
						proxySocket3.SendMessage(new GClass181(text2, this.Game.Hero.PosX, this.Game.Hero.PosY, new GClass259(8)));
						return;
					}
					proxySocket3.SendMessage(new HjlsnuKxjUgfkCoFhrD(text2, true));
					return;
				}
				else
				{
					if (string_3.Length == 2 && string_3[1] == "npc")
					{
						for (int j = 0; j < 4; j++)
						{
							...
							{
								proxySocket4.SendMessage(new GClass263(15161213 + j, "ship_goliath", 0, "", "Test NPC", this.Game.Hero.PosX + j * 100, this.Game.Hero.PosY, j, 0, 0, false, null, 0, false, true, false, 0, 0, "", null, null));
							}
						}
						return;
					}
					if (string_3.Length == 3 && string_3[1] == "distance" && string_3[2] == "gate")
					{
					...
					else if (string_3.Length == 3 && string_3[1] == "init" && string_3[2] == "gate")
					{
						...
						this.method_91(string.Format("Init Gate #{0} dist={1:0.00} active={2}", gate2.Id, num6, gate2.Activatable));
	...
	private void method_48(Map map_0, Ship ship_1, GClass265 gclass265_0)
	{
		GClass889.<>c__DisplayClass208_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass208_0();
		CS$<>8__locals1.gclass889_0 = this;
	...
	private void method_49(Map map_0, Ship ship_1, bool bool_12)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	{
		GClass889.<>c__DisplayClass210_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass210_0();
		CS$<>8__locals1.gclass889_0 = this;
		CS$<>8__locals1.ship_0 = ship_1;
	...
	private void method_53(Map map_0, Ship ship_1, Ship ship_2, int int_11, int int_12)
	{
	...
	private void method_55(Map map_0, string string_3, Collectible collectible_1, bool bool_12)
	{
		object obj = this.object_0;
		lock (obj)
		{
			Collectible collectibleTarget = this.CollectibleTarget;
			if (((collectibleTarget != null) ? collectibleTarget.Hash : null) == string_3)
			{
				if (this.IsCollecting)
				{
					GClass881 stats = this.Stats;
			...
			{
				Collectible collectible;
				this.DormantTargets.TryRemove(string_3, out collectible);
			}
		}
	}
	...
	{
		DateTime now = DateTime.Now;
		if (!this.dateTimeOffset_3.Cooldown(60000))
		{
			this.int_8++;
		}
		else
		...
		if (this.int_8 > 4)
		{
			...
			this.dateTimeOffset_3 = this.dateTime_2;
		}
	...
	private void method_57(GameManager gameManager_0, Hero hero_0)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	private void method_58(GameManager gameManager_0, Hero hero_0, GClass214 gclass214_0, bool bool_12)
	{
		GClass889.<>c__DisplayClass225_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass225_0();
		CS$<>8__locals1.gameManager_0 = gameManager_0;
		CS$<>8__locals1.gclass889_0 = this;
		CS$<>8__locals1.bool_0 = bool_12;
		CS$<>8__locals1.gclass214_0 = gclass214_0;
		this.Log.Info<bool, string>("Hero died wasAlive={alive} killer={killer}", CS$<>8__locals1.bool_0, CS$<>8__locals1.gclass214_0.string_0);
		this.method_61<GClass916>().imethod_1();
		this.Timeout = null;
		if (this.IsPaused)
		{
			return;
		}
		GClass889.<>c__DisplayClass225_0 CS$<>8__locals2 = CS$<>8__locals1;
		GClass903 behavior = this.Behavior;
		CS$<>8__locals2.int_0 = ((behavior != null) ? behavior.vmethod_48() : 1);
		int val = CS$<>8__locals1.gclass214_0.vector_0.Max(new Func<GClass583, int>(GClass889.<>c.<>c_0.method_6));
		...
		MapProfile mapProfile = this.MapProfile;
		if (CS$<>8__locals1.bool_0 && mapProfile != null && mapProfile.ReviveAtPortal && (this.Behavior is GClass907 || this.Behavior is GClass911))
		{
	...
	public GameManager Game
	{
		...
		get
		{
			return this.ykiwrzZvxeJ;
		}
		[CompilerGenerated]
		set
		{
			if (object.Equals(this.ykiwrzZvxeJ, value))
			{
				return;
			}
			this.ykiwrzZvxeJ = value;
			this.method_92(Class10.Hero);
			this.method_92(Class10.propertyChangedEventArgs_26);
			this.method_92(Class10.propertyChangedEventArgs_52);
	...
	public GClass881 Stats
	{
		[CompilerGenerated]
		get
		{
			return this.wMywLwrbipK;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.wMywLwrbipK, value))
			{
				return;
			}
			this.wMywLwrbipK = value;
	...
	public GClass903 Behavior
	{
		[CompilerGenerated]
		get
		{
			return this.gclass903_1;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.gclass903_1, value))
			{
				return;
			}
			this.gclass903_1 = value;
			this.method_92(Class10.propertyChangedEventArgs_2);
		}
	}

	public GClass889(IDopeServiceProxy idopeServiceProxy_0, AccountSettings accountSettings_1)
	{
		...
		this.Stats = new GClass881(this);
		this.Scheduler = new GClass887(this);
		...
		this.gclass903_0 = new GClass904(this);
		this.gclass913_0 = new GClass913(this);
		this.gclass911_0 = new GClass911(this);
		this.gclass908_0 = new GClass908(this);
		this.gclass905_0 = new GClass905(this);
		this.gclass906_0 = new GClass906(this);
		this.Behavior = this.gclass903_0;
		this.method_63();
	}

	public Jvx0iq54WLmsOxmMbvs method_61<Jvx0iq54WLmsOxmMbvs>() where Jvx0iq54WLmsOxmMbvs : GClass915
	{
		return this.method_60().First(new Func<GInterface9, bool>(GClass889.<>c__297<Jvx0iq54WLmsOxmMbvs>.<>9.method_0)) as Jvx0iq54WLmsOxmMbvs;
	}
	...
	private void method_63()
	{
		...
		this.Game.LogMessage += this.method_46;
		this.Game.Hero.Pet.KamikazeDeath += this.method_45;
		this.Game.Hero.Group.InviteAdded += this.method_44;
	}
	...
	public bool AttachPErkava(GClass238 obj)
	{
	...
	public void Start(bool resetStats = true)
	{
		...
		this.BotThread = new Thread(new ThreadStart(this.method_43))
		{
			IsBackground = true
		};
	...
	public void method_64(GClass891.GEnum10 genum10_0)
	{
	...
	{
		GClass889.<GetStatusText>d__314 <GetStatusText>d__ = new GClass889.<GetStatusText>d__314(-2);
		<GetStatusText>d__.<>4__this = this;
		return <GetStatusText>d__;
	}

	Logger ILogManager.Get(string string_3)
	{
		string str = "Base-";
		string str2 = "-";
		AccountSettings account = this.Account;
		return LogManager.GetLogger(str + string_3 + str2 + ((account != null) ? account.BotId : null));
	}

	public Logger method_70(string string_3)
	{
		string str = "Core-";
		string str2 = "-";
		AccountSettings account = this.Account;
	...
	public CooldownTracker<int> NpcLockout
	{
		...
		set
		{
			...
			this.method_92(Class10.etcwNxiscIA);
		}
	}
	...
	{
		return this.Map.method_7<NpcShip>(this.HeroPosition, new Func<NpcShip, bool>(this.Behavior.vmethod_10), new Func<NpcShip, int>(this.Behavior.vmethod_9), 0).Any(new Func<ValueTuple<NpcShip, float, int>, bool>(GClass889.<>c.<>c_0.method_7));
	}
	...
	{
		GClass889.<>c__DisplayClass339_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass339_0();
		CS$<>8__locals1.gclass889_0 = this;
	...
	public bool MxowfnmntQM(out int int_11)
	{
		int_11 = 0;
	...
	{
		GClass889.<>c__DisplayClass346_0 CS$<>8__locals1 = new GClass889.<>c__DisplayClass346_0();
		CS$<>8__locals1.vector2_0 = vector2_2;
		...
		Collectible collectible2 = this.DormantTargets.Select(new Func<KeyValuePair<string, Collectible>, Collectible>(GClass889.<>c.<>c_0.method_8)).OrderBy(new Func<Collectible, float>(CS$<>8__locals1.method_0)).FirstOrDefault<Collectible>();
	...
	{
		return ship_1.method_7(this.Hero);
	}
	...
	public void method_80()
	{
		...
		this.WwQwrdiwwtN = DateTimeOffset.Now;
	}
	...
	static GClass889()
	{
		...
		GClass889.list_2 = new List<string>
		{
			"ability_lightning",
			"ability_sentinel",
			"ability_spectrum",
		...
		GClass889.list_3 = new List<ResourceType>
		{
		...
		GClass889.botState_2 = (BotState.Roam | BotState.Collect | BotState.Hunt | BotState.Dodge);
	}
	...
	private bool method_84()
	{
		...
		foreach (KeyValuePair<int, Ship> keyValuePair in this.Map.Ships)
		{
			if (keyValuePair.Value.IsNpc && Vector2.Distance(this.HeroPosition, keyValuePair.Value.Position) <= 1000f)
			{
				num++;
				bool flag;
				if (!this.Map.mdGbaKqNuQ(keyValuePair.Value, out flag))
				{
					return false;
				}
			}
	...
	{
		return ship_1.IsPlayer && ship_1.method_7(this.Hero);
	}
	...
	private void method_89()
	{
		...
		if (num > 500)
		{
			this.method_64((GClass891.GEnum10)1);
		}
	}
	...
	[CompilerGenerated]
	private void method_91(string string_3)
	{
		GInterface5 proxySocket = this.Game.Connection.ProxySocket;
		if (proxySocket == null)
		{
		...
		proxySocket.SendMessage(new GClass268(GClass90.Log(string_3)));
	}
	...
	private static ResourceType[] IsMwrusUmiJ;
	...
	private DateTimeOffset WwQwrdiwwtN;
	...
	public DateTimeOffset dateTimeOffset_3;

	public int int_8;

	[CompilerGenerated]
	private GameManager ykiwrzZvxeJ;

	public readonly object object_0;

	[CompilerGenerated]
	private GClass881 wMywLwrbipK;
	...
	public readonly GClass903 gclass903_0;

	public readonly GClass913 gclass913_0;

	public readonly GClass911 gclass911_0;

	public readonly GClass908 gclass908_0;

	public readonly GClass905 gclass905_0;
