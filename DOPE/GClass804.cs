...
public class GClass804 : StatisticsCategory
{
	public Dictionary<string, int> Count
	{
		...
		private set
		{
			...
			this.<>OnPropertyChanged(Class5.Count);
		}
	}

	public GClass804(string string_0, Dictionary<string, int> dictionary_1)
	{
	...
	public override void Update()
	{
		...
		lock (count)
		{
			...
			{
				GClass804.<>c__DisplayClass6_0 CS$<>8__locals1 = new GClass804.<>c__DisplayClass6_0();
