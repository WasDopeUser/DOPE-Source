...
public class GClass925
{
	...
	[CompilerGenerated]
	public List<GClass927.GStruct3> method_4()
	{
		return this.list_0;
	}

	[CompilerGenerated]
	private void pXlQxMhyAh8(List<GClass927.GStruct3> list_1)
	{
		this.list_0 = list_1;
	}

	public GClass925(int int_1)
	{
	...
	{
		this.pXlQxMhyAh8(new List<GClass927.GStruct3>());
	...
	[CompilerGenerated]
	private List<GClass927.GStruct3> list_0;
}
