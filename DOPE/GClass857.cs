...
public static class GClass857
{
	...
	public static extern void GetSystemInfo(out GClass857.GStruct1 gstruct1_0);

	[DllImport("kernel32.dll", SetLastError = true)]
	public static extern int VirtualQueryEx(IntPtr intptr_0, IntPtr intptr_1, out GClass857.GStruct2 gstruct2_0, uint uint_0);

	[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx", SetLastError = true)]
	public static extern int VirtualQueryEx_1(IntPtr intptr_0, IntPtr intptr_1, out GClass857.GStruct3 gstruct3_0, uint uint_0);
	...
	{
		bool flag;
		return !Environment.Is64BitOperatingSystem || ((Environment.OSVersion.Version.Major > 5 || (Environment.OSVersion.Version.Major == 5 && Environment.OSVersion.Version.Minor >= 1)) && (GClass857.IsWow64Process(intptr_0, out flag) && flag));
	}
	...
	public static GClass857.GStruct3 smethod_2(IntPtr intptr_0, IntPtr intptr_1, out int int_0)
	{
		int_0 = 0;
		GClass857.GStruct3 result = default(GClass857.GStruct3);
		if (GClass857.smethod_1())
		{
			GClass857.GStruct2 gstruct = default(GClass857.GStruct2);
			if (GClass857.VirtualQueryEx(intptr_0, intptr_1, out gstruct, (uint)Marshal.SizeOf(typeof(GClass857.GStruct2))) != 0)
			{
		...
		{
			if (GClass857.VirtualQueryEx_1(intptr_0, intptr_1, out result, (uint)Marshal.SizeOf(typeof(GClass857.GStruct3))) != 0)
			{
				return result;
			}
			int_0 = Marshal.GetLastWin32Error();
