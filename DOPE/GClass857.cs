...
public class GClass857
{
	...
	[CompilerGenerated]
	public void method_1(BigInteger bigInteger_2)
	{
		this.bigInteger_0 = bigInteger_2;
	}
	...
	[CompilerGenerated]
	public void method_3(BigInteger bigInteger_2)
	{
		this.bigInteger_1 = bigInteger_2;
	}

	[CompilerGenerated]
	public BigInteger method_4()
	{
		return this.PrWwwrsnWho;
	}

	[CompilerGenerated]
	public void method_5(BigInteger bigInteger_2)
	{
		this.PrWwwrsnWho = bigInteger_2;
	}
	...
	{
		return GClass857.smethod_0(GClass857.smethod_1(string_0));
	}

	public GClass857(BigInteger bigInteger_2, BigInteger bigInteger_3, BigInteger bigInteger_4)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor();
		this.method_1(bigInteger_2);
		this.method_3(bigInteger_3);
		this.method_5(bigInteger_4);
	}

	protected BigInteger method_6(BigInteger bigInteger_2)
	{
		return BigInteger.ModPow(bigInteger_2, this.method_2(), this.method_0());
	}

	protected BigInteger method_7(BigInteger bigInteger_2)
	{
		return BigInteger.ModPow(bigInteger_2, this.method_4(), this.method_0());
	}
	...
	private void method_8(Func<BigInteger, BigInteger> func_0, byte[] byte_0, Stream stream_0, uint uint_0, uint uint_1)
	{
		...
		{
			BigInteger arg2 = GClass857.smethod_0(byte_0.Skip((int)uint_0).Take((int)uint_1).ToArray<byte>());
	...
	private void method_9(Func<BigInteger, BigInteger> func_0, byte[] byte_0, Stream stream_0, uint uint_0, uint uint_1)
	{
		...
		{
			BigInteger arg = GClass857.smethod_0(this.method_10(byte_0, (int)num2, (int)num, (int)num3));
	...
	{
		return this.method_0().ToByteArray().Reverse<byte>().SkipWhile(new Func<byte, bool>(GClass857.<>c.<>c_0.method_0)).Count<byte>();
	}

	protected byte[] method_14(BigInteger bigInteger_2, uint uint_0)
	{
		MemoryStream memoryStream = new MemoryStream();
		int num = 0;
		byte[] array = bigInteger_2.ToByteArray().Reverse<byte>().ToArray<byte>();
	...
	[CompilerGenerated]
	private BigInteger PrWwwrsnWho;
}
