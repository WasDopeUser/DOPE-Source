...
public class GClass906 : GClass905
{
	...
	public override Vector2? vmethod_17(bool bool_3)
	{
		...
		CS$<>8__locals1.vector2_1 = (this.vmethod_36(CS$<>8__locals1.vector2_0, 2250) ?? this.vmethod_13()[0].smethod_4());
		...
		return new Vector2?((pathSequence_ != null) ? pathSequence_.Destination : base.C.Game.Security.method_5(base.Map, this.vmethod_13()));
	}

	public override Vector2? vmethod_16(Vector2 vector2_1, out Gate gate_0, bool bool_3 = false, bool bool_4 = true)
	{
		gate_0 = null;
		return null;
	}
