...
public class GClass823 : INotifyPropertyChanged, ILogManager, IPErkavaBotController
{
	...
	public void method_0()
	{
		...
		{
			this.Game.Connection.Server.method_8();
		}
	}
	...
	public void Cloak()
	{
		...
		{
			this.Server.method_13(menuItem.Id, true, false);
			return;
		}
		if (this.Game.Hero.Uridium >= 500.0)
		{
			this.BackgroundQueue.Enqueue(new Func<DarkOrbitWebAPI, object>(GClass823.<>c.<>c_0.method_0));
		}
	}
	...
	public bool method_1(Vector2 vector2_2, int int_11 = 300, bool bool_13 = false)
	{
		...
		{
			this.Game.Connection.Server.method_4(vector2_2.X, vector2_2.Y, false);
			return true;
		}
		return false;
	}
	...
	public void method_3(Collectible collectible_1)
	{
		if (this.Game.Security.HashBlockList.method_0(collectible_1.Hash) && this.Cooldowns.method_2(BotAction.Collect, 600.0))
		{
			...
			this.Game.Connection.Server.method_12(collectible_1);
	...
	{
		GClass823.<>c__DisplayClass13_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass13_0();
	...
	public void method_6(Ship ship_1, bool bool_13 = false)
	{
		...
		{
			this.Game.Connection.Server.method_7(ship_1, bool_13);
	...
	public void method_7(Ship ship_1)
	{
		...
		while (laserType > LaserType.LCB_10 && this.Hero.method_21(Ammo.smethod_1(laserType)) < 100.0)
		{
			laserType--;
		}
	...
	public void method_8(Ship ship_1)
	{
		...
		else
		{
			...
			if (this.Cooldowns.method_2(BotAction.Attack, 225.0))
			{
				...
				this.Game.Connection.Server.method_10(ship_1);
	...
	public void method_9()
	{
		...
		if (this.SelectedAmmo == "ammunition_laser_lcb-10" && this.Hero.method_21(this.SelectedAmmo) < 1900.0)
		{
			...
			this.Server.method_13("buy_" + this.SelectedAmmo, true, false);
		}
		...
		{
			this.Log.Debug("Buying {ammoType}", this.SelectedAmmo);
			this.Server.method_13("buy_" + this.SelectedRockets, true, false);
		}
	...
	public bool method_10<SjFyvZPMeZGBJ8jqi5k>(string string_4, Func<DarkOrbitWebAPI, SjFyvZPMeZGBJ8jqi5k> func_0, out SjFyvZPMeZGBJ8jqi5k gparam_0)
	{
		GClass823.<>c__DisplayClass33_0<SjFyvZPMeZGBJ8jqi5k> CS$<>8__locals1 = new GClass823.<>c__DisplayClass33_0<SjFyvZPMeZGBJ8jqi5k>();
		CS$<>8__locals1.f = func_0;
		CS$<>8__locals1.<>4__this = this;
		CS$<>8__locals1.key = string_4;
		gparam_0 = default(SjFyvZPMeZGBJ8jqi5k);
		object obj;
		...
		if (obj is SjFyvZPMeZGBJ8jqi5k)
		{
			SjFyvZPMeZGBJ8jqi5k sjFyvZPMeZGBJ8jqi5k = (SjFyvZPMeZGBJ8jqi5k)((object)obj);
			object obj2;
			this.concurrentDictionary_0.TryRemove(CS$<>8__locals1.key, out obj2);
			gparam_0 = sjFyvZPMeZGBJ8jqi5k;
			return true;
		}
		return false;
	}
	...
	public void method_12(bool bool_13, bool bool_14 = false)
	{
		...
		if (!bool_14)
		{
			GClass832 gclass = this.Module as GClass832;
			if (gclass != null)
			{
				int num4 = this.Map.Ships.Count(new Func<KeyValuePair<int, Ship>, bool>(GClass823.<>c.<>c_0.method_1));
	...
	public void AutoRefine()
	{
		...
		foreach (ResourceType resourceType in GClass823.resourceType_0)
		{
			int num = this.Hero.method_26(resourceType);
			if (num > 0)
			{
	...
	{
		return this.method_17(GClass823.list_0);
	}

	public bool method_20()
	{
		return this.method_17(GClass823.list_2);
	}
	...
	{
		if (this.method_18(GClass823.list_0) == "ability_solace")
		{
			using (IEnumerator<GroupManager.GroupMember> enumerator = this.Hero.Group.method_11().GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					if (shipInfo != null)
					{
						float num = (float)shipInfo.int_4 / ((float)shipInfo.int_2 + 1f) * 100f;
	...
	public bool method_23()
	{
		...
		if (this.IsAttacking && selectedShip != null && this.AttackingId == selectedShip.Id)
		{
			...
			{
				string text2 = this.method_18(GClass823.list_1);
				if (text2 == "ability_diminisher")
				{
					if (selectedShip.Shield > 15000 && selectedShip.Hp > 25000)
					{
						...
						bool flag3 = true;
						flag2 = true;
						server2.method_13(text3, flag3, false);
					}
				}
				else if (text2 == "ability_venom")
				{
					if (selectedShip.Hp > 25000)
					{
						...
						bool flag4 = true;
						flag2 = true;
						server3.method_13(text4, flag4, false);
					}
				}
				else if (text2 != null && selectedShip.Hp > 25000)
				{
					...
					bool flag5 = true;
					flag2 = true;
					server4.method_13(text5, flag5, false);
				}
			}
		}
		return flag2;
	...
	public GClass821 Scheduler
	{
		...
		set
		{
			if (object.Equals(this.gclass821_0, value))
			{
				return;
			}
			this.gclass821_0 = value;
	...
	public void method_25(string string_4)
	{
	...
	private bool method_27(PetState petState_0)
	{
	...
	public void method_29()
	{
		...
		if (petMode <= PetMode.Off)
		{
			...
			{
				this.method_28(PetMode.Passive, 0);
				this.method_27(PetState.Deactivate);
			}
			return;
		}
		if (this.Hero.Pet.IsEnabled)
		{
			...
			{
				bool flag;
				this.method_10<bool>("BuyPetFuel", new Func<DarkOrbitWebAPI, bool>(GClass823.<>c.<>c_0.method_2), out flag);
			}
			bool flag2;
		...
		this.method_27(PetState.Activate);
	...
	public bool method_30()
	{
		...
		if (!this.Hero.method_16("equipment_extra_cpu_arol-x") && this.IsAttacking && this.Hero.ItemCooldown.method_0(CooldownType.Rocket) && this.SelectedRockets != null)
		{
			...
			this.Server.method_11(this.EnemyTarget);
		}
		if (this.MapProfile.FleeFromEnemySeen && !this.Behavior.vmethod_4(false, false))
		{
			if (GClass823.botState_2.HasFlag(this.State))
			{
				this.method_67(BotState.Flee);
			}
		}
		else if (this.Game.Hero.HpPercentage < (float)this.MapProfile.MinHp && this.Behavior.vmethod_27() && GClass823.botState_2.HasFlag(this.State))
		{
	...
	public void method_32()
	{
		...
		if (num2 > 400)
		{
			this.method_65((GClass825.GEnum10)2);
			return;
		}
	}
	...
	private bool ignoreShields
	{
		get
		{
			return this.method_33(GEnum4.Wheel) || this.method_33(GEnum4.Moth);
		}
	}
	...
	public void method_35()
	{
		...
		else
		{
			...
			if (this.StateIters == 1)
			{
				this.Server.method_4(this.HeroPosition.X, this.HeroPosition.Y, false);
	...
	{
		GClass823.<>c__DisplayClass173_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass173_0();
		CS$<>8__locals1.gclass823_0 = this;
		CS$<>8__locals1.vector2_0 = vector2_2;
		if (gate_1 != null)
		{
	...
	public void method_38()
	{
		...
		if (!this.MapProfile.FleeStopOnEnemyLost || !this.bool_9 || !this.Behavior.vmethod_4(false, false))
		{
			...
			if (this.gate_0 != null)
			{
				...
				if (gate.Activatable)
				{
					if (!this.bool_9 || !this.Behavior.vmethod_4(true, false) || this.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(this.method_92)))
					{
	...
	{
		GClass823.<>c__DisplayClass185_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass185_0();
		CS$<>8__locals1.gclass823_0 = this;
		...
		if (this.Behavior.vmethod_47(npcShip))
		{
			return;
		}
		Func<bool> func = this.Behavior.vmethod_47(npcShip) ? new Func<bool>(CS$<>8__locals1.method_0) : new Func<bool>(CS$<>8__locals1.method_1);
		if (selectedShip != null)
		{
			if (selectedShip.Id == CS$<>8__locals1.ship_0.Id)
			{
				...
				Vector2? vector = null;
				bool flag;
				if ((flag = this.Behavior.vmethod_2(npcShip)) && this.Behavior.vmethod_3(npcShip) && this.method_77())
				{
				...
				if (flag)
				{
					Vector2? vector2 = this.Behavior.vmethod_43(this.HeroPosition, npcShip, vector);
					if (vector2 != null)
					{
	...
	{
		Rectangle rectangle = GClass842.list_0.First<Rectangle>();
		if (!rectangle.Contains((int)this.HeroPosition.X, (int)this.HeroPosition.Y))
		{
			...
			if (this.method_37(vector2_, null, 15, false))
			{
				return;
			}
		}
		...
		Asset value = this.Map.Assets.FirstOrDefault(new Func<KeyValuePair<int, Asset>, bool>(GClass823.<>c.<>c_0.method_3)).Value;
		if (value == null)
		{
			this.method_67(BotState.Default);
			return;
		...
		{
			foreach (ResourceType resourceType in GClass823.list_3)
			{
	...
	public GClass854 MainController
	{
		get
		{
		...
		for (;;)
		{
			...
			while (this.Game.Connection.Socket.method_2() && !this.IsPaused && this.Run && this.Hero.IsInitialized)
			{
				...
				lock (obj)
				{
					...
					GClass825 gclass = this.Scheduler.method_12();
	...
	private void method_46(object object_1, GClass195 gclass195_0)
	{
		if (gclass195_0.int_0 == this.Hero.Id)
		{
			GClass823.<>c__DisplayClass204_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass204_0();
			CS$<>8__locals1.string_0 = gclass195_0.FromId.ToString();
			if (this.MainController.Bots.Any(new Func<GClass853, bool>(CS$<>8__locals1.method_0)))
			{
	...
	private void method_48(GameManager gameManager_1, GClass269 gclass269_0)
	{
		...
		if (array.Length != 3 || !(array[1] == "range") || !int.TryParse(array[2], out num))
		{
			if (array.Length == 2 && array[1] == "distance")
			{
				...
				if (selectedShip != null)
				{
					this.method_93(string.Format("Distance to {0}: {1}", selectedShip.Name, Vector2.Distance(this.Map.Hero.Position, selectedShip.Position)));
					return;
				}
			}
			else
	...
	{
		GClass823.<>c__DisplayClass207_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass207_0();
		CS$<>8__locals1.gclass823_0 = this;
	...
	{
		GClass823.<>c__DisplayClass209_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass209_0();
		CS$<>8__locals1.gclass823_0 = this;
		CS$<>8__locals1.ship_0 = ship_1;
	...
	{
		GClass823.<>c__DisplayClass224_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass224_0();
		CS$<>8__locals1.gameManager_0 = gameManager_1;
		CS$<>8__locals1.gclass823_0 = this;
		CS$<>8__locals1.bool_0 = bool_13;
		CS$<>8__locals1.gclass217_0 = gclass217_0;
		this.Log.Info<bool, string>("Hero died wasAlive={alive} killer={killer}", CS$<>8__locals1.bool_0, CS$<>8__locals1.gclass217_0.tawSrisLpr);
		this.method_62<GClass848>().imethod_1();
		this.Timeout = null;
		if (this.IsPaused)
		{
			return;
		...
		{
			if (CS$<>8__locals1.gclass217_0.vector_0.Any(new Func<GClass559, bool>(GClass823.<>c.<>c_0.method_4)))
			{
		...
		MapProfile mapProfile2 = this.MapProfile;
		if (CS$<>8__locals1.bool_0 && mapProfile2 != null && mapProfile2.ReviveAtPortal && (this.Behavior is GClass839 || this.Behavior is GClass843))
		{
	...
	public GClass815 Stats
	{
		[CompilerGenerated]
		get
		{
			return this.gclass815_0;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.gclass815_0, value))
			{
				return;
			}
			this.gclass815_0 = value;
	...
	public GClass836 Behavior
	{
		[CompilerGenerated]
		get
		{
			return this.gclass836_1;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.gclass836_1, value))
			{
				return;
			}
			this.gclass836_1 = value;
			this.method_94(Class10.propertyChangedEventArgs_2);
		}
	}

	public GClass823(IDopeServiceProxy idopeServiceProxy_0, AccountSettings accountSettings_1)
	{
		...
		this.Stats = new GClass815(this);
		this.Scheduler = new GClass821(this);
		...
		this.gclass836_0 = new GClass837(this);
		this.gclass845_0 = new GClass845(this);
		this.gclass843_0 = new GClass843(this);
		this.gclass840_0 = new GClass840(this);
		this.gclass838_0 = new GClass838(this);
		this.Behavior = this.gclass836_0;
		this.method_64();
	}

	public Aj3QhyP2xFTPLNA4TLK method_62<Aj3QhyP2xFTPLNA4TLK>() where Aj3QhyP2xFTPLNA4TLK : GClass847
	{
		return this.method_61().First(new Func<GInterface9, bool>(GClass823.<>c__295<Aj3QhyP2xFTPLNA4TLK>.<>9.method_0)) as Aj3QhyP2xFTPLNA4TLK;
	}
	...
	private void method_64()
	{
		...
		this.Game.LogMessage += this.method_48;
		this.Game.Hero.Pet.KamikazeDeath += this.method_47;
		this.Game.Hero.Group.InviteAdded += this.method_46;
	}
	...
	public bool AttachPErkava(GClass241 obj)
	{
		...
		if (game.Settings.FlashSettings.sessionID == null)
		{
			...
			game.Settings.FlashSettings.userID = obj.int_1;
	...
	public void Start(bool resetStats = true)
	{
		...
		this.BotThread = new Thread(new ThreadStart(this.method_45))
		{
			IsBackground = true
		};
	...
	public void method_65(GClass825.GEnum10 genum10_0)
	{
		GClass825 module = this.Module;
		if (module == null)
		{
			return;
		}
	...
	{
		GClass823.<GetStatusText>d__312 <GetStatusText>d__ = new GClass823.<GetStatusText>d__312(-2);
	...
	{
		return this.Map.method_7<NpcShip>(this.HeroPosition, new Func<NpcShip, bool>(this.Behavior.vmethod_10), new Func<NpcShip, int>(this.Behavior.vmethod_9), 0).Any(new Func<ValueTuple<NpcShip, float, int>, bool>(GClass823.<>c.<>c_0.method_5));
	}
	...
	{
		GClass823.<>c__DisplayClass337_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass337_0();
		CS$<>8__locals1.gclass823_0 = this;
	...
	{
		GClass823.<>c__DisplayClass344_0 CS$<>8__locals1 = new GClass823.<>c__DisplayClass344_0();
		CS$<>8__locals1.vector2_0 = vector2_2;
		...
		Collectible collectible2 = this.DormantTargets.Select(new Func<KeyValuePair<string, Collectible>, Collectible>(GClass823.<>c.<>c_0.method_6)).OrderBy(new Func<Collectible, float>(CS$<>8__locals1.method_0)).FirstOrDefault<Collectible>();
	...
	static GClass823()
	{
		...
		GClass823.list_2 = new List<string>
		{
			"ability_lightning",
			"ability_sentinel",
			"ability_spectrum",
		...
		GClass823.list_3 = new List<ResourceType>
		{
		...
		GClass823.botState_2 = (BotState.Roam | BotState.Collect | BotState.Hunt | BotState.Dodge);
	}
	...
	private void method_91()
	{
		...
		if (num > 500)
		{
			this.method_65((GClass825.GEnum10)1);
		}
	}
	...
	public readonly GClass836 gclass836_0;

	public readonly GClass845 gclass845_0;

	public readonly GClass843 gclass843_0;

	public readonly GClass840 gclass840_0;

	public readonly GClass838 gclass838_0;

	[CompilerGenerated]
	private GClass825 gclass825_0;

	[CompilerGenerated]
	private GClass836 gclass836_1;
