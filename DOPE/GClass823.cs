...
public static class GClass823
{
	...
	{
		return GClass823.smethod_5(color_0, string_0, 0, 0, nullable_0, args);
	}
	...
	private static EntityRenderFragment smethod_5(Color color_0, string string_0, int int_0, int int_1, Color? nullable_0 = null, params object[] args)
	{
		...
		entityRenderFragment.Fill = ((color_0 == Color.Transparent) ? "" : GClass823.smethod_0(color_0));
		entityRenderFragment.Stroke = ((nullable_0 != null) ? GClass823.smethod_0(nullable_0.Value) : "");
		entityRenderFragment.Shape = string_0;
		entityRenderFragment.Extra = args.Where(new Func<object, bool>(GClass823.<>c.<>c_0.method_0)).Select(new Func<object, string>(GClass823.<>c.<>c_0.method_1)).ToList<string>();
		entityRenderFragment.ExtraF = args.Where(new Func<object, bool>(GClass823.<>c.<>c_0.method_2)).Select(new Func<object, float>(GClass823.<>c.<>c_0.method_3)).ToList<float>();
	...
	private static EntityDataRoot smethod_11(GClass822 gclass822_0, Map map_0, Ship ship_0)
	{
		...
		{
			GClass823.smethod_6(color_, 4, nullable_)
		};
	...
	private static EntityDataRoot smethod_18(GClass822 gclass822_0)
	{
		...
		{
			text += " | PET: ";
			if (gclass822_0.Hero.Pet.IsEnabled)
			{
				text += gclass822_0.Hero.Pet.Mode.ToString();
			}
			else
			{
				text += "Off";
