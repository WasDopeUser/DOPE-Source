...
public abstract class GClass841 : INotifyPropertyChanged
{
	public string Name
	{
		[CompilerGenerated]
	...
	public virtual void HandleError(GClass841.GEnum10 genum10_0)
	{
		this.SetCooldown(TimeSpan.FromMinutes(3.0), false);
		this.C.method_65(BotState.Default);
	}
