...
public class GClass893 : GClass891
{
	...
	public GClass893(GClass889 gclass889_1)
	{
		Class13.xnk8ImWzpOt04();
		this.bool_0 = true;
		base..ctor(gclass889_1, "Palladium", int.MinValue);
		this.gclass909_0 = new GClass909(gclass889_1);
		this.gclass910_0 = new GClass910(gclass889_1);
	}
	...
	public override MapProfile UpdateProfile(BotProfile botProfile_1)
	{
		...
		else
		{
			...
			{
				collectProfile = maps.FirstOrDefault(new Func<MapProfile, bool>(GClass893.<>c.<>c_0.method_0));
			}
		}
