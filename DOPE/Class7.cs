...
internal static class Class7
{
	...
	static Class7()
	{
		...
		Class7.mHxqUgjMiYb = new PropertyChangedEventArgs("CollectMaterials");
		...
		Class7.propertyChangedEventArgs_25 = new PropertyChangedEventArgs("EarnedX4");
		Class7.Enabled = new PropertyChangedEventArgs("Enabled");
		Class7.NkjqUvxoIkP = new PropertyChangedEventArgs("EnableTimeTable");
		Class7.propertyChangedEventArgs_26 = new PropertyChangedEventArgs("First");
		Class7.UbNqUnoxoCX = new PropertyChangedEventArgs("FleeConfig");
		Class7.propertyChangedEventArgs_27 = new PropertyChangedEventArgs("FleeFormation");
		Class7.propertyChangedEventArgs_28 = new PropertyChangedEventArgs("FleeFromEnemyAttacker");
		Class7.propertyChangedEventArgs_29 = new PropertyChangedEventArgs("FleeFromEnemySeen");
		Class7.propertyChangedEventArgs_30 = new PropertyChangedEventArgs("FleeOnlyFromKnownEnemySeen");
		Class7.propertyChangedEventArgs_31 = new PropertyChangedEventArgs("FleeStopOnEnemyLost");
		Class7.propertyChangedEventArgs_32 = new PropertyChangedEventArgs("FleeTimeout");
		Class7.propertyChangedEventArgs_33 = new PropertyChangedEventArgs("FlyingConfig");
		Class7.propertyChangedEventArgs_34 = new PropertyChangedEventArgs("FlyingFormation");
		Class7.propertyChangedEventArgs_35 = new PropertyChangedEventArgs("GG_ChaseFleeing");
		Class7.propertyChangedEventArgs_36 = new PropertyChangedEventArgs("GG_DragNpcs");
		Class7.propertyChangedEventArgs_37 = new PropertyChangedEventArgs("GG_UseKamikazeCorner");
		Class7.propertyChangedEventArgs_38 = new PropertyChangedEventArgs("GgCornerLaser");
		Class7.GgStats = new PropertyChangedEventArgs("GgStats");
		Class7.Group = new PropertyChangedEventArgs("Group");
		Class7.propertyChangedEventArgs_39 = new PropertyChangedEventArgs("GroupAttackMode");
		Class7.propertyChangedEventArgs_40 = new PropertyChangedEventArgs("HangarDefault");
		Class7.propertyChangedEventArgs_41 = new PropertyChangedEventArgs("HangarPalladiumCollect");
		...
		Class7.propertyChangedEventArgs_44 = new PropertyChangedEventArgs("HasNextProfile");
		Class7.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("Hellstorm");
		Class7.HeroStats = new PropertyChangedEventArgs("HeroStats");
		Class7.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("Hunter");
		Class7.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("IgnoreOwnership");
		Class7.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("JumpGGLastLife");
		Class7.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("KamikazeConfig");
		Class7.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("KamikazeFormation");
		Class7.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("Key");
		Class7.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("Laser");
		Class7.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("LastError");
		Class7.propertyChangedEventArgs_54 = new PropertyChangedEventArgs("MapCooldown");
		Class7.propertyChangedEventArgs_55 = new PropertyChangedEventArgs("MapDuration");
		Class7.MapName = new PropertyChangedEventArgs("MapName");
		Class7.propertyChangedEventArgs_56 = new PropertyChangedEventArgs("Maps");
		Class7.propertyChangedEventArgs_57 = new PropertyChangedEventArgs("MaxDeaths");
		Class7.propertyChangedEventArgs_58 = new PropertyChangedEventArgs("MinHealHp");
		Class7.propertyChangedEventArgs_59 = new PropertyChangedEventArgs("MinHp");
		Class7.propertyChangedEventArgs_60 = new PropertyChangedEventArgs("MinSabShield");
		Class7.propertyChangedEventArgs_61 = new PropertyChangedEventArgs("ModuleType");
		Class7.Name = new PropertyChangedEventArgs("Name");
		Class7.propertyChangedEventArgs_62 = new PropertyChangedEventArgs("NextProfileName");
		Class7.propertyChangedEventArgs_63 = new PropertyChangedEventArgs("NpcId");
		...
		Class7.propertyChangedEventArgs_74 = new PropertyChangedEventArgs("RepairDrones");
		Class7.propertyChangedEventArgs_75 = new PropertyChangedEventArgs("Resets");
		Class7.propertyChangedEventArgs_76 = new PropertyChangedEventArgs("ReviveAtPortal");
		Class7.propertyChangedEventArgs_77 = new PropertyChangedEventArgs("Rocket");
		Class7.propertyChangedEventArgs_78 = new PropertyChangedEventArgs("SecondaryCircleNpcs");
		Class7.propertyChangedEventArgs_79 = new PropertyChangedEventArgs("Server");
		Class7.propertyChangedEventArgs_80 = new PropertyChangedEventArgs("SessionId");
		Class7.propertyChangedEventArgs_81 = new PropertyChangedEventArgs("Skylab_KeepPromerium");
		Class7.propertyChangedEventArgs_82 = new PropertyChangedEventArgs("Skylab_KeepSeprom");
		Class7.propertyChangedEventArgs_83 = new PropertyChangedEventArgs("Spinner_Alpha");
		Class7.propertyChangedEventArgs_84 = new PropertyChangedEventArgs("Spinner_Beta");
		Class7.propertyChangedEventArgs_85 = new PropertyChangedEventArgs("Spinner_Delta");
		Class7.propertyChangedEventArgs_86 = new PropertyChangedEventArgs("Spinner_Enabled");
		Class7.propertyChangedEventArgs_87 = new PropertyChangedEventArgs("Spinner_Epsilon");
		Class7.propertyChangedEventArgs_88 = new PropertyChangedEventArgs("Spinner_Gamma");
		Class7.propertyChangedEventArgs_89 = new PropertyChangedEventArgs("Spinner_Kappa");
		Class7.propertyChangedEventArgs_90 = new PropertyChangedEventArgs("Spinner_Kuiper");
		Class7.YvOqSzqsxmc = new PropertyChangedEventArgs("Spinner_Lambda");
		Class7.propertyChangedEventArgs_91 = new PropertyChangedEventArgs("Spinner_PlaceGates");
		Class7.propertyChangedEventArgs_92 = new PropertyChangedEventArgs("Spinner_SpinDelay");
		Class7.propertyChangedEventArgs_93 = new PropertyChangedEventArgs("Spinner_SpinSize");
		Class7.propertyChangedEventArgs_94 = new PropertyChangedEventArgs("Spinner_StopABG");
		Class7.lyJqwpIdQcT = new PropertyChangedEventArgs("Spinner_UsePhoenix");
		...
		Class7.eNkqwmwAyEm = new PropertyChangedEventArgs("UsePetLocator");
		...
		Class7.propertyChangedEventArgs_107 = new PropertyChangedEventArgs("Username");
		Class7.propertyChangedEventArgs_108 = new PropertyChangedEventArgs("UseRocketPrecision");
		Class7.propertyChangedEventArgs_109 = new PropertyChangedEventArgs("UseSab");
		Class7.Value = new PropertyChangedEventArgs("Value");
		Class7.propertyChangedEventArgs_110 = new PropertyChangedEventArgs("Volatile");
	}
	...
	internal static readonly PropertyChangedEventArgs mHxqUgjMiYb;
	...
	internal static readonly PropertyChangedEventArgs NkjqUvxoIkP;

	internal static readonly PropertyChangedEventArgs propertyChangedEventArgs_26;

	internal static readonly PropertyChangedEventArgs UbNqUnoxoCX;
	...
	internal static readonly PropertyChangedEventArgs YvOqSzqsxmc;
	...
	internal static readonly PropertyChangedEventArgs lyJqwpIdQcT;
	...
	internal static readonly PropertyChangedEventArgs eNkqwmwAyEm;
