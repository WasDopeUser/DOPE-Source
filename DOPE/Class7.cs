...
internal static class Class7
{
	...
	static Class7()
	{
		...
		Class7.DhHwuOgxjXW = new PropertyChangedEventArgs("BotControlState");
		Class7.propertyChangedEventArgs_4 = new PropertyChangedEventArgs("BotId");
		Class7.BotName = new PropertyChangedEventArgs("BotName");
		Class7.uJawuhmyxqC = new PropertyChangedEventArgs("BotStateName");
		Class7.Boxes = new PropertyChangedEventArgs("Boxes");
		Class7.BoxStats = new PropertyChangedEventArgs("BoxStats");
		Class7.propertyChangedEventArgs_5 = new PropertyChangedEventArgs("CircleNpcs");
		Class7.propertyChangedEventArgs_6 = new PropertyChangedEventArgs("CircleRange");
		Class7.propertyChangedEventArgs_7 = new PropertyChangedEventArgs("Cloak");
		Class7.propertyChangedEventArgs_8 = new PropertyChangedEventArgs("CollectBonus");
		Class7.propertyChangedEventArgs_9 = new PropertyChangedEventArgs("CollectCargo");
		Class7.propertyChangedEventArgs_10 = new PropertyChangedEventArgs("CollectGoldBooty");
		Class7.propertyChangedEventArgs_11 = new PropertyChangedEventArgs("CollectGreenBooty");
		Class7.propertyChangedEventArgs_12 = new PropertyChangedEventArgs("CollectMaterials");
		Class7.propertyChangedEventArgs_13 = new PropertyChangedEventArgs("Collector");
		Class7.propertyChangedEventArgs_14 = new PropertyChangedEventArgs("CollectPalladium");
		...
		Class7.propertyChangedEventArgs_15 = new PropertyChangedEventArgs("DefaultHellstorm");
		Class7.propertyChangedEventArgs_16 = new PropertyChangedEventArgs("DefaultLaser");
		Class7.propertyChangedEventArgs_17 = new PropertyChangedEventArgs("DefaultRocket");
		Class7.propertyChangedEventArgs_18 = new PropertyChangedEventArgs("DroneFormation");
		...
		Class7.propertyChangedEventArgs_19 = new PropertyChangedEventArgs("EarnedJackpot");
		Class7.propertyChangedEventArgs_20 = new PropertyChangedEventArgs("EarnedSAB");
		Class7.EarnedUridium = new PropertyChangedEventArgs("EarnedUridium");
		Class7.propertyChangedEventArgs_21 = new PropertyChangedEventArgs("EarnedX1");
		Class7.propertyChangedEventArgs_22 = new PropertyChangedEventArgs("EarnedX2");
		Class7.propertyChangedEventArgs_23 = new PropertyChangedEventArgs("EarnedX3");
		Class7.propertyChangedEventArgs_24 = new PropertyChangedEventArgs("EarnedX4");
		Class7.Enabled = new PropertyChangedEventArgs("Enabled");
		Class7.propertyChangedEventArgs_25 = new PropertyChangedEventArgs("EnableTimeTable");
		Class7.propertyChangedEventArgs_26 = new PropertyChangedEventArgs("Escort_PreferFreeNPCs");
		Class7.propertyChangedEventArgs_27 = new PropertyChangedEventArgs("First");
		Class7.propertyChangedEventArgs_28 = new PropertyChangedEventArgs("FleeConfig");
		Class7.propertyChangedEventArgs_29 = new PropertyChangedEventArgs("FleeFormation");
		Class7.propertyChangedEventArgs_30 = new PropertyChangedEventArgs("FleeFromEnemyAttacker");
		Class7.propertyChangedEventArgs_31 = new PropertyChangedEventArgs("FleeFromEnemySeen");
		Class7.JqewnTmbAsh = new PropertyChangedEventArgs("FleeOnlyFromKnownEnemySeen");
		Class7.propertyChangedEventArgs_32 = new PropertyChangedEventArgs("FleeStopOnEnemyLost");
		Class7.propertyChangedEventArgs_33 = new PropertyChangedEventArgs("FleeTimeout");
		Class7.propertyChangedEventArgs_34 = new PropertyChangedEventArgs("FlyingConfig");
		Class7.propertyChangedEventArgs_35 = new PropertyChangedEventArgs("FlyingFormation");
		Class7.propertyChangedEventArgs_36 = new PropertyChangedEventArgs("GG_ChaseFleeing");
		Class7.propertyChangedEventArgs_37 = new PropertyChangedEventArgs("GG_DragNpcs");
		Class7.propertyChangedEventArgs_38 = new PropertyChangedEventArgs("GG_UseKamikazeCorner");
		Class7.propertyChangedEventArgs_39 = new PropertyChangedEventArgs("GgCornerLaser");
		Class7.GgStats = new PropertyChangedEventArgs("GgStats");
		Class7.Group = new PropertyChangedEventArgs("Group");
		Class7.propertyChangedEventArgs_40 = new PropertyChangedEventArgs("GroupAttackMode");
		Class7.propertyChangedEventArgs_41 = new PropertyChangedEventArgs("HangarDefault");
		Class7.propertyChangedEventArgs_42 = new PropertyChangedEventArgs("HangarPalladiumCollect");
		Class7.propertyChangedEventArgs_43 = new PropertyChangedEventArgs("HangarPalladiumSell");
		Class7.propertyChangedEventArgs_44 = new PropertyChangedEventArgs("HasLicense");
		Class7.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("HasNextProfile");
		Class7.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("Hellstorm");
		Class7.HeroStats = new PropertyChangedEventArgs("HeroStats");
		Class7.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("Hunter");
		Class7.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("IgnoreOwnership");
		Class7.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("JumpGGLastLife");
		Class7.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("KamikazeConfig");
		Class7.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("KamikazeFormation");
		Class7.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("Key");
		Class7.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("Laser");
		Class7.propertyChangedEventArgs_54 = new PropertyChangedEventArgs("LastError");
		Class7.propertyChangedEventArgs_55 = new PropertyChangedEventArgs("MapCooldown");
		Class7.propertyChangedEventArgs_56 = new PropertyChangedEventArgs("MapDuration");
		Class7.MapName = new PropertyChangedEventArgs("MapName");
		Class7.propertyChangedEventArgs_57 = new PropertyChangedEventArgs("Maps");
		Class7.propertyChangedEventArgs_58 = new PropertyChangedEventArgs("MaxDeaths");
		Class7.propertyChangedEventArgs_59 = new PropertyChangedEventArgs("MinHealHp");
		Class7.propertyChangedEventArgs_60 = new PropertyChangedEventArgs("MinHp");
		Class7.propertyChangedEventArgs_61 = new PropertyChangedEventArgs("MinSabShield");
		Class7.propertyChangedEventArgs_62 = new PropertyChangedEventArgs("ModuleType");
		Class7.Name = new PropertyChangedEventArgs("Name");
		Class7.propertyChangedEventArgs_63 = new PropertyChangedEventArgs("NextProfileName");
		Class7.obhwnPxvhrh = new PropertyChangedEventArgs("NpcId");
		Class7.NpcStats = new PropertyChangedEventArgs("NpcStats");
		Class7.propertyChangedEventArgs_64 = new PropertyChangedEventArgs("NpcWhitelist");
		Class7.propertyChangedEventArgs_65 = new PropertyChangedEventArgs("Order");
		Class7.propertyChangedEventArgs_66 = new PropertyChangedEventArgs("PalladiumCollectionAreaWidth");
		Class7.propertyChangedEventArgs_67 = new PropertyChangedEventArgs("Password");
		Class7.propertyChangedEventArgs_68 = new PropertyChangedEventArgs("PetDeaths");
		Class7.propertyChangedEventArgs_69 = new PropertyChangedEventArgs("PetMode");
		Class7.PetStats = new PropertyChangedEventArgs("PetStats");
		Class7.propertyChangedEventArgs_70 = new PropertyChangedEventArgs("Priority");
		Class7.propertyChangedEventArgs_71 = new PropertyChangedEventArgs("ProfileName");
		Class7.propertyChangedEventArgs_72 = new PropertyChangedEventArgs("ProxyString");
		Class7.propertyChangedEventArgs_73 = new PropertyChangedEventArgs("QZ_GroupSize");
		Class7.reZwnemCyCB = new PropertyChangedEventArgs("RepairDrones");
		Class7.propertyChangedEventArgs_74 = new PropertyChangedEventArgs("Resets");
		Class7.propertyChangedEventArgs_75 = new PropertyChangedEventArgs("ReviveAtPortal");
		Class7.propertyChangedEventArgs_76 = new PropertyChangedEventArgs("Rocket");
		Class7.propertyChangedEventArgs_77 = new PropertyChangedEventArgs("SecondaryCircleNpcs");
		Class7.propertyChangedEventArgs_78 = new PropertyChangedEventArgs("Server");
		Class7.propertyChangedEventArgs_79 = new PropertyChangedEventArgs("SessionId");
		Class7.xaTwnUlmFyS = new PropertyChangedEventArgs("Skylab_KeepPromerium");
		Class7.propertyChangedEventArgs_80 = new PropertyChangedEventArgs("Skylab_KeepSeprom");
		Class7.propertyChangedEventArgs_81 = new PropertyChangedEventArgs("Spinner_Alpha");
		Class7.propertyChangedEventArgs_82 = new PropertyChangedEventArgs("Spinner_Beta");
		Class7.propertyChangedEventArgs_83 = new PropertyChangedEventArgs("Spinner_Delta");
		Class7.propertyChangedEventArgs_84 = new PropertyChangedEventArgs("Spinner_Enabled");
		Class7.propertyChangedEventArgs_85 = new PropertyChangedEventArgs("Spinner_Epsilon");
		Class7.propertyChangedEventArgs_86 = new PropertyChangedEventArgs("Spinner_Gamma");
		Class7.propertyChangedEventArgs_87 = new PropertyChangedEventArgs("Spinner_Kappa");
		Class7.propertyChangedEventArgs_88 = new PropertyChangedEventArgs("Spinner_Kuiper");
		Class7.propertyChangedEventArgs_89 = new PropertyChangedEventArgs("Spinner_Lambda");
		Class7.propertyChangedEventArgs_90 = new PropertyChangedEventArgs("Spinner_PlaceGates");
		Class7.propertyChangedEventArgs_91 = new PropertyChangedEventArgs("Spinner_SpinDelay");
		Class7.propertyChangedEventArgs_92 = new PropertyChangedEventArgs("Spinner_SpinSize");
		Class7.propertyChangedEventArgs_93 = new PropertyChangedEventArgs("Spinner_StopABG");
		Class7.propertyChangedEventArgs_94 = new PropertyChangedEventArgs("Spinner_UsePhoenix");
		Class7.propertyChangedEventArgs_95 = new PropertyChangedEventArgs("Spinner_UseUridium");
		Class7.propertyChangedEventArgs_96 = new PropertyChangedEventArgs("Spinner_Zeta");
		Class7.Spins = new PropertyChangedEventArgs("Spins");
		Class7.propertyChangedEventArgs_97 = new PropertyChangedEventArgs("TargetMap");
		Class7.propertyChangedEventArgs_98 = new PropertyChangedEventArgs("TimeTable");
		Class7.propertyChangedEventArgs_99 = new PropertyChangedEventArgs("TimeTableActive");
		Class7.propertyChangedEventArgs_100 = new PropertyChangedEventArgs("TimeTableUseUtc");
		Class7.propertyChangedEventArgs_101 = new PropertyChangedEventArgs("Use3D");
		Class7.propertyChangedEventArgs_102 = new PropertyChangedEventArgs("UseKamikaze");
		Class7.propertyChangedEventArgs_103 = new PropertyChangedEventArgs("UseMothToKillCorners");
		Class7.propertyChangedEventArgs_104 = new PropertyChangedEventArgs("UseOffensiveAbility");
		Class7.propertyChangedEventArgs_105 = new PropertyChangedEventArgs("UsePetLocator");
		Class7.propertyChangedEventArgs_106 = new PropertyChangedEventArgs("UserAgent");
		Class7.propertyChangedEventArgs_107 = new PropertyChangedEventArgs("UserId");
		Class7.propertyChangedEventArgs_108 = new PropertyChangedEventArgs("Username");
		Class7.propertyChangedEventArgs_109 = new PropertyChangedEventArgs("UseRocketPrecision");
		Class7.propertyChangedEventArgs_110 = new PropertyChangedEventArgs("UseSab");
		Class7.Value = new PropertyChangedEventArgs("Value");
		Class7.propertyChangedEventArgs_111 = new PropertyChangedEventArgs("Volatile");
	}
	...
	internal static readonly PropertyChangedEventArgs DhHwuOgxjXW;
	...
	internal static readonly PropertyChangedEventArgs uJawuhmyxqC;
	...
	internal static readonly PropertyChangedEventArgs JqewnTmbAsh;
	...
	internal static readonly PropertyChangedEventArgs obhwnPxvhrh;
	...
	internal static readonly PropertyChangedEventArgs reZwnemCyCB;
	...
	internal static readonly PropertyChangedEventArgs xaTwnUlmFyS;
