...
internal static class Class7
{
	...
	static Class7()
	{
		...
		Class7.MoqMrUatYqs = new PropertyChangedEventArgs("HasLicense");
		...
		Class7.krqMrQduOiI = new PropertyChangedEventArgs("MinHealHp");
		Class7.propertyChangedEventArgs_61 = new PropertyChangedEventArgs("MinHp");
		Class7.propertyChangedEventArgs_62 = new PropertyChangedEventArgs("MinSabShield");
		Class7.propertyChangedEventArgs_63 = new PropertyChangedEventArgs("ModuleType");
		Class7.Name = new PropertyChangedEventArgs("Name");
		Class7.propertyChangedEventArgs_64 = new PropertyChangedEventArgs("NextProfileName");
		Class7.propertyChangedEventArgs_65 = new PropertyChangedEventArgs("NpcId");
		Class7.NpcStats = new PropertyChangedEventArgs("NpcStats");
		Class7.propertyChangedEventArgs_66 = new PropertyChangedEventArgs("NpcWhitelist");
		Class7.propertyChangedEventArgs_67 = new PropertyChangedEventArgs("Order");
		Class7.propertyChangedEventArgs_68 = new PropertyChangedEventArgs("PalladiumCollectionAreaWidth");
		Class7.propertyChangedEventArgs_69 = new PropertyChangedEventArgs("Password");
		Class7.propertyChangedEventArgs_70 = new PropertyChangedEventArgs("PetDeaths");
		Class7.propertyChangedEventArgs_71 = new PropertyChangedEventArgs("PetMode");
		Class7.PetStats = new PropertyChangedEventArgs("PetStats");
		Class7.propertyChangedEventArgs_72 = new PropertyChangedEventArgs("Priority");
		Class7.propertyChangedEventArgs_73 = new PropertyChangedEventArgs("ProfileName");
		Class7.propertyChangedEventArgs_74 = new PropertyChangedEventArgs("ProxyString");
		Class7.propertyChangedEventArgs_75 = new PropertyChangedEventArgs("QZ_GroupSize");
		Class7.propertyChangedEventArgs_76 = new PropertyChangedEventArgs("RepairDrones");
		Class7.propertyChangedEventArgs_77 = new PropertyChangedEventArgs("Resets");
		Class7.propertyChangedEventArgs_78 = new PropertyChangedEventArgs("ReviveAtPortal");
		Class7.propertyChangedEventArgs_79 = new PropertyChangedEventArgs("Rocket");
		Class7.propertyChangedEventArgs_80 = new PropertyChangedEventArgs("SecondaryCircleNpcs");
		Class7.propertyChangedEventArgs_81 = new PropertyChangedEventArgs("Server");
		Class7.propertyChangedEventArgs_82 = new PropertyChangedEventArgs("SessionId");
		Class7.propertyChangedEventArgs_83 = new PropertyChangedEventArgs("Skylab_KeepPromerium");
		Class7.propertyChangedEventArgs_84 = new PropertyChangedEventArgs("Skylab_KeepSeprom");
		Class7.propertyChangedEventArgs_85 = new PropertyChangedEventArgs("Spinner_Alpha");
		Class7.propertyChangedEventArgs_86 = new PropertyChangedEventArgs("Spinner_Beta");
		Class7.propertyChangedEventArgs_87 = new PropertyChangedEventArgs("Spinner_Delta");
		Class7.propertyChangedEventArgs_88 = new PropertyChangedEventArgs("Spinner_Enabled");
		Class7.propertyChangedEventArgs_89 = new PropertyChangedEventArgs("Spinner_Epsilon");
		Class7.propertyChangedEventArgs_90 = new PropertyChangedEventArgs("Spinner_Gamma");
		Class7.propertyChangedEventArgs_91 = new PropertyChangedEventArgs("Spinner_Kappa");
		Class7.propertyChangedEventArgs_92 = new PropertyChangedEventArgs("Spinner_Kuiper");
		Class7.propertyChangedEventArgs_93 = new PropertyChangedEventArgs("Spinner_Lambda");
		Class7.propertyChangedEventArgs_94 = new PropertyChangedEventArgs("Spinner_PlaceGates");
		Class7.propertyChangedEventArgs_95 = new PropertyChangedEventArgs("Spinner_SpinDelay");
		Class7.propertyChangedEventArgs_96 = new PropertyChangedEventArgs("Spinner_SpinSize");
		Class7.propertyChangedEventArgs_97 = new PropertyChangedEventArgs("Spinner_StopABG");
		Class7.propertyChangedEventArgs_98 = new PropertyChangedEventArgs("Spinner_UsePhoenix");
		Class7.propertyChangedEventArgs_99 = new PropertyChangedEventArgs("Spinner_UseUridium");
		Class7.propertyChangedEventArgs_100 = new PropertyChangedEventArgs("Spinner_Zeta");
		Class7.Spins = new PropertyChangedEventArgs("Spins");
		Class7.propertyChangedEventArgs_101 = new PropertyChangedEventArgs("TargetMap");
		Class7.propertyChangedEventArgs_102 = new PropertyChangedEventArgs("TimeTable");
		Class7.propertyChangedEventArgs_103 = new PropertyChangedEventArgs("TimeTableActive");
		Class7.propertyChangedEventArgs_104 = new PropertyChangedEventArgs("TimeTableUseUtc");
		Class7.propertyChangedEventArgs_105 = new PropertyChangedEventArgs("Use3D");
		Class7.propertyChangedEventArgs_106 = new PropertyChangedEventArgs("UseKamikaze");
		Class7.propertyChangedEventArgs_107 = new PropertyChangedEventArgs("UseMothToKillCorners");
		Class7.propertyChangedEventArgs_108 = new PropertyChangedEventArgs("UseOffensiveAbility");
		Class7.propertyChangedEventArgs_109 = new PropertyChangedEventArgs("UsePetLocator");
		Class7.propertyChangedEventArgs_110 = new PropertyChangedEventArgs("UserAgent");
		Class7.propertyChangedEventArgs_111 = new PropertyChangedEventArgs("UserId");
		Class7.propertyChangedEventArgs_112 = new PropertyChangedEventArgs("Username");
		Class7.propertyChangedEventArgs_113 = new PropertyChangedEventArgs("UseRocketPrecision");
		Class7.propertyChangedEventArgs_114 = new PropertyChangedEventArgs("UseSab");
		Class7.Value = new PropertyChangedEventArgs("Value");
		Class7.propertyChangedEventArgs_115 = new PropertyChangedEventArgs("Volatile");
	}
	...
	internal static readonly PropertyChangedEventArgs MoqMrUatYqs;
	...
	internal static readonly PropertyChangedEventArgs krqMrQduOiI;
