...
internal static class Class7
{
	...
	static Class7()
	{
		...
		Class7.mfSoYujxgbc = new PropertyChangedEventArgs("CollectCargo");
		Class7.propertyChangedEventArgs_11 = new PropertyChangedEventArgs("CollectGoldBooty");
		Class7.propertyChangedEventArgs_12 = new PropertyChangedEventArgs("CollectGreenBooty");
		Class7.propertyChangedEventArgs_13 = new PropertyChangedEventArgs("CollectMaterials");
		Class7.propertyChangedEventArgs_14 = new PropertyChangedEventArgs("Collector");
		Class7.propertyChangedEventArgs_15 = new PropertyChangedEventArgs("CollectPalladium");
		...
		Class7.propertyChangedEventArgs_16 = new PropertyChangedEventArgs("DefaultHellstorm");
		Class7.propertyChangedEventArgs_17 = new PropertyChangedEventArgs("DefaultLaser");
		Class7.propertyChangedEventArgs_18 = new PropertyChangedEventArgs("DefaultRocket");
		Class7.propertyChangedEventArgs_19 = new PropertyChangedEventArgs("DroneFormation");
		...
		Class7.propertyChangedEventArgs_20 = new PropertyChangedEventArgs("EarnedJackpot");
		Class7.propertyChangedEventArgs_21 = new PropertyChangedEventArgs("EarnedSAB");
		Class7.EarnedUridium = new PropertyChangedEventArgs("EarnedUridium");
		Class7.propertyChangedEventArgs_22 = new PropertyChangedEventArgs("EarnedX1");
		Class7.propertyChangedEventArgs_23 = new PropertyChangedEventArgs("EarnedX2");
		Class7.propertyChangedEventArgs_24 = new PropertyChangedEventArgs("EarnedX3");
		Class7.DtAoYzgVolf = new PropertyChangedEventArgs("EarnedX4");
		...
		Class7.propertyChangedEventArgs_26 = new PropertyChangedEventArgs("First");
		Class7.propertyChangedEventArgs_27 = new PropertyChangedEventArgs("FleeConfig");
		Class7.propertyChangedEventArgs_28 = new PropertyChangedEventArgs("FleeFormation");
		Class7.propertyChangedEventArgs_29 = new PropertyChangedEventArgs("FleeFromEnemyAttacker");
		Class7.propertyChangedEventArgs_30 = new PropertyChangedEventArgs("FleeFromEnemySeen");
		Class7.propertyChangedEventArgs_31 = new PropertyChangedEventArgs("FleeOnlyFromKnownEnemySeen");
		...
		Class7.kbBoeOnLvYq = new PropertyChangedEventArgs("HangarPalladiumCollect");
		Class7.propertyChangedEventArgs_42 = new PropertyChangedEventArgs("HangarPalladiumSell");
		Class7.propertyChangedEventArgs_43 = new PropertyChangedEventArgs("HasLicense");
		Class7.nfYoekhXaSL = new PropertyChangedEventArgs("HasNextProfile");
		Class7.propertyChangedEventArgs_44 = new PropertyChangedEventArgs("Hellstorm");
		Class7.HeroStats = new PropertyChangedEventArgs("HeroStats");
		Class7.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("Hunter");
		Class7.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("IgnoreOwnership");
		Class7.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("JumpGGLastLife");
		Class7.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("KamikazeConfig");
		Class7.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("KamikazeFormation");
		Class7.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("Key");
		Class7.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("Laser");
		Class7.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("LastError");
		Class7.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("MapCooldown");
		Class7.propertyChangedEventArgs_54 = new PropertyChangedEventArgs("MapDuration");
		Class7.MapName = new PropertyChangedEventArgs("MapName");
		Class7.propertyChangedEventArgs_55 = new PropertyChangedEventArgs("Maps");
		Class7.propertyChangedEventArgs_56 = new PropertyChangedEventArgs("MaxDeaths");
		Class7.propertyChangedEventArgs_57 = new PropertyChangedEventArgs("MinHealHp");
		Class7.propertyChangedEventArgs_58 = new PropertyChangedEventArgs("MinHp");
		Class7.propertyChangedEventArgs_59 = new PropertyChangedEventArgs("MinSabShield");
		Class7.propertyChangedEventArgs_60 = new PropertyChangedEventArgs("ModuleType");
		Class7.Name = new PropertyChangedEventArgs("Name");
		Class7.propertyChangedEventArgs_61 = new PropertyChangedEventArgs("NextProfileName");
		Class7.propertyChangedEventArgs_62 = new PropertyChangedEventArgs("NpcId");
		Class7.NpcStats = new PropertyChangedEventArgs("NpcStats");
		Class7.propertyChangedEventArgs_63 = new PropertyChangedEventArgs("NpcWhitelist");
		Class7.propertyChangedEventArgs_64 = new PropertyChangedEventArgs("Order");
		Class7.propertyChangedEventArgs_65 = new PropertyChangedEventArgs("PalladiumCollectionAreaWidth");
		Class7.propertyChangedEventArgs_66 = new PropertyChangedEventArgs("Password");
		Class7.propertyChangedEventArgs_67 = new PropertyChangedEventArgs("PetDeaths");
		Class7.propertyChangedEventArgs_68 = new PropertyChangedEventArgs("PetMode");
		Class7.PetStats = new PropertyChangedEventArgs("PetStats");
		Class7.propertyChangedEventArgs_69 = new PropertyChangedEventArgs("Priority");
		Class7.propertyChangedEventArgs_70 = new PropertyChangedEventArgs("ProfileName");
		Class7.propertyChangedEventArgs_71 = new PropertyChangedEventArgs("ProxyString");
		Class7.propertyChangedEventArgs_72 = new PropertyChangedEventArgs("QZ_GroupSize");
		Class7.tenoeDtTjgd = new PropertyChangedEventArgs("RepairDrones");
		Class7.propertyChangedEventArgs_73 = new PropertyChangedEventArgs("Resets");
		Class7.propertyChangedEventArgs_74 = new PropertyChangedEventArgs("ReviveAtPortal");
		Class7.propertyChangedEventArgs_75 = new PropertyChangedEventArgs("Rocket");
		Class7.propertyChangedEventArgs_76 = new PropertyChangedEventArgs("SecondaryCircleNpcs");
		Class7.propertyChangedEventArgs_77 = new PropertyChangedEventArgs("Server");
		Class7.propertyChangedEventArgs_78 = new PropertyChangedEventArgs("SessionId");
		Class7.propertyChangedEventArgs_79 = new PropertyChangedEventArgs("Skylab_KeepPromerium");
		...
		Class7.gbrolhxyfvp = new PropertyChangedEventArgs("TimeTableUseUtc");
		Class7.propertyChangedEventArgs_100 = new PropertyChangedEventArgs("Use3D");
		Class7.propertyChangedEventArgs_101 = new PropertyChangedEventArgs("UseKamikaze");
		Class7.propertyChangedEventArgs_102 = new PropertyChangedEventArgs("UseMothToKillCorners");
		Class7.propertyChangedEventArgs_103 = new PropertyChangedEventArgs("UseOffensiveAbility");
		Class7.propertyChangedEventArgs_104 = new PropertyChangedEventArgs("UsePetLocator");
		Class7.propertyChangedEventArgs_105 = new PropertyChangedEventArgs("UserAgent");
		Class7.propertyChangedEventArgs_106 = new PropertyChangedEventArgs("UserId");
		Class7.fdXolxBejSE = new PropertyChangedEventArgs("Username");
		Class7.propertyChangedEventArgs_107 = new PropertyChangedEventArgs("UseRocketPrecision");
		Class7.propertyChangedEventArgs_108 = new PropertyChangedEventArgs("UseSab");
		Class7.Value = new PropertyChangedEventArgs("Value");
		Class7.propertyChangedEventArgs_109 = new PropertyChangedEventArgs("Volatile");
	}
	...
	internal static readonly PropertyChangedEventArgs mfSoYujxgbc;
	...
	internal static readonly PropertyChangedEventArgs DtAoYzgVolf;
	...
	internal static readonly PropertyChangedEventArgs kbBoeOnLvYq;
	...
	internal static readonly PropertyChangedEventArgs nfYoekhXaSL;
	...
	internal static readonly PropertyChangedEventArgs tenoeDtTjgd;
	...
	internal static readonly PropertyChangedEventArgs gbrolhxyfvp;
	...
	internal static readonly PropertyChangedEventArgs fdXolxBejSE;
