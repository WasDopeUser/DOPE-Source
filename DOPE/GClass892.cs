...
public abstract class GClass892 : INotifyPropertyChanged
{
	public string Name
	{
		[CompilerGenerated]
		...
		protected set
		{
			...
			this.string_0 = value;
			this.method_0(Class10.propertyChangedEventArgs_36);
	...
	public virtual GClass904 GetBehavior()
	{
		if (this.C.Map.IsGG)
		{
			return this.C.gclass914_0;
		}
		if (this.C.Map.MapName.StartsWith("4-"))
		{
			return this.C.gclass912_0;
		}
		if (this.C.Map.MapId == 92)
		{
			return this.C.gclass909_0;
		}
		...
		{
			return this.C.gclass907_0;
		}
		return this.C.gclass904_0;
	}
	...
	public virtual void HandleError(GClass892.GEnum10 genum10_0)
	{
