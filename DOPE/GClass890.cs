...
public class GClass890 : INotifyPropertyChanged, ILogManager, IPErkavaBotController
{
	public Collectible CollectibleTarget
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_9);
		}
	}
	...
	public bool IsAttacking
	{
		...
		set
		{
			...
			this.bool_0 = value;
			this.method_91(Class10.propertyChangedEventArgs_25);
		}
	}
	...
	public bool IsCollecting
	{
		...
		set
		{
			...
			this.bool_1 = value;
			this.method_91(Class10.propertyChangedEventArgs_26);
		}
	}
	...
	public int AttackingId
	{
		...
		set
		{
			...
			this.int_0 = value;
			this.method_91(Class10.propertyChangedEventArgs_0);
		}
	}
	...
	public void method_8(Ship ship_1)
	{
		...
		if (this.IsAttacking && ship_1.Id == this.AttackingId && !this.Game.Hero.LastAttacked.Cooldown(2000))
		{
			if (this.IsAttacking)
			{
				...
				if (ship_1.LastTookDamageHero.smethod_0(3000) && this.Behavior.RvcjkXariys(ship_1).GroupAttackMode == GroupAttackMode.Assist && this.Cooldowns.method_2(BotAction.PingLocation, 3000.0))
				{
	...
	public bool method_10<GRg0bpuvg07fuNyQwZa>(string string_4, Func<DarkOrbitWebAPI, GRg0bpuvg07fuNyQwZa> func_0, out GRg0bpuvg07fuNyQwZa gparam_0)
	{
		GClass890.<>c__DisplayClass33_0<GRg0bpuvg07fuNyQwZa> CS$<>8__locals1 = new GClass890.<>c__DisplayClass33_0<GRg0bpuvg07fuNyQwZa>();
		CS$<>8__locals1.f = func_0;
		CS$<>8__locals1.<>4__this = this;
		CS$<>8__locals1.key = string_4;
		gparam_0 = default(GRg0bpuvg07fuNyQwZa);
		object obj;
		...
		if (obj is GRg0bpuvg07fuNyQwZa)
		{
			GRg0bpuvg07fuNyQwZa grg0bpuvg07fuNyQwZa = (GRg0bpuvg07fuNyQwZa)((object)obj);
			object obj2;
			this.concurrentDictionary_0.TryRemove(CS$<>8__locals1.key, out obj2);
			gparam_0 = grg0bpuvg07fuNyQwZa;
			return true;
		}
		return false;
	}

	private bool mqiQdyFohqS(int int_11)
	{
	...
	public bool method_12(bool bool_13, bool bool_14 = false)
	{
		...
		Gate gate_;
		Vector2? vector = this.Behavior.vmethod_16(this.Map.Hero.Position, out gate_, bool_14, bool_13);
		if (vector == null)
		{
			return false;
		}
		...
		{
			vector = this.Behavior.vmethod_16(this.Map.Hero.Position, out gate_, bool_14, true);
		}
	...
	public void method_15()
	{
		...
		if (this.Map.IsGG && this.Behavior.vmethod_23())
		{
	...
	public bool method_22()
	{
		...
		{
			SelectedNpcModel selectedNpcModel = this.Behavior.RvcjkXariys(selectedShip);
	...
	public ErrorReason LastDisconnectReason
	{
		...
		set
		{
			...
			this.method_23();
			this.method_91(Class10.LastDisconnectReason);
		}
	}
	...
	public MapProfile MapProfile
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_38);
		}
	}
	...
	public AccountSettings Account
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_22);
			this.method_91(Class10.propertyChangedEventArgs_35);
			this.method_91(Class10.Account);
		}
	}
	...
	public GClass888 Scheduler
	{
		...
		set
		{
			...
			this.method_91(Class10.Scheduler);
		}
	}
	...
	public int RealDist
	{
		...
		set
		{
			...
			this.int_1 = value;
			this.method_91(Class10.propertyChangedEventArgs_43);
		}
	}
	...
	public DateTime LastLogin
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_32);
		}
	}
	...
	public DateTime LastMapLogin
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_33);
		}
	}
	...
	public bool IsEnabled
	{
		...
		set
		{
			...
			this.bool_2 = value;
			this.method_91(Class10.propertyChangedEventArgs_27);
		}
	}
	...
	public bool Run
	{
		...
		set
		{
			...
			this.bool_3 = value;
			this.method_91(Class10.propertyChangedEventArgs_46);
		}
	}
	...
	public bool IsStopping
	{
		...
		set
		{
			...
			this.bool_4 = value;
			this.method_91(Class10.propertyChangedEventArgs_28);
		}
	}
	...
	public Thread BotThread
	{
		...
		set
		{
			...
			this.thread_0 = value;
			this.method_91(Class10.propertyChangedEventArgs_6);
		}
	}
	...
	public ConcurrentQueue<Func<DarkOrbitWebAPI, object>> BackgroundQueue
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_1);
		}
	}
	...
	public Task LastBackgroundAction
	{
		...
		internal set
		{
			...
			this.task_0 = value;
			this.method_91(Class10.propertyChangedEventArgs_30);
		}
	}
	...
	public Task LastBackgroundHandlerAction
	{
		...
		internal set
		{
			...
			this.task_1 = value;
			this.method_91(Class10.propertyChangedEventArgs_31);
		}
	}
	...
	public UsageCounter<int> EnemyLocated
	{
		...
		protected set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_18);
		}
	}
	...
	public void method_28()
	{
		...
		int num;
		PetMode petMode = this.Behavior.vmethod_30(out num);
	...
	public bool method_29()
	{
		...
		else if (this.Game.Hero.HpPercentage < (float)this.MapProfile.MinHp && this.Behavior.vmethod_23() && GClass890.botState_2.HasFlag(this.State))
		{
	...
	public Ship EnemyTarget
	{
		...
		set
		{
			...
			this.ship_0 = value;
			this.method_91(Class10.propertyChangedEventArgs_19);
		}
	}
	...
	public bool method_30()
	{
		...
		else
		{
			...
			if (this.Behavior.vmethod_11(this.EnemyTarget, this.CollectibleTarget))
			{
				botState_ = BotState.Collect;
			}
			else
	...
	public void method_31()
	{
		...
		if (this.Behavior.vmethod_22() && ((this.Game.Hero.HpPercentage < 98f && this.Hero.method_16("equipment_extra_repbot_rep")) || (!this.ignoreShields && this.Game.Hero.ShieldPercentage < 90f)) && this.dateTimeOffset_3.Cooldown(10000))
		{
			this.method_66(BotState.Repair);
			return;
		}
		...
		if (this.IsStopping && this.Behavior.frijklxAtwW())
		{
		...
		int num;
		if (!this.VfoQqoxikXF(out num))
		{
			this.Clear();
			this.method_66(this.Behavior.vmethod_14());
			return;
		}
		Gate gate = this.Behavior.vmethod_21(num);
		if (gate != null)
		{
		...
		if (num2 > 400)
		{
			this.method_64((GClass892.GEnum10)2);
			return;
		}
	}
	...
	public DateTime? Timeout
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_54);
		}
	}
	...
	public void method_33()
	{
		...
		if (!this.Behavior.vmethod_23())
		{
			this.method_67();
			return;
		}
		if (this.Game.Hero.Hp == 0 && this.StateIters > 200 && this.Game.Connection.Socket.method_1())
		{
		...
		if ((this.bool_6 ^ this.bool_7) && this.mqiQdyFohqS(this.bool_6 ? 2 : 1))
		{
			this.int_4++;
		}
	}
	...
	public Vector2 RoamTarget
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_45);
		}
	}
	...
	public void method_35()
	{
		...
		Vector2? vector;
		if (!this.Behavior.vmethod_20(out vector))
		{
			Collectible collectible = this.method_76(this.HeroPosition);
			if (collectible != null)
			{
			...
			{
				this.RoamTarget = this.Game.Security.method_5(this.Game.Map, this.Behavior.vmethod_13());
			}
		}
		else
		{
	...
	public Vector2? TravelTarget
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_57);
		}
	}
	...
	public PathSequence CurrentPath
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_14);
		}
	}
	...
	public UsageCounter<string> BoxTracker
	{
		...
		private set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_7);
		}
	}
	...
	public void method_41()
	{
		...
		if (this.Behavior.vmethod_44(npcShip))
		{
			return;
		}
		Func<bool> func = this.Behavior.vmethod_44(npcShip) ? new Func<bool>(CS$<>8__locals1.method_0) : new Func<bool>(CS$<>8__locals1.method_1);
		if (selectedShip != null)
		{
			if (selectedShip.Id == CS$<>8__locals1.ship_0.Id)
			{
				...
				if (flag)
				{
					Vector2? vector2 = this.Behavior.vmethod_39(this.HeroPosition, npcShip, vector);
					if (vector2 != null)
					{
	...
	public Vector2 HeroPosition
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_23);
		}
	}
	...
	public GClass922 Controller
	{
		...
		internal set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_37);
			this.method_91(Class10.Controller);
		}
	}
	...
	public Task LoginTask
	{
		...
		internal set
		{
			...
			this.task_2 = value;
			this.method_91(Class10.propertyChangedEventArgs_36);
		}
	}
	...
	public void method_44()
	{
		...
		for (;;)
		{
			...
			{
				if (this.Game.Connection.Socket.method_1())
				{
					if (++num3 > 400)
					{
			...
			Thread.Sleep(300);
			while (this.Game.Connection.Socket.method_1() && !this.IsPaused && this.Run && this.Hero.IsInitialized)
			{
				Thread.Sleep(50);
	...
	private void method_47(GameManager gameManager_1, GClass268 gclass268_0)
	{
	...
	private void method_48(string[] string_4)
	{
		...
		if (string_4.Length != 3 || !(string_4[1] == "range") || !int.TryParse(string_4[2], out num))
		{
			if (string_4.Length == 2 && string_4[1] == "distance")
			{
				...
				if (ship != null)
				{
					this.method_90(string.Format("Distance to {0}: {1}", ship.Name, Vector2.Distance(this.Map.Hero.Position, ship.Position)));
					return;
				}
			}
			else
			{
				...
				else if (string_4.Length == 4 && string_4[1] == "res")
				{
					...
					if (flag2)
					{
						proxySocket3.SendMessage(new GClass182(text2, this.Game.Hero.PosX, this.Game.Hero.PosY, new GClass259(8)));
						return;
					}
				...
				else
				{
					...
					else if (string_4.Length == 3 && string_4[1] == "init" && string_4[2] == "gate")
					{
						...
						this.method_90(string.Format("Init Gate #{0} dist={1:0.00} active={2}", gate2.Id, num6, gate2.Activatable));
	...
	private void method_49(Map map_0, Ship ship_1, GClass265 gclass265_0)
	{
	...
	private void method_54(Map map_0, Ship ship_1, Ship ship_2, int int_11, int int_12)
	{
		if (ship_1 != null && ship_2 != null)
		{
			...
			{
				if (this.method_78(ship_1) || !ship_1.IsNpc)
				{
	...
	private void AxuQdtrIuPG(GClass91 gclass91_0, ErrorReason errorReason_1, Exception exception_0 = null)
	{
		DateTime now = DateTime.Now;
	...
	private void method_58(GameManager gameManager_1, Hero hero_0, GClass215 gclass215_0, bool bool_13)
	{
		...
		this.method_61<GClass917>().imethod_1();
		this.Timeout = null;
		if (this.IsPaused)
		{
			return;
		...
		CS$<>8__locals2.int_0 = ((behavior != null) ? behavior.vmethod_43() : 1);
		int val = CS$<>8__locals1.gclass215_0.vector_0.Max(new Func<GClass583, int>(GClass890.<>c.<>c_0.method_6));
	...
	public GameManager Game
	{
		...
		set
		{
			...
			this.method_91(Class10.Hero);
			this.method_91(Class10.propertyChangedEventArgs_24);
			this.method_91(Class10.propertyChangedEventArgs_50);
			this.method_91(Class10.Map);
			this.method_91(Class10.propertyChangedEventArgs_17);
			this.method_91(Class10.propertyChangedEventArgs_51);
			this.method_91(Class10.Game);
		}
	}
	...
	public BotState ReturnState
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_44);
		}
	}
	...
	public MaxStack<BotState> LastStates
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_34);
		}
	}
	...
	public CooldownTracker<BotAction> Cooldowns
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_13);
		}
	}
	...
	public bool ShouldBeDisabled
	{
		...
		set
		{
			...
			this.bool_10 = value;
			this.method_91(Class10.propertyChangedEventArgs_52);
		}
	}
	...
	public bool ForceLogout
	{
		...
		set
		{
			...
			this.bool_11 = value;
			this.method_91(Class10.propertyChangedEventArgs_20);
		}
	}
	...
	public bool IsPaused
	{
		...
		set
		{
			...
			this.bool_12 = value;
			this.method_91(Class10.IsPaused);
		}
	}
	...
	public GClass904 Behavior
	{
		...
		private set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_2);
		}
	}
	...
	public ltQ8dEugntOXsetwhLo method_61<ltQ8dEugntOXsetwhLo>() where ltQ8dEugntOXsetwhLo : GClass916
	{
		return this.method_60().First(new Func<GInterface9, bool>(GClass890.<>c__297<ltQ8dEugntOXsetwhLo>.<>9.method_0)) as ltQ8dEugntOXsetwhLo;
	}
	...
	private void method_63()
	{
		...
		this.Game.Connection.Socket.Disconnected += this.AxuQdtrIuPG;
	...
	public bool AttachPErkava(GClass238 obj)
	{
		...
		if (game.Connection.Socket.method_1())
		{
	...
	public void method_64(GClass892.GEnum10 genum10_0)
	{
	...
	public int StateIters
	{
		...
		set
		{
			...
			this.int_9 = value;
			this.method_91(Class10.propertyChangedEventArgs_53);
		}
	}
	...
	public CooldownTracker<int> NpcLockout
	{
		...
		set
		{
			...
			this.method_91(Class10.propertyChangedEventArgs_40);
		}
	}
	...
	public string SelectedAmmo
	{
		...
		set
		{
			...
			this.string_1 = value;
			this.method_91(Class10.propertyChangedEventArgs_47);
		}
	}
	...
	public string SelectedRockets
	{
		...
		set
		{
			...
			this.string_2 = value;
			this.method_91(Class10.VnhQjplZey4);
		}
	}
	...
	public string SelectedHS
	{
		...
		set
		{
			...
			this.string_3 = value;
			this.method_91(Class10.propertyChangedEventArgs_48);
		}
	}
	...
	public NpcShip IqfQqchDeZQ(int int_11 = 0)
	{
	...
	public bool method_74()
	{
		...
		this.EnemyTarget = this.IqfQqchDeZQ(0);
	...
	public bool VfoQqoxikXF(out int int_11)
	{
		int_11 = 0;
		return this.Behavior.vmethod_12() && this.Module.TrySwitchMap(out int_11);
	}
	...
	public Collectible method_76(Vector2 vector2_2)
	{
	...
	public Gate method_77(int int_11)
	{
		return this.Behavior.vmethod_21(int_11);
	}

	public bool method_78(Ship ship_1)
	{
	...
	{
		this.nullable_1 = new Vector2?(this.Game.Security.method_5(this.Map, this.Behavior.vmethod_13()));
	}
	...
	private void method_88()
	{
		...
		if (num > 500)
		{
			this.method_64((GClass892.GEnum10)1);
		}
	}
	...
	{
		return this.method_78(keyValuePair_0.Value);
	}

	[CompilerGenerated]
	private void method_90(string string_4)
	{
		GInterface5 proxySocket = this.Game.Connection.ProxySocket;
		if (proxySocket == null)
		{
		...
		proxySocket.SendMessage(new GClass268(GClass90.Log(string_4)));
	}

	[GeneratedCode("PropertyChanged.Fody", "3.2.3.0")]
	[DebuggerNonUserCode]
	protected void method_91(PropertyChangedEventArgs propertyChangedEventArgs_0)
	{
		PropertyChangedEventHandler propertyChanged = this.PropertyChanged;
		if (propertyChanged != null)
		{
