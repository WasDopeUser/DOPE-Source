...
public class GClass913 : GClass903
{
	public GClass913(GClass889 gclass889_1)
	{
	...
	{
		bool flag;
		return npcShip_0 != null && (npcShip_0.HpPercentage <= 24.75f || base.Map.mdGbaKqNuQ(npcShip_0, out flag));
	}
	...
	protected virtual bool vmethod_53(Ship ship_0, Ship ship_1)
	{
		...
		double num2 = (this.method_29() || flag) ? 0.0 : Math.Abs(GClass872.smethod_4(ship_0.Position - base.Context.HeroPosition, ship_1.Position - base.Context.HeroPosition));
	...
	public override bool vmethod_1(Ship ship_0, out Ship ship_1)
	{
		...
		if (base.C.AttackingId == ship_0.Id && this.vmethod_51(ship_0 as NpcShip) && ship_0.HpPercentage < 24.75f && base.C.float_0 >= 24.75f && base.C.method_74().Any(new Func<NpcShip, bool>(this.method_39)))
		{
	...
	{
		return base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(this.method_40)) && !this.vmethod_4(true, false);
	}
	...
	{
		return !base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass913.<>c.<>c_0.method_0)) && base.C.Map.Gates.Any<KeyValuePair<int, Gate>>() && !base.C.method_76() && base.C.DormantTargets.Count == 0 && base.C.Game.Web.GgInfo != null;
	}

	public override bool vmethod_24(out Vector2? nullable_0)
	{
		if (!base.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass913.<>c.<>c_0.method_1)) && !base.Map.Collectibles.Any<KeyValuePair<string, Collectible>>() && !base.Map.Gates.Any<KeyValuePair<int, Gate>>())
		{
			nullable_0 = null;
			return true;
		}
	...
	public override bool vmethod_4(bool bool_8 = false, bool bool_9 = false)
	{
		...
		Ship ship = base.C.Map.method_5<Ship>(heroPosition, new Func<Ship, bool>(GClass913.<>c.<>c_0.method_2), null, 0);
	...
	public override bool vmethod_19(GClass891 gclass891_0)
	{
		...
		{
			GClass899 gclass = gclass891_0 as GClass899;
	...
	{
		GClass913.<>c__DisplayClass16_0 CS$<>8__locals1 = new GClass913.<>c__DisplayClass16_0();
		Map map = base.C.Map;
	...
	{
		GClass913.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass913.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass913_0 = this;
		Vector2? vector = null;
		CS$<>8__locals1.vector2_0 = base.C.HeroPosition;
		if (base.C.Map.method_5<Ship>(CS$<>8__locals1.vector2_0, new Func<Ship, bool>(GClass913.<>c.<>c_0.method_3), null, 0) == null)
		{
			vector = new Vector2?(base.C.Map.Center);
		}
		else if (this.method_29())
		{
			vector = this.vmethod_39(CS$<>8__locals1.vector2_0, base.C.Map.Center, (float)base.C.Map.MapSize.Height * 0.4f, null, this.method_31() ? -0.5f : 0.5f);
		}
		else
		{
	...
	public override int vmethod_9(NpcShip npcShip_0)
	{
		...
		bool flag;
		if (num > -100 && base.Map.mdGbaKqNuQ(npcShip_0, out flag))
		{
			return -100;
		}
		...
		int num2;
		if (@class != null && GClass913.dictionary_0.TryGetValue(@class, out num2))
		{
			num = num2;
		}
	...
	{
		int range;
		if (npcShip_0.Type.Class != null && GClass913.OyjwCbnLaEX.TryGetValue(npcShip_0.Type.Class, out range))
		{
	...
	{
		GClass899 gclass = base.C.Module as GClass899;
		if (gclass == null)
		{
			return null;
		}
	...
	{
		GClass913.<>c__DisplayClass29_0 CS$<>8__locals1 = new GClass913.<>c__DisplayClass29_0();
		CS$<>8__locals1.gclass913_0 = this;
		...
		else if (base.C.MapProfile.GG_UseKamikazeCorner)
		{
			...
			bool flag2;
			if ((attackingId == num.GetValueOrDefault() & num != null) && base.Map.mdGbaKqNuQ(enemyTarget, out flag2))
			{
				flag = true;
			}
		}
	...
	{
		GClass913.<>c__DisplayClass34_0 CS$<>8__locals1 = new GClass913.<>c__DisplayClass34_0();
		CS$<>8__locals1.gclass913_0 = this;
	...
	public override Vector2? vmethod_46(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		...
		if (vector != null && this.method_33().Cooldown(10000))
		{
			...
			this.method_32(GClass872.smethod_2(vector2_1.Y - center.Y, vector2_1.X - center.X, value.Y - center.Y, value.X - center.X));
		...
		PointF pointF;
		PointF pointF2;
		int num3 = GClass877.smethod_0(center.X, center.Y, num2, vector2.X, vector2.Y, (float)num, out pointF, out pointF2);
		double num4;
		if (num3 == 2)
		{
			num4 = GClass872.smethod_3(pointF.Y - center.Y, pointF.X - center.X, pointF2.Y - center.Y, pointF2.X - center.X, false);
		}
		else
		{
			num4 = Math.Atan2((double)(vector2.X - center.X), (double)(vector2.Y - center.Y)) + (double)(this.method_31() ? -0.5f : 0.5f);
		}
		Vector2 value2 = GClass872.smethod_8(center, num2, (float)num4);
		if (num3 != 0)
		{
			this.method_30(true);
	...
	{
		this.method_36(this.vmethod_55());
		base.Update();
		this.method_28(this.vmethod_56());
	...
	{
		Class13.xnk8ImWzpOt04();
		GClass913.dictionary_0 = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
		...
		GClass913.OyjwCbnLaEX = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
	...
	{
		bool flag;
		return npcShip_0.HpPercentage > 24.75f && !base.C.Map.mdGbaKqNuQ(npcShip_0, out flag) && Vector2.Distance(base.C.HeroPosition, npcShip_0.Position) < 1200f;
	}
	...
	{
		bool flag;
		return keyValuePair_0.Value.IsNpc && keyValuePair_0.Value.HpPercentage > 24.75f && !base.C.Map.mdGbaKqNuQ(keyValuePair_0.Value, out flag);
	}
	...
	public static Dictionary<NpcUtils.NpcClass, int> OyjwCbnLaEX;
