...
public class GClass116 : GInterface4
{
	...
	public void method_0(GClass126 gclass126_0)
	{
		...
		if (gclass126_0.gclass130_0.uint_0 != 35U)
		{
			if (gclass126_0.gclass130_0.uint_0 != 36U)
			{
				...
				{
					asset = new BattlestationModule(gclass126_0.int_3, gclass126_0.int_2);
					goto IL_89;
				}
				asset = new Asset(gclass126_0.int_3, gclass126_0.int_2);
				goto IL_89;
			}
		}
		asset = (map.Battlestation = new Battlestation(gclass126_0.int_3, gclass126_0.int_2));
		IL_89:
		if (asset != null)
		{
			asset.method_0(gclass126_0);
			map.Assets[gclass126_0.int_4] = asset;
	...
	{
		this.Map.pLpalbrlAr(gclass180_0);
	}
