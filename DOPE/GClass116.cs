...
public class GClass116 : GInterface4
{
	...
	public void BkqssdripY(GClass126 gclass126_0)
	{
		...
		if (gclass126_0.gclass130_0.uint_0 != 35U)
		{
			if (gclass126_0.gclass130_0.uint_0 != 36U)
			{
				...
				{
					asset = new BattlestationModule(gclass126_0.int_6, gclass126_0.int_3);
					goto IL_89;
				}
				asset = new Asset(gclass126_0.int_6, gclass126_0.int_3);
				goto IL_89;
			}
		}
		asset = (map.Battlestation = new Battlestation(gclass126_0.int_6, gclass126_0.int_3));
		IL_89:
		if (asset != null)
		{
	...
	public void method_0(GClass190 gclass190_0)
	{
	...
	public void method_2(GClass246 gclass246_0)
	{
		this.Map.method_21(gclass246_0);
	}

	public void method_3(GClass248 gclass248_0)
	{
	...
	public void method_6(GClass267 gclass267_0)
	{
		this.Map.method_23(gclass267_0);
	}

	public void method_7(GClass270 gclass270_0)
	{
	...
	public void method_15(GClass255 gclass255_0)
	{
		this.Map.method_20(gclass255_0);
	}

	public void method_16(GClass240 gclass240_0)
	{
		this.Map.method_24(gclass240_0);
	}

	public void method_17(GClass249 gclass249_0)
	{
		this.Map.FmZiqOmqp0(gclass249_0);
