...
public class GClass897 : GClass895
{
	public GClass897(GClass889 gclass889_1)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor(gclass889_1, TargetMap.FL_ATLAS_A);
	}
	...
	public override MapProfile UpdateProfile(BotProfile botProfile_1)
	{
		...
		return maps.FirstOrDefault(new Func<MapProfile, bool>(GClass897.<>c.<>c_0.method_0));
	}
