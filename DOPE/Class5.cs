...
internal static class Class5
{
	...
	static Class5()
	{
		...
		Class5.propertyChangedEventArgs_6 = new PropertyChangedEventArgs("CanMove");
		Class5.propertyChangedEventArgs_7 = new PropertyChangedEventArgs("CargoCapacity");
		Class5.propertyChangedEventArgs_8 = new PropertyChangedEventArgs("CargoDisplay");
		Class5.Center = new PropertyChangedEventArgs("Center");
		Class5.propertyChangedEventArgs_9 = new PropertyChangedEventArgs("ClanDiplomacy");
		Class5.propertyChangedEventArgs_10 = new PropertyChangedEventArgs("ClanTag");
		Class5.propertyChangedEventArgs_11 = new PropertyChangedEventArgs("Cloaked");
		Class5.xCywTyrSaDy = new PropertyChangedEventArgs("Collectibles");
		...
		Class5.ehOwktwZfVR = new PropertyChangedEventArgs("EventGateGoal");
		Class5.propertyChangedEventArgs_20 = new PropertyChangedEventArgs("EventGateKeys");
		Class5.propertyChangedEventArgs_21 = new PropertyChangedEventArgs("EventGateOpening");
		Class5.Experience = new PropertyChangedEventArgs("Experience");
		Class5.propertyChangedEventArgs_22 = new PropertyChangedEventArgs("FactionId");
		Class5.propertyChangedEventArgs_23 = new PropertyChangedEventArgs("ForcedUserAgent");
		Class5.propertyChangedEventArgs_24 = new PropertyChangedEventArgs("FreeCargo");
		Class5.propertyChangedEventArgs_25 = new PropertyChangedEventArgs("Fuel");
		Class5.Game = new PropertyChangedEventArgs("Game");
		Class5.propertyChangedEventArgs_26 = new PropertyChangedEventArgs("Gates");
		Class5.GG = new PropertyChangedEventArgs("GG");
		Class5.propertyChangedEventArgs_27 = new PropertyChangedEventArgs("GgInfo");
		...
		Class5.propertyChangedEventArgs_35 = new PropertyChangedEventArgs("Invites");
		Class5.propertyChangedEventArgs_36 = new PropertyChangedEventArgs("IsActive");
		Class5.propertyChangedEventArgs_37 = new PropertyChangedEventArgs("IsAuthenticated");
		Class5.propertyChangedEventArgs_38 = new PropertyChangedEventArgs("IsAvailable");
		Class5.propertyChangedEventArgs_39 = new PropertyChangedEventArgs("IsCloaked");
		Class5.propertyChangedEventArgs_40 = new PropertyChangedEventArgs("IsControlDisabled");
		Class5.propertyChangedEventArgs_41 = new PropertyChangedEventArgs("IsEnabled");
		Class5.propertyChangedEventArgs_42 = new PropertyChangedEventArgs("IsFighting");
		Class5.propertyChangedEventArgs_43 = new PropertyChangedEventArgs("IsGG");
		Class5.propertyChangedEventArgs_44 = new PropertyChangedEventArgs("IsInitialized");
		Class5.IsLoggedIn = new PropertyChangedEventArgs("IsLoggedIn");
		Class5.propertyChangedEventArgs_45 = new PropertyChangedEventArgs("IsLoggedOut");
		Class5.propertyChangedEventArgs_46 = new PropertyChangedEventArgs("IsNpc");
		Class5.IsOwner = new PropertyChangedEventArgs("IsOwner");
		Class5.propertyChangedEventArgs_47 = new PropertyChangedEventArgs("IsRepairNeeded");
		Class5.propertyChangedEventArgs_48 = new PropertyChangedEventArgs("IsX1");
		Class5.propertyChangedEventArgs_49 = new PropertyChangedEventArgs("Jackpot");
		Class5.propertyChangedEventArgs_50 = new PropertyChangedEventArgs("LastAttacked");
		Class5.propertyChangedEventArgs_51 = new PropertyChangedEventArgs("LastAttackedHero");
		Class5.propertyChangedEventArgs_52 = new PropertyChangedEventArgs("LastAttackedHeroDamage");
		Class5.propertyChangedEventArgs_53 = new PropertyChangedEventArgs("LastConfigSwitched");
		Class5.propertyChangedEventArgs_54 = new PropertyChangedEventArgs("LastControlDisabled");
		Class5.propertyChangedEventArgs_55 = new PropertyChangedEventArgs("LastDailyLogin");
		Class5.propertyChangedEventArgs_56 = new PropertyChangedEventArgs("LastDied");
		Class5.propertyChangedEventArgs_57 = new PropertyChangedEventArgs("LastDistance");
		Class5.propertyChangedEventArgs_58 = new PropertyChangedEventArgs("LastJumped");
		Class5.propertyChangedEventArgs_59 = new PropertyChangedEventArgs("LastPinged");
		Class5.propertyChangedEventArgs_60 = new PropertyChangedEventArgs("LastStatUpdate");
		Class5.propertyChangedEventArgs_61 = new PropertyChangedEventArgs("LastTookDamage");
		Class5.propertyChangedEventArgs_62 = new PropertyChangedEventArgs("LastTookDamageEnemy");
		Class5.propertyChangedEventArgs_63 = new PropertyChangedEventArgs("LastTookDamageFrom");
		Class5.propertyChangedEventArgs_64 = new PropertyChangedEventArgs("LastTookDamageHero");
		Class5.propertyChangedEventArgs_65 = new PropertyChangedEventArgs("LeashedBy");
		Class5.propertyChangedEventArgs_66 = new PropertyChangedEventArgs("Level");
		Class5.propertyChangedEventArgs_67 = new PropertyChangedEventArgs("LicenseExpiration");
		Class5.propertyChangedEventArgs_68 = new PropertyChangedEventArgs("LicenseState");
		Class5.propertyChangedEventArgs_69 = new PropertyChangedEventArgs("Location");
		Class5.eiQwkWcPfad = new PropertyChangedEventArgs("Log");
		Class5.propertyChangedEventArgs_70 = new PropertyChangedEventArgs("LogManager");
		...
		Class5.propertyChangedEventArgs_71 = new PropertyChangedEventArgs("MapSize");
		Class5.MemberList = new PropertyChangedEventArgs("MemberList");
		Class5.propertyChangedEventArgs_72 = new PropertyChangedEventArgs("Members");
		Class5.Mode = new PropertyChangedEventArgs("Mode");
		Class5.propertyChangedEventArgs_73 = new PropertyChangedEventArgs("ModeExtra");
		Class5.propertyChangedEventArgs_74 = new PropertyChangedEventArgs("Modes");
		Class5.Name = new PropertyChangedEventArgs("Name");
		Class5.propertyChangedEventArgs_75 = new PropertyChangedEventArgs("NextMapId");
		Class5.propertyChangedEventArgs_76 = new PropertyChangedEventArgs("NpcTypes");
		Class5.propertyChangedEventArgs_77 = new PropertyChangedEventArgs("OwnerId");
		Class5.Pet = new PropertyChangedEventArgs("Pet");
		Class5.propertyChangedEventArgs_78 = new PropertyChangedEventArgs("Position");
		Class5.propertyChangedEventArgs_79 = new PropertyChangedEventArgs("Premium");
		Class5.propertyChangedEventArgs_80 = new PropertyChangedEventArgs("ProxySettings");
		Class5.propertyChangedEventArgs_81 = new PropertyChangedEventArgs("ProxySocket");
		Class5.propertyChangedEventArgs_82 = new PropertyChangedEventArgs("Range");
		Class5.propertyChangedEventArgs_83 = new PropertyChangedEventArgs("RangeFix");
		Class5.propertyChangedEventArgs_84 = new PropertyChangedEventArgs("Rect");
		Class5.propertyChangedEventArgs_85 = new PropertyChangedEventArgs("ResourceDuranium");
		Class5.propertyChangedEventArgs_86 = new PropertyChangedEventArgs("ResourceEndurium");
		Class5.propertyChangedEventArgs_87 = new PropertyChangedEventArgs("ResourcePalladium");
		Class5.propertyChangedEventArgs_88 = new PropertyChangedEventArgs("ResourcePromerium");
		Class5.propertyChangedEventArgs_89 = new PropertyChangedEventArgs("ResourcePrometid");
		Class5.propertyChangedEventArgs_90 = new PropertyChangedEventArgs("ResourcePrometium");
		Class5.Resources = new PropertyChangedEventArgs("Resources");
		Class5.propertyChangedEventArgs_91 = new PropertyChangedEventArgs("ResourceSeprom");
		Class5.propertyChangedEventArgs_92 = new PropertyChangedEventArgs("ResourceTerbium");
		Class5.propertyChangedEventArgs_93 = new PropertyChangedEventArgs("ResourceXenomit");
		Class5.propertyChangedEventArgs_94 = new PropertyChangedEventArgs("RightCorner");
		Class5.propertyChangedEventArgs_95 = new PropertyChangedEventArgs("SecretKey");
		Class5.propertyChangedEventArgs_96 = new PropertyChangedEventArgs("Security");
		Class5.SelectedShip = new PropertyChangedEventArgs("SelectedShip");
		Class5.propertyChangedEventArgs_97 = new PropertyChangedEventArgs("Server");
		Class5.propertyChangedEventArgs_98 = new PropertyChangedEventArgs("Settings");
		Class5.propertyChangedEventArgs_99 = new PropertyChangedEventArgs("Shield");
		Class5.ShieldDisplay = new PropertyChangedEventArgs("ShieldDisplay");
		Class5.propertyChangedEventArgs_100 = new PropertyChangedEventArgs("ShieldMax");
		Class5.ShieldPercentage = new PropertyChangedEventArgs("ShieldPercentage");
		Class5.propertyChangedEventArgs_101 = new PropertyChangedEventArgs("ShipInfo");
		Class5.propertyChangedEventArgs_102 = new PropertyChangedEventArgs("Ships");
		Class5.propertyChangedEventArgs_103 = new PropertyChangedEventArgs("Sid");
		Class5.propertyChangedEventArgs_104 = new PropertyChangedEventArgs("Socket");
		Class5.ApIwulrncBf = new PropertyChangedEventArgs("Speed");
	...
	internal static readonly PropertyChangedEventArgs xCywTyrSaDy;
	...
	internal static readonly PropertyChangedEventArgs ehOwktwZfVR;
	...
	internal static readonly PropertyChangedEventArgs eiQwkWcPfad;
	...
	internal static readonly PropertyChangedEventArgs ApIwulrncBf;
