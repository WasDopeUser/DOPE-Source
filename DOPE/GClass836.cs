...
public abstract class GClass836
{
	public GClass823 Context { get; protected set; }
	...
	public GClass836(GClass823 gclass823_1)
	{
	...
	{
		GClass836.<>c__DisplayClass13_0 CS$<>8__locals1;
		...
		if (flag || flag2)
		{
			this.method_17(1.0, ref CS$<>8__locals1);
			return true;
		}
		return false;
	}
	...
	{
		GClass836.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass836_0 = this;
	...
	public virtual bool vmethod_19(GClass825 gclass825_0)
	{
		return true;
	}
	...
	{
		GClass836.<>c__DisplayClass33_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass33_0();
		...
		if (bool_3)
		{
			GClass836.<>c__DisplayClass33_1 CS$<>8__locals2 = new GClass836.<>c__DisplayClass33_1();
			...
			if (ship != null)
			{
				...
				gate_0 = CS$<>8__locals2.<>c__DisplayClass33_0_0.map_0.Gates.Where(new Func<KeyValuePair<int, Gate>, bool>(GClass836.<>c.<>c_0.method_0)).OrderByDescending(new Func<KeyValuePair<int, Gate>, float>(CS$<>8__locals2.method_1)).FirstOrDefault<KeyValuePair<int, Gate>>().Value;
				Gate gate = gate_0;
	...
	{
		GClass836.<>c__DisplayClass35_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass35_0();
		CS$<>8__locals1.hero_0 = this.C.Hero;
	...
	protected virtual IEnumerable<Vector2> vmethod_23()
	{
		...
		Vector2 vector = this.NkMlExAgsn1();
	...
	{
		GClass836.<>c__DisplayClass38_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass38_0();
		CS$<>8__locals1.gclass836_0 = this;
		...
		if (flag2)
		{
			...
			int_1 = MapUtils.smethod_9(1, this.Hero.FactionId);
		}
		if (flag)
		{
			return this.Map.Gates.FirstOrDefault(new Func<KeyValuePair<int, Gate>, bool>(CS$<>8__locals1.method_2)).Value;
		}
		return MapUtils.smethod_12(this.Map, this.Hero.Position, int_1);
	}
	...
	{
		GClass836.<>c__DisplayClass44_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass44_0();
		CS$<>8__locals1.gclass836_0 = this;
		int_1 = 0;
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		...
		using (IEnumerator<SelectedNpcModel> enumerator = this.C.MapProfile.NpcWhitelist.GetEnumerator())
		{
			...
			{
				GClass836.<>c__DisplayClass44_1 CS$<>8__locals2 = new GClass836.<>c__DisplayClass44_1();
		...
		int_1 = list.OrderByDescending(new Func<ValueTuple<int, int>, bool>(CS$<>8__locals1.method_0)).ThenBy(new Func<ValueTuple<int, int>, DateTimeOffset>(CS$<>8__locals1.method_1)).ThenByDescending(new Func<ValueTuple<int, int>, int>(GClass836.<>c.<>c_0.method_1)).FirstOrDefault<ValueTuple<int, int>>().Item1;
		return int_1 != 0;
	}

	protected virtual bool vmethod_32()
	{
		GClass836.<>c__DisplayClass45_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass45_0();
		CS$<>8__locals1.gclass836_0 = this;
		...
		if (enemyLocatorResult_ != null && enemyLocatorResult_.Found)
		{
			...
			if (((enemyLocatorResult_2 != null) ? enemyLocatorResult_2.Type : null) != null && CS$<>8__locals1.enemyLocatorResult_0.Timestamp.smethod_0(3000))
			{
				...
				if (this.method_13().method_2(CS$<>8__locals1.vector2_1, out objectEntry, 1700))
				{
				...
				if (npcShip != null && (!this.vmethod_7(npcShip) || !this.vmethod_8(npcShip)))
				{
					...
					this.method_13().method_1(CS$<>8__locals1.vector2_1, 1700);
					return false;
				}
				this.method_8(true);
				if (this.method_11() == -1)
				{
					this.method_12((npcShip != null) ? npcShip.Id : 0);
				}
				return true;
			}
		}
	...
	protected virtual Vector2 NkMlExAgsn1()
	{
	...
	{
		GClass836.<>c__DisplayClass56_0 CS$<>8__locals1 = new GClass836.<>c__DisplayClass56_0();
		CS$<>8__locals1.gclass836_0 = this;
		this.method_8(false);
		this.method_1(GroupAttackMode.Disabled);
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		List<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>> source = CS$<>8__locals1.method_0().OrderByDescending(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, int>(GClass836.<>c.<>c_0.method_2)).ToList<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>>();
		ValueTuple<GroupManager.GroupMember, SelectedNpcModel> valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass836.<>c.<>c_0.method_3));
		...
		IL_112:
		valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass836.<>c.<>c_0.method_4));
		if (valueTuple.Item2 != null)
		{
			this.method_8(true);
			this.method_3(valueTuple.Item1.Position);
	...
	})] List<ValueTuple<Vector2, int>> npcs)
	{
		...
		foreach (ValueTuple<Vector2, int> valueTuple in npcs)
		{
			float num2 = Math.Max(0f, (float)((double)valueTuple.Item2 - GClass811.smethod_13(vector2_1, vector2_2, valueTuple.Item1, true)));
	...
	public virtual Vector2? vmethod_37(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		...
		return this.vmethod_46(vector2_1, vector2_2, float_0);
	}

	public virtual Vector2? vmethod_38(Vector2 vector2_1, Vector2 vector2_2, float float_0, Vector2? nullable_0 = null, float float_1 = 0.5f)
	{
		Vector2 vector2_3 = GClass806.smethod_0(vector2_1, vector2_2, float_0, nullable_0, float_1);
		return this.vmethod_37(vector2_1, vector2_3, float_0);
	}

	public virtual int vmethod_39(Vector2 vector2_1, Vector2 vector2_2, float float_0, int int_1 = 10)
	{
		GClass836.<>c__DisplayClass62_0 CS$<>8__locals1;
		...
		float num4 = this.method_19(this.method_18(0f, ref CS$<>8__locals1), ref CS$<>8__locals1);
		int num5 = 1;
		float num6 = float.MinValue;
		float num7 = float.MinValue;
		while (num5 <= int_1 && Math.Abs(num - num2) <= 100f)
		{
			float num8 = this.method_19(this.method_18(num3 * (float)num5, ref CS$<>8__locals1), ref CS$<>8__locals1);
			num6 = Math.Max(num6, num8);
			num += num8;
			num8 = this.method_19(this.method_18(-num3 * (float)num5, ref CS$<>8__locals1), ref CS$<>8__locals1);
	...
	public virtual Vector2? vmethod_40(Vector2 vector2_1, int int_1 = 1100)
	{
		float num = 0f;
		float num2 = 0f;
		int num3 = 0;
	...
	public virtual int vmethod_41(NpcShip npcShip_0)
	{
		int val = 590;
	...
	public virtual int vmethod_42(Vector2 vector2_1, NpcShip npcShip_0, out Vector2 vector2_2)
	{
		...
		int num4 = this.vmethod_41(npcShip_0) + num2;
		int num5 = num4 / 2;
	...
	public virtual Vector2? vmethod_43(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null)
	{
		if (this.method_9() >= KamikazeState.PullingEnemies)
		{
			return this.vmethod_44(vector2_1);
		}
		if (this.vmethod_12(npcShip_0) || npcShip_0.TemporarySpeed == 0f)
		{
			nullable_0 = null;
		}
		return this.vmethod_45(vector2_1, npcShip_0, nullable_0, 0.5f);
	}

	public virtual Vector2? vmethod_44(Vector2 vector2_1)
	{
		if (this.method_9() == KamikazeState.PullingEnemies)
		{
			return null;
		...
		Vector2 vector2_2 = this.vmethod_40(vector2_1, 1100) ?? position;
		NpcShip npcShip = this.C.EnemyTarget as NpcShip;
		if (this.method_9() == KamikazeState.Activating && !this.Hero.LastTookDamage.smethod_0(2000))
		{
			Vector2? result = this.vmethod_38(vector2_1, vector2_2, 325f, null, 0.5f);
			bool flag;
			if (npcShip != null && this.Map.method_8(npcShip, out flag))
			{
				result = this.vmethod_38(vector2_1, vector2_2, 325f, new Vector2?(this.Map.Center), 0.5f);
			}
			return result;
		}
		...
		if ((lastControlDisabled > this.Hero.LastTookDamage || (this.Hero.LastTookDamage - lastControlDisabled).TotalMilliseconds <= (double)num) && (npcShip == null || !this.vmethod_12(npcShip)))
		{
			...
			Vector2 vector2_3 = GClass806.smethod_8(position, 100f, num2 + 0.6f);
			return this.vmethod_37(vector2_1, vector2_3, 100f);
		}
		return this.vmethod_38(vector2_1, position, 650f, null, 0.5f);
	}

	public virtual Vector2? vmethod_45(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		if (npcShip_0 == null)
		{
		...
		Vector2 vector2_2;
		int num2 = this.vmethod_42(vector2_1, npcShip_0, out vector2_2);
		if (float_0 != 0f)
		{
			...
			float_0 *= (float)this.vmethod_39(vector2_1, vector2_2, (float)num2, 10);
		}
		return this.vmethod_38(vector2_1, vector2_2, (float)num2, nullable_0, float_0);
	}

	public virtual Vector2? vmethod_46(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		GClass836.<>c__DisplayClass69_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass836_0 = this;
		...
		for (double num4 = 0.0; num4 < 6.2831853071795862; num4 += num)
		{
			...
			if (this.Map.Grid.method_1(CS$<>8__locals1.vector2_0.X, CS$<>8__locals1.vector2_0.Y, out num5, out num6) && (num5 != num2 || num6 != num3))
			{
				...
				{
					this.method_21(ref CS$<>8__locals1);
				}
			}
		}
	...
	public virtual bool vmethod_47(NpcShip npcShip_0)
	{
	...
	[CompilerGenerated]
	protected void method_6(bool bool_3)
	{
		this.bool_0 = bool_3;
	}
	...
	[CompilerGenerated]
	protected void method_8(bool bool_3)
	{
		this.bool_1 = bool_3;
	}
	...
	[CompilerGenerated]
	protected void method_16(bool bool_3)
	{
		this.bool_2 = bool_3;
	}
	...
	public virtual void Update()
	{
		...
		this.method_4();
		this.method_10(this.vmethod_29());
		this.method_13().method_0();
		this.method_16(this.vmethod_32());
	}

	public virtual IEnumerable<string> vmethod_48()
	{
	...
	[CompilerGenerated]
	private void method_17(double double_0, ref GClass836.<>c__DisplayClass13_0 <>c__DisplayClass13_0_0)
	{
		this.C.NpcLockout.method_1(<>c__DisplayClass13_0_0.ship_0.Id, double_0 * 10000.0);
	}

	[CompilerGenerated]
	private Vector2 method_18(float float_0, ref GClass836.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return GClass806.smethod_8(<>c__DisplayClass62_0_0.vector2_0, <>c__DisplayClass62_0_0.float_0, <>c__DisplayClass62_0_0.float_1 + float_0);
	}

	[CompilerGenerated]
	private float method_19(Vector2 vector2_1, ref GClass836.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return this.vmethod_34(vector2_1) + this.vmethod_35(vector2_1, <>c__DisplayClass62_0_0.list_0);
	}

	[CompilerGenerated]
	private float method_20(ref GClass836.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
	...
	[CompilerGenerated]
	private void method_21(ref GClass836.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
		float num = this.method_20(ref <>c__DisplayClass69_0_0);
