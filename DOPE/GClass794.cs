...
{
	public GClass794(Vector<uint> vector_5, Vector<uint> vector_6)
	{
	...
	private void method_0()
	{
		...
		this.method_12(vector, 0U, vector, 4U, 4U);
		int num5 = 0;
		...
		this.method_12(vector, 8U, vector, 12U, 4U);
		...
		this.method_12(vector, 256U, this.vector_0, 0U, 512U);
		this.method_12(vector, 768U, this.vector_1, 0U, 512U);
		for (int j = 0; j < 512; j++)
		{
			this.vector_0[j] = this.method_11();
		}
		for (int k = 0; k < 512; k++)
		{
			this.vector_1[k] = this.method_11();
		}
		this.uint_0 = 0U;
	}
	...
	{
		return this.wPxidnkkhvK(uint_2, 7U) ^ this.wPxidnkkhvK(uint_2, 18U) ^ uint_2 >> 3;
	}

	private uint method_3(uint uint_2)
	{
		return this.wPxidnkkhvK(uint_2, 17U) ^ this.wPxidnkkhvK(uint_2, 19U) ^ uint_2 >> 10;
	}

	private uint method_4(uint uint_2, uint uint_3, uint uint_4)
	{
		return (this.wPxidnkkhvK(uint_2, 10U) ^ this.wPxidnkkhvK(uint_4, 23U)) + this.wPxidnkkhvK(uint_3, 8U);
	}
	...
	private uint wPxidnkkhvK(uint uint_2, uint uint_3)
	{
	...
	private uint wSjidLuEdbl(uint uint_2)
	{
	...
	private uint method_10(uint uint_2, uint uint_3)
	{
		return this.method_9(uint_2 - uint_3);
	}

	private uint method_11()
	{
		uint uint_ = this.method_9(this.uint_0);
		uint result;
		if (this.uint_0 < 512U)
		{
			this.vector_0[uint_] = this.vector_0[uint_] + this.method_4(this.vector_0[this.method_10(uint_, 3U)], this.vector_0[this.method_10(uint_, 10U)], this.vector_0[this.method_10(uint_, 511U)]);
			result = (this.method_7(this.vector_0[this.method_10(uint_, 12U)]) ^ this.vector_0[uint_]);
		}
		else
		{
			this.vector_1[uint_] = this.vector_1[uint_] + this.method_5(this.vector_1[this.method_10(uint_, 3U)], this.vector_1[this.method_10(uint_, 10U)], this.vector_1[this.method_10(uint_, 511U)]);
			result = (this.wSjidLuEdbl(this.vector_1[this.method_10(uint_, 12U)]) ^ this.vector_1[uint_]);
		}
		this.uint_0 = this.method_8(this.uint_0 + 1U);
		return result;
	}

	private void method_12(Vector<uint> vector_5, uint uint_2, Vector<uint> vector_6, uint uint_3, uint uint_4)
	{
		uint num = uint_3;
	...
	public virtual void sgxPvnhkklu()
	{
		this.uint_1 = 0U;
		this.method_0();
	}
