...
public class GClass858
{
	...
	public GClass858(BigInteger bigInteger_3, BigInteger bigInteger_4, BigInteger bigInteger_5)
	{
	...
	{
		return this.method_0().ToByteArray().Reverse<byte>().SkipWhile(new Func<byte, bool>(GClass858.<>c.<>c_0.method_0)).Count<byte>();
	}
