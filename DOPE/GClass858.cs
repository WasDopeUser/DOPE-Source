...
public static class GClass858
{
	...
	public static extern void GetSystemInfo(out GClass858.GStruct1 gstruct1_0);

	[DllImport("kernel32.dll", SetLastError = true)]
	public static extern int VirtualQueryEx(IntPtr intptr_0, IntPtr intptr_1, out GClass858.GStruct2 gstruct2_0, uint uint_0);

	[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx", SetLastError = true)]
	public static extern int VirtualQueryEx_1(IntPtr intptr_0, IntPtr intptr_1, out GClass858.GStruct3 gstruct3_0, uint uint_0);
	...
	{
		bool flag;
		return !Environment.Is64BitOperatingSystem || ((Environment.OSVersion.Version.Major > 5 || (Environment.OSVersion.Version.Major == 5 && Environment.OSVersion.Version.Minor >= 1)) && (GClass858.IsWow64Process(intptr_0, out flag) && flag));
	}
	...
	public static GClass858.GStruct3 smethod_2(IntPtr intptr_0, IntPtr intptr_1, out int int_0)
	{
		int_0 = 0;
		GClass858.GStruct3 result = default(GClass858.GStruct3);
		if (GClass858.smethod_1())
		{
			GClass858.GStruct2 gstruct = default(GClass858.GStruct2);
			if (GClass858.VirtualQueryEx(intptr_0, intptr_1, out gstruct, (uint)Marshal.SizeOf(typeof(GClass858.GStruct2))) != 0)
			{
		...
		{
			if (GClass858.VirtualQueryEx_1(intptr_0, intptr_1, out result, (uint)Marshal.SizeOf(typeof(GClass858.GStruct3))) != 0)
			{
				return result;
			}
			int_0 = Marshal.GetLastWin32Error();
