...
public sealed class GClass859 : IDisposable
{
	...
	{
		this.int_0++;
		if (!GClass859.RegisterHotKey(this.window_0.Handle, this.int_0, (uint)genum13_0, (uint)keys_0))
		{
	...
	public void Dispose()
	{
		...
		{
			GClass859.UnregisterHotKey(this.window_0.Handle, i);
		}
	...
	private GClass859.Window window_0;
	...
	private class Window : NativeWindow, IDisposable
	{
		...
		{
			base.WndProc(ref m);
			if (m.Msg == GClass859.Window.int_0)
			{
