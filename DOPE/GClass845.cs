...
public class GClass845 : GClass836
{
	public GClass845(GClass823 gclass823_1)
	{
	...
	protected virtual bool vmethod_51(Ship ship_0, Ship ship_1)
	{
		int num = this.vmethod_50();
		bool flag = ship_1 != null && this.vmethod_12(ship_0 as NpcShip) && !this.vmethod_12(ship_1 as NpcShip);
		double num2 = (this.method_28() || flag) ? 0.0 : Math.Abs(GClass806.smethod_4(ship_0.Position - base.Context.HeroPosition, ship_1.Position - base.Context.HeroPosition));
	...
	public override bool vmethod_1(Ship ship_0, out Ship ship_1)
	{
		...
		if (ship_0 != null)
		{
			...
			if (npcShip != null && cooldowns.method_0(BotAction.SelectShip) && cooldowns.method_0(BotAction.TargetQuickSwitch) && npcShip != ship_0 && this.vmethod_51(ship_0, npcShip))
			{
		...
		if (base.C.AttackingId == ship_0.Id && this.vmethod_49(ship_0 as NpcShip) && ship_0.HpPercentage < 24.75f && base.C.float_0 >= 24.75f && base.C.method_75().Any(new Func<NpcShip, bool>(this.method_38)))
		{
	...
	{
		return !base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass845.<>c.<>c_0.method_0)) && base.C.Map.Gates.Any<KeyValuePair<int, Gate>>() && !base.C.method_77() && base.C.DormantTargets.Count == 0 && base.C.Game.Web.GgInfo != null;
	}

	public override bool vmethod_24(out Vector2? nullable_0)
	{
		if (!base.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass845.<>c.<>c_0.method_1)) && !base.Map.Collectibles.Any<KeyValuePair<string, Collectible>>() && !base.Map.Gates.Any<KeyValuePair<int, Gate>>())
		{
			nullable_0 = null;
			return true;
		}
	...
	public override bool vmethod_4(bool bool_8 = false, bool bool_9 = false)
	{
		...
		Ship ship = base.C.Map.method_5<Ship>(heroPosition, new Func<Ship, bool>(GClass845.<>c.<>c_0.method_2), null, 0);
	...
	public override bool vmethod_19(GClass825 gclass825_0)
	{
		...
		{
			GClass832 gclass = gclass825_0 as GClass832;
			return gclass != null && gclass.GalaxyGateType == MapUtils.uHiiygsnnX(base.C.Map.MapId);
		}
		return true;
	}
	...
	{
		GClass845.<>c__DisplayClass16_0 CS$<>8__locals1 = new GClass845.<>c__DisplayClass16_0();
		Map map = base.C.Map;
		CS$<>8__locals1.int_0 = MapUtils.smethod_10(MapUtils.uHiiygsnnX(map.MapId));
	...
	{
		GClass845.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass845.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass845_0 = this;
		Vector2? vector = null;
		CS$<>8__locals1.vector2_0 = base.C.HeroPosition;
		if (base.C.Map.method_5<Ship>(CS$<>8__locals1.vector2_0, new Func<Ship, bool>(GClass845.<>c.<>c_0.method_3), null, 0) == null)
		{
			vector = new Vector2?(base.C.Map.Center);
		}
		else if (this.method_28())
		{
			vector = this.vmethod_38(CS$<>8__locals1.vector2_0, base.C.Map.Center, (float)base.C.Map.MapSize.Height * 0.4f, null, this.method_30() ? -0.5f : 0.5f);
		}
		else
		{
			CS$<>8__locals1.vector2_1 = (this.vmethod_40(CS$<>8__locals1.vector2_0, 2250) ?? base.C.Map.Center);
	...
	public override int vmethod_9(NpcShip npcShip_0)
	{
		...
		int num2;
		if (@class != null && GClass845.dictionary_0.TryGetValue(@class, out num2))
		{
			num = num2;
		}
		if (this.vmethod_52(npcShip_0))
		{
			num++;
		}
		return num;
	...
	public virtual bool vmethod_52(NpcShip npcShip_0)
	{
	...
	{
		int range;
		if (npcShip_0.Type.Class != null && GClass845.dictionary_1.TryGetValue(npcShip_0.Type.Class, out range))
		{
	...
	{
		GClass832 gclass = base.C.Module as GClass832;
		if (gclass == null)
		{
			return null;
		}
		return gclass.snWlbuEwdg5(ship_0);
	}
	...
	{
		GClass845.<>c__DisplayClass29_0 CS$<>8__locals1 = new GClass845.<>c__DisplayClass29_0();
		CS$<>8__locals1.gclass845_0 = this;
	...
	{
		GClass845.<>c__DisplayClass34_0 CS$<>8__locals1 = new GClass845.<>c__DisplayClass34_0();
		CS$<>8__locals1.gclass845_0 = this;
	...
	public override Vector2? vmethod_45(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		if (!this.method_26())
		{
			return base.vmethod_45(vector2_1, npcShip_0, nullable_0, float_0);
		}
		Vector2? vector = this.vmethod_40(vector2_1, 1100);
		Vector2 vector2;
		int num = this.vmethod_42(vector2_1, npcShip_0, out vector2);
		...
		if (vector != null && this.method_32().Cooldown(10000))
		{
			...
			this.method_31(GClass806.smethod_2(vector2_1.Y - center.Y, vector2_1.X - center.X, value.Y - center.Y, value.X - center.X));
		...
		PointF pointF;
		PointF pointF2;
		int num3 = GClass811.smethod_0(center.X, center.Y, num2, vector2.X, vector2.Y, (float)num, out pointF, out pointF2);
		double num4;
		if (num3 == 2)
		{
			num4 = GClass806.smethod_3(pointF.Y - center.Y, pointF.X - center.X, pointF2.Y - center.Y, pointF2.X - center.X, false);
		}
		else
		{
			num4 = Math.Atan2((double)(vector2.X - center.X), (double)(vector2.Y - center.Y)) + (double)(this.method_30() ? -0.5f : 0.5f);
		}
		Vector2 value2 = GClass806.smethod_8(center, num2, (float)num4);
		if (num3 != 0)
		{
			this.method_29(true);
		...
		{
			return base.vmethod_45(vector2_1, npcShip_0, new Vector2?(value2), 0.5f);
		}
		return base.vmethod_45(vector2_1, npcShip_0, null, 0.5f);
	}
	...
	{
		this.method_35(this.vmethod_53());
		base.Update();
		this.method_27(this.vmethod_54());
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass845.dictionary_0 = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
		...
		GClass845.dictionary_1 = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
