...
public abstract class GClass789 : GClass787<GInterface7>
{
	public static byte[] smethod_0(string string_0)
	{
		GClass789.<>c__DisplayClass0_0 CS$<>8__locals1 = new GClass789.<>c__DisplayClass0_0();
		CS$<>8__locals1.string_0 = string_0;
		return Enumerable.Range(0, CS$<>8__locals1.string_0.Length).Where(new Func<int, bool>(GClass789.<>c.<>c_0.method_0)).Select(new Func<int, byte>(CS$<>8__locals1.method_0)).ToArray<byte>();
	}
