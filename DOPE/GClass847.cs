...
public class GClass847 : Interface0
{
	[CompilerGenerated]
	public Dictionary<string, GClass847.GClass848> method_0()
	{
	...
	public bool imethod_2()
	{
		try
		{
			GClass847.GClass848 gclass = new GClass847.GClass848("69.69.69.69", false);
			gclass.method_1();
	...
	public void imethod_0(HashSet<string> hashSet_0 = null)
	{
		...
		lock (obj)
		{
			if (hashSet_0 != null)
			{
				using (HashSet<string>.Enumerator enumerator = hashSet_0.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						GClass847.GClass848 gclass;
						if (!this.method_0().TryGetValue(text, out gclass))
						{
							gclass = new GClass847.GClass848(text, false);
						}
			...
			GClass847.GClass848 gclass2 = new GClass847.GClass848("127.0.0.1", false);
	...
	public void imethod_1(string[] string_0)
	{
		...
		lock (obj)
		{
			foreach (string text in string_0)
			{
				...
				if (!this.method_0().TryGetValue(text, out gclass))
				{
					gclass = (this.method_0()[text] = new GClass847.GClass848(text, false));
				}
				if (gclass.bool_0)
				{
					gclass.method_1();
	...
	public GClass847()
	{
		...
		this.dictionary_0 = new Dictionary<string, GClass847.GClass848>();
		this.object_0 = new object();
		base..ctor();
	}

	[CompilerGenerated]
	private readonly Dictionary<string, GClass847.GClass848> dictionary_0;

	private readonly object object_0;

	public class GClass848
	{
		public GClass848(string string_1, bool bool_1 = false)
		{
			Class8.xDph7tozmh5WD();
			this.string_0 = "";
			base..ctor();
		...
		public void method_1()
		{
			this.bool_0 = false;
			string text;
			if ((text = this.method_0(string.Concat(new object[]
			{
		...
		public bool method_2(bool bool_1 = false)
		{
			...
			this.bool_0 = true;
			return this.method_0(string.Concat(new object[]
			{
				"netsh int ip delete addr ",
				this.method_4(),
				" ",
				this.ipaddress_0.ToString()
			})).Length <= 3;
		...
		public HashSet<string> method_3()
		{
			...
			this.method_0("netsh int ip show ipaddresses " + this.method_4());
