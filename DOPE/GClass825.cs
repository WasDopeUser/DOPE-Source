...
public abstract class GClass825 : INotifyPropertyChanged
{
	public string Name
	{
		[CompilerGenerated]
	...
	public GClass825(GClass823 gclass823_1, string string_1, int int_2 = -2147483648)
	{
	...
	public virtual GClass836 GetBehavior()
	{
		if (this.C.Map.IsGG)
		{
			return this.C.gclass845_0;
		}
		if (this.C.Map.MapName.StartsWith("4-"))
		{
			return this.C.gclass843_0;
		}
		if (this.C.Map.MapId == 92)
		{
			return this.C.gclass840_0;
		}
		if (this.C.Map.MapId >= 430 && this.C.Map.MapId <= 445)
		{
			return this.C.gclass838_0;
		}
		return this.C.gclass836_0;
	}
	...
	public virtual void HandleError(GClass825.GEnum10 genum10_0)
	{
