...
public class GClass865 : Interface0
{
	[CompilerGenerated]
	public Dictionary<string, GClass865.GClass866> method_0()
	{
	...
	public bool imethod_2()
	{
		try
		{
			GClass865.GClass866 gclass = new GClass865.GClass866("69.69.69.69", false);
			gclass.method_1();
	...
	public void imethod_0(HashSet<string> hashSet_0 = null)
	{
		...
		lock (obj)
		{
			if (hashSet_0 != null)
			{
				using (HashSet<string>.Enumerator enumerator = hashSet_0.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						GClass865.GClass866 gclass;
						if (!this.method_0().TryGetValue(text, out gclass))
						{
							gclass = new GClass865.GClass866(text, false);
						}
			...
			GClass865.GClass866 gclass2 = new GClass865.GClass866("127.0.0.1", false);
	...
	public void imethod_1(string[] string_0)
	{
		...
		lock (obj)
		{
			foreach (string text in string_0)
			{
				...
				if (!this.method_0().TryGetValue(text, out gclass))
				{
					gclass = (this.method_0()[text] = new GClass865.GClass866(text, false));
				}
				if (gclass.bool_0)
				{
					gclass.method_1();
	...
	public GClass865()
	{
		...
		this.dictionary_0 = new Dictionary<string, GClass865.GClass866>();
		this.object_0 = new object();
		base..ctor();
	}

	[CompilerGenerated]
	private readonly Dictionary<string, GClass865.GClass866> dictionary_0;

	private readonly object object_0;

	public class GClass866
	{
		public GClass866(string string_1, bool bool_1 = false)
		{
			Class13.Gj4N3WdzaR1LY();
			this.string_0 = "";
			base..ctor();
