...
{
	public GClass792(Vector<uint> vector_5, Vector<uint> vector_6)
	{
		...
		if (vector_5 != null)
		{
			if (vector_5.Length == 12)
			{
				...
				this.ognzKiUqu0(this.vector_0, this.vector_1);
				this.method_0();
				return;
			}
		}
	...
	private void ognzKiUqu0(Vector<uint> vector_5, Vector<uint> vector_6)
	{
		vector_6[12U] = 255U;
		vector_6[13U] = 255U;
		vector_6[14U] = 255U;
	...
	public virtual void vmethod_0(byte[] byte_0, int int_0, int int_1)
	{
		...
		{
			byte_0[i + int_0] = (byte)(((uint)byte_0[i + int_0] ^ this.method_5()) & 255U);
		}
	}
