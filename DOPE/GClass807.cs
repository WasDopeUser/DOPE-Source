...
public class GClass807
{
	...
	{
		return GClass807.smethod_0(GClass807.smethod_1(string_0));
	}

	public GClass807(BigInteger bigInteger_3, BigInteger bigInteger_4, BigInteger bigInteger_5)
	{
	...
	private void method_8(Func<BigInteger, BigInteger> func_0, byte[] byte_0, Stream stream_0, uint uint_0, uint uint_1)
	{
		...
		{
			BigInteger arg2 = GClass807.smethod_0(byte_0.Skip((int)uint_0).Take((int)uint_1).ToArray<byte>());
	...
	private void method_9(Func<BigInteger, BigInteger> func_0, byte[] byte_0, Stream stream_0, uint uint_0, uint uint_1)
	{
		...
		{
			BigInteger arg = GClass807.smethod_0(this.method_10(byte_0, (int)num2, (int)num, (int)num3));
	...
	{
		return this.method_0().ToByteArray().Reverse<byte>().SkipWhile(new Func<byte, bool>(GClass807.<>c.<>c_0.method_0)).Count<byte>();
	}
