...
public static class GClass807
{
	public static Vector2 smethod_0(Vector2 vector2_0, Vector2 vector2_1, float float_0, Vector2? nullable_0 = null, float float_1 = 0.5f)
	{
		...
		if (nullable_0 != null)
		{
			...
			PointF left = GClass812.smethod_1(vector2_1.X, vector2_1.Y, float_0, new PointF(value.X, value.Y), new PointF(vector2_1.X, vector2_1.Y));
		...
		if (vector == default(Vector2))
		{
			...
			vector = GClass807.smethod_8(vector2_1, float_0, (float)num);
		}
		return vector;
	}
	...
	public static bool smethod_2(float float_0, float float_1, float float_2, float float_3)
	{
		...
		int num3 = GClass807.smethod_1(float_0, float_1);
		int num4 = GClass807.smethod_1(float_2, float_3);
		double num5 = num2;
		if (num3 == num4)
		{
	...
	{
		return GClass807.smethod_5(vector2_0.X, vector2_0.Y, vector2_1.X, vector2_1.Y);
	}

	public static double smethod_5(float float_0, float float_1, float float_2, float float_3)
	{
		return Math.Atan2(GClass807.Cross(float_0, float_1, float_2, float_3), GClass807.smethod_6(float_0, float_1, float_2, float_3));
	}
	...
	public static float smethod_7(float float_0, float float_1, float float_2, float float_3, float float_4)
	{
		...
		double num2 = GClass807.smethod_5(float_0, float_1, float_2, float_3);
		if (float_4 < 0f)
		{
			float_4 = -float_4;
