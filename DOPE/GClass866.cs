...
{
	[CompilerGenerated]
	public Dictionary<string, GClass866.GClass867> method_0()
	{
	...
	public bool imethod_2()
	{
		try
		{
			GClass866.GClass867 gclass = new GClass866.GClass867("69.69.69.69", false);
			gclass.method_1();
	...
	public void imethod_0(HashSet<string> hashSet_0 = null)
	{
		...
		lock (obj)
		{
			if (hashSet_0 != null)
			{
				using (HashSet<string>.Enumerator enumerator = hashSet_0.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						GClass866.GClass867 gclass;
						if (!this.method_0().TryGetValue(text, out gclass))
						{
							gclass = new GClass866.GClass867(text, false);
						}
			...
			GClass866.GClass867 gclass2 = new GClass866.GClass867("127.0.0.1", false);
	...
	public void imethod_1(string[] string_0)
	{
		...
		lock (obj)
		{
			foreach (string text in string_0)
			{
				...
				if (!this.method_0().TryGetValue(text, out gclass))
				{
					gclass = (this.method_0()[text] = new GClass866.GClass867(text, false));
				}
				if (gclass.bool_0)
				{
					gclass.method_1();
	...
	public GClass866()
	{
		...
		this.dictionary_0 = new Dictionary<string, GClass866.GClass867>();
		this.object_0 = new object();
		base..ctor();
	}

	[CompilerGenerated]
	private readonly Dictionary<string, GClass866.GClass867> dictionary_0;

	private readonly object object_0;

	public class GClass867
	{
		public GClass867(string string_1, bool bool_1 = false)
		{
			Class13.igxcIukzfpare();
			this.string_0 = "";
			base..ctor();
