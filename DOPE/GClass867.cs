...
public class GClass867 : Interface0
{
	private static Yro2uCE27qDC2xmVJd2 smethod_0<Yro2uCE27qDC2xmVJd2>(ManagementObject managementObject_0, string string_0)
	{
		GClass867.<>c__DisplayClass0_0<Yro2uCE27qDC2xmVJd2> CS$<>8__locals1 = new GClass867.<>c__DisplayClass0_0<Yro2uCE27qDC2xmVJd2>();
		...
		return (Yro2uCE27qDC2xmVJd2)((object)((propertyData != null) ? propertyData.Value : null));
	}
	...
	public void imethod_0(HashSet<string> hashSet_0 = null)
	{
		...
		foreach (ManagementBaseObject managementBaseObject in new ManagementObjectSearcher(scope, new ObjectQuery("SELECT * FROM MSFT_NetIPAddress")).Get())
		{
			...
			string item = GClass867.smethod_0<string>(managementObject, "IPAddress");
			if ((long)NetworkInterface.LoopbackInterfaceIndex == (long)((ulong)GClass867.smethod_0<uint>(managementObject, "InterfaceIndex")) & (GClass867.smethod_1(GClass867.smethod_0<string>(managementObject, "PreferredLifetime"), TimeSpan.FromHours(24.0)) && (hashSet_0 == null || hashSet_0.Contains(item))))
			{
	...
	public void imethod_1(string[] string_0)
	{
		...
		foreach (ManagementBaseObject managementBaseObject in new ManagementObjectSearcher(scope, new ObjectQuery("SELECT * FROM MSFT_NetIPAddress")).Get())
		{
			string item = GClass867.smethod_0<string>((ManagementObject)managementBaseObject, "IPAddress");
			hashSet.Remove(item);
		}
