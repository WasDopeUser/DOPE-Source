...
{
	public GClass867(Vector<uint> vector_6, Vector<uint> vector_7)
	{
	...
	protected void method_0(Vector<uint> vector_6, Vector<uint> vector_7)
	{
		...
		Vector<uint> vector_8 = GClass867.vector_0;
	...
	{
		this.method_5(vector_6, 0U, this.vector_2, 0U, (uint)vector_6.Length);
		uint num = 10U;
		int num2 = 0;
		...
		{
			this.woMwcKgHsyP(this.vector_2[num4] + vector_6[num4], vector_7, num3);
			num3 += 4U;
		}
		uint num5 = this.uint_0;
		while ((ulong)num5 < (ulong)((long)this.vector_2.Length))
		{
			this.woMwcKgHsyP(this.vector_2[num5], vector_7, num3);
			num3 += 4U;
			num5 += 1U;
		}
	}
	...
	{
		return uint_5 << (int)uint_6 | (uint)U.smethod_1(uint_5, (int)(-(int)uint_6));
	}
	...
	private Vector<uint> woMwcKgHsyP(uint uint_5, Vector<uint> vector_6, uint uint_6 = 0U)
	{
		vector_6[uint_6] = (uint_5 & 255U);
		vector_6[uint_6 + 1U] = (uint)(U.smethod_1(uint_5, 8) & 255);
		vector_6[uint_6 + 2U] = (uint)(U.smethod_1(uint_5, 16) & 255);
		vector_6[uint_6 + 3U] = (uint)(U.smethod_1(uint_5, 24) & 255);
		return vector_6;
	}
	...
	private void method_5(Vector<uint> vector_6, uint uint_5, Vector<uint> vector_7, uint uint_6, uint uint_7)
	{
		uint num = uint_6;
	...
	{
		Class13.xnk8ImWzpOt04();
		GClass867.vector_0 = new Vector<uint>
		{
			35U,
			185U,
			189U,
