...
public class GClass123 : IWebProxy
{
	...
	private static bool smethod_1(Socket socket_1, out string string_0, out byte[] byte_0)
	{
		...
		while (num2 != 0)
		{
			...
			num2 -= num4;
			int num5;
			if (array.HhbApjwxn2(Math.Max(0, num3 - 3), num, out num5))
			{
		...
		public static GClass123.GEnum7 smethod_0(Socket socket_0, string string_0, int int_0, ProxySettings proxySettings_0)
		{
			...
			try
			{
				...
				else
				{
					...
					if (instance != null && Class4.smethod_1(string_0) == (Class4.Enum0)3)
					{
					...
					socket_0.Send(GClass123.Class3.smethod_2((GClass123.GEnum8)1, Class4.smethod_1(string_0), string_0, int_0));
