...
public class GClass816 : StatisticsCategory
{
	...
	public override void Update()
	{
		...
		lock (deathLog)
		{
			foreach (KeyValuePair<string, GClass816.GStruct0> keyValuePair in this.DeathLog)
			{
				GClass816.<>c__DisplayClass8_0 CS$<>8__locals1 = new GClass816.<>c__DisplayClass8_0();
	...
	[CompilerGenerated]
	private Dictionary<string, GClass816.GStruct0> dictionary_0;
