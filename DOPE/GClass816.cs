...
public class GClass816 : BotStats, INotifyPropertyChanged
{
	...
	public Dictionary<string, GClass818.GStruct0> DeathLog
	{
		[CompilerGenerated]
		get
		{
	...
	public GClass816(GClass824 gclass824_1)
	{
		Class13.igxcIukzfpare();
		base..ctor();
		this.Context = gclass824_1;
		base.HeroStats = (this.gclass820_0 = new GClass820(gclass824_1.Hero, this));
		base.PetStats = (this.gclass821_0 = new GClass821(gclass824_1.Hero.Pet, this));
		base.GgStats = (this.gclass819_0 = new GClass819(gclass824_1.Game.Web));
		this.DeathLog = new Dictionary<string, GClass818.GStruct0>();
		base.DeathStats = (this.gclass818_0 = new GClass818(this.DeathLog));
		this.dictionary_0 = new Dictionary<string, int>();
		base.NpcStats = (this.gclass817_0 = new GClass817("NPCs", this.dictionary_0));
		this.dictionary_1 = new Dictionary<string, int>();
		base.BoxStats = (this.gclass817_1 = new GClass817("Boxes", this.dictionary_1));
		gclass824_1.Game.LogMessage += this.method_2;
		gclass824_1.Game.Map.ShipDestroyed += this.method_1;
		gclass824_1.Game.Map.CollectibleCollected += this.method_0;
	}
	...
	private void method_2(GameManager gameManager_0, GClass269 gclass269_0)
	{
		...
		if (array[1] == "LM" && array[2] == "ST" && array.Length > 4)
		{
			...
			if (text != null)
			{
				uint num3 = <PrivateImplementationDetails>{1BBFFFC1-F0AD-4035-9372-469805D6C710}.ComputeStringHash(text);
				if (num3 <= 1746879935U)
				{
					if (num3 != 583800688U)
					{
	...
	public void Reset()
	{
		...
		Dictionary<string, GClass818.GStruct0> deathLog = this.DeathLog;
		lock (deathLog)
		{
			this.DeathLog.Clear();
		}
	...
	{
		base.InternalRaiseChanged("RunTime", GClass816.propertyChangedEventArgs_0);
		base.InternalRaiseChanged("UridiumHourly", GClass816.propertyChangedEventArgs_1);
		base.InternalRaiseChanged("CreditsHourly", GClass816.propertyChangedEventArgs_2);
		int num = this.int_0;
		this.int_0 = num + 1;
		if (num % 20 == 0)
		{
			...
			this.gclass819_0.Update();
			this.gclass818_0.Update();
	...
	public void method_4(GClass217 gclass217_0)
	{
		...
		this.gclass818_0.method_0(gclass217_0.string_2);
	}
	...
	{
		Class13.igxcIukzfpare();
		GClass816.propertyChangedEventArgs_0 = new PropertyChangedEventArgs("RunTime");
		GClass816.propertyChangedEventArgs_1 = new PropertyChangedEventArgs("UridiumHourly");
		GClass816.propertyChangedEventArgs_2 = new PropertyChangedEventArgs("CreditsHourly");
	}
	...
	[CompilerGenerated]
	private Dictionary<string, GClass818.GStruct0> dictionary_2;
