...
public class GClass826 : GClass825
{
	...
	public GClass826(GClass823 gclass823_1)
	{
	...
	public override bool ShouldChangeHangar(out string string_1)
	{
		...
		if (account != null && account.Spinner_UsePhoenix)
		{
			...
			{
				GClass826.<>c__DisplayClass8_0 CS$<>8__locals1 = new GClass826.<>c__DisplayClass8_0();
				GClass850 gclass = base.Context.method_62<GClass850>();
				GClass826.<>c__DisplayClass8_0 CS$<>8__locals2 = CS$<>8__locals1;
				...
				string_1 = ((CS$<>8__locals1.list_0 == null) ? null : GClass826.list_0.FirstOrDefault(new Func<string, bool>(CS$<>8__locals1.method_0)));
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass826.list_0 = new List<string>
		{
			"ship_phoenix",
			"ship_liberator"
		};
