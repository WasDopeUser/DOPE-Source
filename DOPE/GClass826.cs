...
public abstract class GClass826 : INotifyPropertyChanged
{
	public string Name
	{
		[CompilerGenerated]
		...
		protected set
		{
			...
			this.string_0 = value;
			this.method_0(Class10.propertyChangedEventArgs_33);
	...
	public BotProfile Profile
	{
		...
		protected set
		{
			...
			this.method_0(Class10.propertyChangedEventArgs_39);
		}
	}
	...
	protected Logger Log
	{
		get
		{
			return this.Context.method_69("Module-" + this.Name);
		}
	}

	public GClass826(GClass824 gclass824_1, string string_1, int int_2 = -2147483648)
	{
	...
	public virtual GClass837 GetBehavior()
	{
		if (this.C.Map.IsGG)
		{
			return this.C.gclass846_0;
		}
		if (this.C.Map.MapName.StartsWith("4-"))
		{
			return this.C.smhomKoDhPA;
		}
		if (this.C.Map.MapId == 92)
		{
			return this.C.gclass841_0;
		}
	...
	public virtual void HandleError(GClass826.GEnum10 genum10_0)
	{
