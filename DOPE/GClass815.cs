...
public class GClass815 : BotStats, INotifyPropertyChanged
{
	...
	public GClass815(GClass823 gclass823_1)
	{
		Class13.Gj4N3WdzaR1LY();
		base..ctor();
		this.Context = gclass823_1;
		base.HeroStats = (this.gclass819_0 = new GClass819(gclass823_1.Hero, this));
		base.PetStats = (this.gclass820_0 = new GClass820(gclass823_1.Hero.Pet, this));
		base.GgStats = (this.gclass818_0 = new GClass818(gclass823_1.Game.Web));
		this.DeathLog = new Dictionary<string, GClass817.GStruct0>();
		base.DeathStats = (this.gclass817_0 = new GClass817(this.DeathLog));
		this.dictionary_0 = new Dictionary<string, int>();
		base.NpcStats = (this.gclass816_0 = new GClass816("NPCs", this.dictionary_0));
		this.dictionary_1 = new Dictionary<string, int>();
		base.BoxStats = (this.gclass816_1 = new GClass816("Boxes", this.dictionary_1));
		gclass823_1.Game.LogMessage += this.method_2;
		gclass823_1.Game.Map.ShipDestroyed += this.method_1;
		gclass823_1.Game.Map.CollectibleCollected += this.method_0;
	}
	...
	private void method_2(GameManager gameManager_0, GClass269 gclass269_0)
	{
		...
		if (array[1] == "LM" && array[2] == "ST" && array.Length > 4)
		{
			...
			if (text != null)
			{
				uint num3 = <PrivateImplementationDetails>{824DE923-811B-4506-835A-5C88C614FC99}.ComputeStringHash(text);
				if (num3 <= 1746879935U)
				{
					if (num3 != 583800688U)
					{
	...
	{
		base.InternalRaiseChanged("RunTime", GClass815.propertyChangedEventArgs_0);
		base.InternalRaiseChanged("UridiumHourly", GClass815.propertyChangedEventArgs_1);
		base.InternalRaiseChanged("CreditsHourly", GClass815.propertyChangedEventArgs_2);
		int num = this.int_0;
		this.int_0 = num + 1;
		if (num % 20 == 0)
		{
	...
	public void method_4(GClass217 gclass217_0)
	{
		...
		this.gclass817_0.method_0(gclass217_0.tawSrisLpr);
	}
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass815.propertyChangedEventArgs_0 = new PropertyChangedEventArgs("RunTime");
		GClass815.propertyChangedEventArgs_1 = new PropertyChangedEventArgs("UridiumHourly");
		GClass815.propertyChangedEventArgs_2 = new PropertyChangedEventArgs("CreditsHourly");
	}
	...
	[CompilerGenerated]
	private Dictionary<string, GClass817.GStruct0> dictionary_2;
