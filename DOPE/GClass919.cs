...
public class GClass919 : GClass915
{
	public GClass919(GClass889 gclass889_1)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor(gclass889_1, "HangarInfoProvider");
	}
	...
	public override void Execute()
	{
		...
		List<string> list = hangarList.data.ret.hangars.Select(new Func<GClass28.GClass32, string>(GClass919.<>c.<>c_0.method_0)).ToList<string>();
		if (list != null && list.Any<string>() && hangar != null)
		{
			...
			GClass28.GClass32 gclass = hangarList.data.ret.hangars.FirstOrDefault(new Func<GClass28.GClass32, bool>(GClass919.<>c.<>c_0.method_1));
			string activeHangar;
			if (gclass == null)
			{
				activeHangar = null;
