...
public class GClass839 : INotifyPropertyChanged, ILogManager, IPErkavaBotController
{
	...
	public void Cloak()
	{
		...
		{
			this.BackgroundQueue.Enqueue(new Func<DarkOrbitWebAPI, object>(GClass839.<>c.<>c_0.method_0));
		}
	}
	...
	{
		GClass839.<>c__DisplayClass13_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass13_0();
		...
		if (this.Cooldowns.method_0(BotAction.Move))
		{
			...
			{
				PathSequence pathSequence = this.Map.Grid.method_12(this.HeroPosition, CS$<>8__locals1.vector2_0, 30, int_17);
	...
	public void BusHahcYqkv(Ship ship_1, bool bool_13 = false)
	{
	...
	public void method_6(Ship ship_1)
	{
		LaserType laserType;
		...
		if (laserType > LaserType.LCB_10 && this.Hero.method_19(Ammo.smethod_1(laserType)) < 100.0)
		{
	...
	public void method_8()
	{
		...
		if (this.SelectedHS == "ammunition_rocketlauncher_eco-10" && this.Hero.method_19(this.SelectedHS) < 90.0)
		{
			...
			bool flag;
			this.method_9<bool>("BuyAmmoHs", new Func<DarkOrbitWebAPI, bool>(this.method_83), out flag);
		}
	}

	public bool method_9<FOAvQGL1d91ICQW9wSe>(string string_4, Func<DarkOrbitWebAPI, FOAvQGL1d91ICQW9wSe> func_0, out FOAvQGL1d91ICQW9wSe gparam_0)
	{
		GClass839.<>c__DisplayClass33_0<FOAvQGL1d91ICQW9wSe> CS$<>8__locals1 = new GClass839.<>c__DisplayClass33_0<FOAvQGL1d91ICQW9wSe>();
		CS$<>8__locals1.f = func_0;
		CS$<>8__locals1.<>4__this = this;
		CS$<>8__locals1.key = string_4;
		gparam_0 = default(FOAvQGL1d91ICQW9wSe);
		object obj;
		...
		if (obj is FOAvQGL1d91ICQW9wSe)
		{
			FOAvQGL1d91ICQW9wSe foavQGL1d91ICQW9wSe = (FOAvQGL1d91ICQW9wSe)((object)obj);
			object obj2;
			this.concurrentDictionary_0.TryRemove(CS$<>8__locals1.key, out obj2);
			gparam_0 = foavQGL1d91ICQW9wSe;
			return true;
		}
		return false;
	}

	private bool method_10(int int_11)
	{
	...
	public void method_11(bool bool_13, bool bool_14 = false)
	{
		int num;
		int num2;
		GEnum4 genum;
		...
		if (!bool_14)
		{
			GClass849 gclass = this.Module as GClass849;
			if (gclass != null)
			{
				int num4 = this.Map.Ships.Count(new Func<KeyValuePair<int, Ship>, bool>(GClass839.<>c.<>c_0.method_1));
	...
	public bool method_12(bool bool_13, bool bool_14 = false)
	{
		if (this.Behavior is GClass857)
		{
			bool_13 = false;
		}
		Gate gate_;
		...
		return vector != null && this.method_35(vector.Value, gate_, 15, bool_14);
	}
	...
	public void AutoRefine()
	{
		...
		foreach (ResourceType resourceType in GClass839.resourceType_0)
		{
	...
	protected bool method_13()
	{
		...
		{
			Vector2 vector = this.Map.Grid.method_15(this.HeroPosition);
	...
	private bool method_16(List<string> list_5)
	{
		...
		{
			MenuItem menuItem;
			if (this.Hero.itunwqCnuq(text, out menuItem, true))
			{
				return true;
			}
		}
	...
	private string BanHaOjNriW(List<string> list_5)
	{
	...
	{
		return this.method_16(GClass839.list_0);
	}

	public bool method_18()
	{
		return this.method_16(GClass839.list_2);
	}
	...
	{
		if (this.BanHaOjNriW(GClass839.list_0) == "ability_solace")
		{
			using (IEnumerator<GroupManager.GroupMember> enumerator = this.Hero.Group.method_9().GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					GClass199 shipInfo = groupMember.ShipInfo;
					if (shipInfo != null)
					{
						float num = (float)shipInfo.int_2 / ((float)shipInfo.int_4 + 1f) * 100f;
	...
	public bool method_21()
	{
		...
		if (this.IsAttacking && selectedShip != null && this.AttackingId == selectedShip.Id)
		{
			...
			{
				string text2 = this.BanHaOjNriW(GClass839.list_1);
	...
	public GClass837 Scheduler
	{
		[CompilerGenerated]
		get
		{
			return this.gclass837_0;
		}
		[CompilerGenerated]
		set
		{
			if (object.Equals(this.gclass837_0, value))
			{
				return;
			}
			this.gclass837_0 = value;
	...
	public void method_23(string string_4)
	{
	...
	public void method_27()
	{
		...
		if (this.Hero.Pet.IsEnabled)
		{
			...
			{
				bool flag;
				this.method_9<bool>("BuyPetFuel", new Func<DarkOrbitWebAPI, bool>(GClass839.<>c.<>c_0.method_2), out flag);
			}
			bool flag2;
	...
	public bool method_28()
	{
		...
		if (this.IsAttacking)
		{
			...
			{
				MenuItem menuItem;
				this.Hero.itunwqCnuq("tech_precision-targeter", out menuItem, false);
			}
		}
		...
		{
			if (GClass839.botState_2.HasFlag(this.State))
			{
				this.method_65(BotState.Flee);
			}
		}
		else if (this.Game.Hero.HpPercentage < (float)this.MapProfile.MinHp && this.Behavior.vmethod_27() && GClass839.botState_2.HasFlag(this.State))
		{
			this.method_65(BotState.Repair);
		}
		return false;
	}
	...
	public void method_30()
	{
		...
		{
			this.method_65(BotState.Logout);
			return;
		}
		...
		{
			this.Clear();
			this.method_65(this.Behavior.vmethod_18());
			return;
		}
		...
		if (num2 > 400)
		{
			this.method_63((GClass841.GEnum10)2);
			return;
		}
	}
	...
	public DateTime? Timeout
	{
		...
		set
		{
			...
			this.method_92(Class10.propertyChangedEventArgs_57);
		}
	}
	...
	public void method_32()
	{
		...
		if ((this.bool_6 ^ this.bool_7) && this.method_10(this.bool_6 ? 2 : 1))
		{
			this.int_4++;
		}
	}
	...
	public void method_33()
	{
		...
		else
		{
			...
			{
				this.method_65(BotState.Default);
	...
	public Vector2? TravelTarget
	{
		...
		set
		{
			...
			this.method_92(Class10.propertyChangedEventArgs_60);
		}
	}
	...
	public bool method_35(Vector2 vector2_2, Gate gate_1 = null, int int_11 = 15, bool bool_13 = false)
	{
		GClass839.<>c__DisplayClass173_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass173_0();
		CS$<>8__locals1.gclass839_0 = this;
		CS$<>8__locals1.vector2_0 = vector2_2;
		if (gate_1 != null)
		{
			Vector2 vector = this.Map.Grid.method_14(gate_1.Position, 580f);
			if (vector == default(Vector2))
			{
		...
		if (flag && this.pathSequence_0 != null)
		{
			...
			this.gate_0 = gate_1;
			this.int_6 = int_11;
			this.Map.Grid.method_13(this.pathSequence_0);
			this.method_65(BotState.Travel);
		}
		return flag;
	}
	...
	public void method_36()
	{
		...
		if (this.LastStates.method_2() != BotState.Logout && this.method_67())
		{
			return;
		}
	...
	public UsageCounter<string> BoxTracker
	{
		...
		get
		{
			return this.PilHxukeStw;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.PilHxukeStw, value))
			{
				return;
			}
			this.PilHxukeStw = value;
	...
	{
		GClass839.<>c__DisplayClass185_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass185_0();
		CS$<>8__locals1.gclass839_0 = this;
		...
		if (selectedShip != null)
		{
			if (selectedShip.Id == CS$<>8__locals1.ship_0.Id)
			{
				...
				if ((flag = this.Behavior.vmethod_2(npcShip)) && this.Behavior.vmethod_3(npcShip) && this.method_75())
				{
					...
					{
						this.method_65(BotState.Collect);
						return;
					}
		...
		if (func())
		{
			this.BusHahcYqkv(CS$<>8__locals1.ship_0, true);
	...
	{
		Rectangle rectangle = GClass860.list_0.First<Rectangle>();
		...
		Asset value = this.Map.Assets.FirstOrDefault(new Func<KeyValuePair<int, Asset>, bool>(GClass839.<>c.<>c_0.method_3)).Value;
		if (value == null)
		{
			this.method_65(BotState.Default);
			return;
		...
		{
			foreach (ResourceType resourceType in GClass839.list_3)
			{
	...
	public GClass872 MainController
	{
		get
		{
			GClass871 controller = this.Controller;
			if (controller == null)
			{
				return null;
			}
	...
	public GClass871 Controller
	{
		...
		internal set
		{
			if (object.Equals(this.gclass871_0, value))
			{
				return;
			}
			this.gclass871_0 = value;
		...
		for (;;)
		{
			...
			while (this.Game.Connection.Socket.method_2() && !this.IsPaused && this.Run && this.Hero.IsInitialized)
			{
				...
				lock (obj)
				{
					...
					GClass841 gclass = this.Scheduler.method_11();
	...
	private void method_44(object object_1, GClass196 gclass196_0)
	{
		if (gclass196_0.int_0 == this.Hero.Id)
		{
			GClass839.<>c__DisplayClass204_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass204_0();
			CS$<>8__locals1.string_0 = gclass196_0.FromId.ToString();
			if (this.MainController.Bots.Any(new Func<GClass871, bool>(CS$<>8__locals1.method_0)))
			{
				this.Server.method_22(gclass196_0.FromId);
			}
		}
	}
	...
	private void method_46(GameManager gameManager_1, GClass273 gclass273_0)
	{
		if (!gclass273_0.string_0.StartsWith("69|"))
		{
			return;
		}
		...
		if (array.Length != 3 || !(array[1] == "range") || !int.TryParse(array[2], out num))
		{
			if (array.Length == 2 && array[1] == "distance")
			{
				...
				NpcShip npcShip = this.Map.method_5<NpcShip>(this.Hero.Position, new Func<NpcShip, bool>(GClass839.<>c.<>c_0.method_4), null, 0);
				if (npcShip != null)
				{
					ship = npcShip;
				}
			...
			else
			{
				...
				if (array.Length == 2 && array[1] == "portals")
				{
					...
					for (int i = 1; i < 100; i++)
					{
						...
						if (proxySocket != null)
						{
							proxySocket.SendMessage(new GClass269(15161615 + i, "ship_goliath", 0, "", string.Format("{0}", i), int_, int_2, 0, 0, 0, false, null, 0, false, true, false, 0, 0, "", null, null));
						}
					}
					return;
				}
				...
				if (array.Length == 5 && array[1] == "box")
				{
					...
					if (flag)
					{
						proxySocket2.SendMessage(new GClass181(text, this.Game.Hero.PosX, this.Game.Hero.PosY, array[4]));
						return;
					}
				...
				else if (array.Length == 4 && array[1] == "res")
				{
					...
					if (flag2)
					{
						proxySocket3.SendMessage(new GClass182(text2, this.Game.Hero.PosX, this.Game.Hero.PosY, new GClass265(8U)));
						return;
					}
				...
				else
				{
					if (array.Length == 2 && array[1] == "npc")
					{
						for (int j = 0; j < 4; j++)
						{
							...
							{
								proxySocket4.SendMessage(new GClass269(15161213 + j, "ship_goliath", 0, "", "Test NPC", this.Game.Hero.PosX + j * 100, this.Game.Hero.PosY, j, 0, 0, false, null, 0, false, true, false, 0, 0, "", null, null));
							}
						}
						return;
					}
					...
					else if (array.Length == 3 && array[1] == "init" && array[2] == "gate")
					{
	...
	private void method_47(Map map_0, Ship ship_1, GClass271 gclass271_0)
	{
		GClass839.<>c__DisplayClass207_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass207_0();
		CS$<>8__locals1.gclass839_0 = this;
	...
	private void method_48(Map map_0, Ship ship_1)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	{
		GClass839.<>c__DisplayClass209_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass209_0();
		CS$<>8__locals1.gclass839_0 = this;
		CS$<>8__locals1.ship_0 = ship_1;
	...
	public bool method_50(int int_11)
	{
		CachedDictionary<int, bool> obj = this.cachedDictionary_0;
		bool orDefault;
		lock (obj)
	...
	private void method_52(Map map_0, Ship ship_1, Ship ship_2, int int_11, uint uint_0)
	{
	...
	private void method_53(GClass91 gclass91_0)
	{
		this.Log.Info("Connected to game server");
		this.LastDisconnectReason = ErrorReason.Unknown;
	}

	private void method_54(Map map_0, string string_4, Collectible collectible_1, bool bool_13)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	private void method_55(GClass91 gclass91_0, ErrorReason errorReason_1, Exception exception_0 = null)
	{
		DateTime now = DateTime.Now;
	...
	private void method_56(GameManager gameManager_1, Hero hero_0)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	private void method_57(GameManager gameManager_1, Hero hero_0, GClass218 gclass218_0, bool bool_13)
	{
		GClass839.<>c__DisplayClass224_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass224_0();
		CS$<>8__locals1.gameManager_0 = gameManager_1;
		CS$<>8__locals1.gclass839_0 = this;
		CS$<>8__locals1.bool_0 = bool_13;
		CS$<>8__locals1.gclass218_0 = gclass218_0;
		this.Log.Info<bool, string>("Hero died wasAlive={alive} killer={killer}", CS$<>8__locals1.bool_0, CS$<>8__locals1.gclass218_0.string_1);
		this.method_60<GClass866>().imethod_1();
		this.Timeout = null;
		if (this.IsPaused)
		{
			return;
		}
		GClass839.<>c__DisplayClass224_0 CS$<>8__locals2 = CS$<>8__locals1;
		GClass853 behavior = this.Behavior;
		CS$<>8__locals2.uint_0 = ((behavior != null) ? behavior.vmethod_48() : 1U);
		uint val = CS$<>8__locals1.gclass218_0.vector_0.Max(new Func<GClass574, uint>(GClass839.<>c.<>c_0.method_5));
		CS$<>8__locals1.uint_0 = Math.Min(CS$<>8__locals1.uint_0, val);
		object obj = this.object_0;
		lock (obj)
		{
			if (this.Run)
		...
		MapProfile mapProfile = this.MapProfile;
		if (CS$<>8__locals1.bool_0 && mapProfile != null && mapProfile.ReviveAtPortal && (this.Behavior is GClass857 || this.Behavior is GClass861))
		{
	...
	public GClass831 Stats
	{
		[CompilerGenerated]
		get
		{
			return this.gclass831_0;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.gclass831_0, value))
			{
				return;
			}
			this.gclass831_0 = value;
	...
	[CompilerGenerated]
	public List<GInterface9> method_59()
	{
		return this.list_4;
	}
	...
	public GClass853 Behavior
	{
		[CompilerGenerated]
		get
		{
			return this.gclass853_1;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.gclass853_1, value))
			{
				return;
			}
			this.gclass853_1 = value;
			this.method_92(Class10.propertyChangedEventArgs_2);
		}
	}

	public GClass839(IDopeServiceProxy idopeServiceProxy_0, AccountSettings accountSettings_1)
	{
		...
		this.PilHxukeStw = new UsageCounter<string>();
		...
		this.Stats = new GClass831(this);
		this.Scheduler = new GClass837(this);
		...
		this.gclass853_0 = new GClass854(this);
		this.gclass863_0 = new GClass863(this);
		this.gclass861_0 = new GClass861(this);
		this.gclass858_0 = new GClass858(this);
		this.gclass855_0 = new GClass855(this);
		this.gclass856_0 = new GClass856(this);
		this.Behavior = this.gclass853_0;
		this.method_62();
	}

	public PbE6LnLf2FZyQ18rNDu method_60<PbE6LnLf2FZyQ18rNDu>() where PbE6LnLf2FZyQ18rNDu : GClass865
	{
		return this.method_59().First(new Func<GInterface9, bool>(GClass839.<>c__296<PbE6LnLf2FZyQ18rNDu>.<>9.method_0)) as PbE6LnLf2FZyQ18rNDu;
	}
	...
	{
		this.Game.HeroInit += this.method_56;
		this.Game.HeroDied += this.method_57;
		this.Game.Map.ShipAttacked += this.method_52;
		this.Game.Map.ShipCreated += this.method_49;
		this.Game.Map.ShipDestroyed += this.method_48;
		this.Game.Connection.Socket.Disconnected += this.method_55;
		this.Game.Connection.Socket.Connected += this.method_53;
		this.Game.Map.CollectibleCollected += this.method_54;
		this.Game.Map.ShipMoveStarted += this.method_47;
	...
	public bool AttachPErkava(GClass242 obj)
	{
	...
	public void method_63(GClass841.GEnum10 genum10_0)
	{
	...
	public void method_65(BotState botState_3)
	{
		this.StateIters = 0;
	...
	public IEnumerable<string> method_68()
	{
		GClass839.<GetStatusText>d__313 <GetStatusText>d__ = new GClass839.<GetStatusText>d__313(-2);
	...
	public Logger method_69(string string_4)
	{
		string str = "Core-";
		string str2 = "-";
		AccountSettings account = this.Account;
	...
	{
		return this.Map.method_7<NpcShip>(this.HeroPosition, new Func<NpcShip, bool>(this.Behavior.vmethod_10), new Func<NpcShip, int>(this.Behavior.vmethod_9), 0).Any(new Func<ValueTuple<NpcShip, float, int>, bool>(GClass839.<>c.<>c_0.method_6));
	}
	...
	{
		GClass839.<>c__DisplayClass338_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass338_0();
		CS$<>8__locals1.gclass839_0 = this;
	...
	{
		GClass839.<>c__DisplayClass345_0 CS$<>8__locals1 = new GClass839.<>c__DisplayClass345_0();
		CS$<>8__locals1.vector2_0 = vector2_2;
		...
		Collectible collectible2 = this.DormantTargets.Select(new Func<KeyValuePair<string, Collectible>, Collectible>(GClass839.<>c.<>c_0.method_7)).OrderBy(new Func<Collectible, float>(CS$<>8__locals1.method_0)).FirstOrDefault<Collectible>();
	...
	static GClass839()
	{
		...
		GClass839.list_2 = new List<string>
		{
			"ability_lightning",
			"ability_sentinel",
			"ability_spectrum",
		...
		GClass839.list_3 = new List<ResourceType>
		{
		...
		GClass839.botState_2 = (BotState.Roam | BotState.Collect | BotState.Hunt | BotState.Dodge);
	}
	...
	private void method_89()
	{
		...
		if (num > 500)
		{
			this.method_63((GClass841.GEnum10)1);
		}
	}
	...
	private void method_91(string string_4)
	{
		...
		proxySocket.SendMessage(new GClass273(GClass90.Log(string_4)));
	}
	...
	[CompilerGenerated]
	private UsageCounter<string> PilHxukeStw;
	...
	public readonly GClass853 gclass853_0;

	public readonly GClass863 gclass863_0;

	public readonly GClass861 gclass861_0;

	public readonly GClass858 gclass858_0;

	public readonly GClass855 gclass855_0;

	public readonly GClass856 gclass856_0;

	[CompilerGenerated]
	private GClass841 gclass841_0;

	[CompilerGenerated]
	private GClass853 gclass853_1;
