...
public class GClass797 : GClass793
{
	[CompilerGenerated]
	...
	public override void Init(List<byte[]> list_0)
	{
		...
		this.method_1(new GClass804(new Vector<uint>(vector), new Vector<uint>(vector2)));
		this.method_3(new GClass804(new Vector<uint>(vector), new Vector<uint>(vector2)));
	}
