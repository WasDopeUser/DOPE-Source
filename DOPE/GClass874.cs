...
public class GClass874
{
	...
	[CompilerGenerated]
	public List<GClass876.GStruct3> method_4()
	{
		return this.list_0;
	}

	[CompilerGenerated]
	private void method_5(List<GClass876.GStruct3> list_1)
	{
		this.list_0 = list_1;
	}

	public GClass874(int int_1)
	{
	...
	{
		int num = 0;
		return GClass876.WriteProcessMemory(this.method_2(), intptr_3, byte_0, byte_0.Length, ref num);
	}

	public bool method_8(IntPtr intptr_3, byte[] byte_0, int int_1)
	{
		int num = 0;
		return GClass876.ReadProcessMemory(this.method_2(), intptr_3, byte_0, int_1, ref num);
	}
	...
	[CompilerGenerated]
	private List<GClass876.GStruct3> list_0;
}
