...
public class GClass766 : GInterface0
{
	...
	public GClass766(int int_3 = 0, int int_4 = 0, int int_5 = 0, GClass201 gclass201_2 = null, GClass201 gclass201_3 = null, Vector<GClass515> vector_3 = null, Vector<GClass515> vector_4 = null, Vector<GClass379> vector_5 = null, GClass838 gclass838_1 = null)
	{
		...
		if (vector_3 == null)
		{
			this.vector_1 = new Vector<GClass515>();
		}
		else
		{
		...
		if (vector_5 == null)
		{
			this.vector_2 = new Vector<GClass379>();
		}
		else
		{
	...
	public virtual void imethod_1(BinaryStream binaryStream_0)
	{
		...
		while (i < num)
		{
			GClass515 gclass = (GClass515)GClass86.smethod_2((int)binaryStream_0.smethod_1());
		...
		while (i < num)
		{
			GClass515 gclass2 = (GClass515)GClass86.smethod_2((int)binaryStream_0.smethod_1());
		...
		while (i < num)
		{
			GClass379 gclass3 = (GClass379)GClass86.smethod_2((int)binaryStream_0.smethod_1());
	...
	public virtual void imethod_2(BinaryStream binaryStream_0)
	{
		...
		if (this.gclass838_0 != null)
		{
			this.gclass838_0.imethod_2(binaryStream_0);
		}
		else
		{
		...
		foreach (GClass515 gclass2 in this.vector_1)
		{
			gclass2.imethod_2(binaryStream_0);
		}
		binaryStream_0.WriteByte(this.vector_2.Length);
		foreach (GClass379 gclass3 in this.vector_2)
		{
	...
	public Vector<GClass515> vector_1;

	public Vector<GClass379> vector_2;
