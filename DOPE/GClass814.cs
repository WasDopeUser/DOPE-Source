...
public class GClass814 : GClass812
{
	public MapProfile CollectProfile
	{
		...
		protected set
		{
			...
			this.method_0(Class5.propertyChangedEventArgs_8);
		}
	}
	...
	public MapProfile SellProfile
	{
		...
		protected set
		{
			...
			this.method_0(Class5.propertyChangedEventArgs_46);
		}
	}

	public GClass814(GClass810 gclass810_1)
	{
		Class8.xDph7tozmh5WD();
		this.bool_0 = true;
		base..ctor(gclass810_1, "Palladium", int.MinValue);
		this.gclass824_0 = new GClass824(gclass810_1);
		this.gclass825_0 = new GClass825(gclass810_1);
	}
	...
	public override MapProfile UpdateProfile(BotProfile botProfile_1)
	{
		...
		else
		{
			...
			{
				collectProfile = maps.FirstOrDefault(new Func<MapProfile, bool>(GClass814.<>c.<>c_0.method_0));
			}
		}
	...
	public override void UpdateState()
	{
		...
		{
			if (base.C.Hero.TypeId == base.Context.Account.HangarPalladiumCollect)
			{
	...
	public readonly GClass824 gclass824_0;

	public readonly GClass825 gclass825_0;
