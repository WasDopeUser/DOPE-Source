...
public abstract class GClass904
{
	public GClass890 Context { get; protected set; }
	...
	{
		GClass904.<>c__DisplayClass13_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass904_0 = this;
		...
		else
		{
			...
			if (npcShip != null && !this.vmethod_6(npcShip))
			{
				flag2 = true;
			}
		}
	...
	{
		GClass904.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass904_0 = this;
	...
	public virtual SelectedNpcModel RvcjkXariys(Ship ship_0)
	{
	...
	{
		SelectedNpcModel selectedNpcModel = this.RvcjkXariys(npcShip_0);
	...
	{
		return this.vmethod_5(npcShip_0) || npcShip_0.LeashedBy <= 0 || this.Hero.Group.method_1(npcShip_0.LeashedBy);
	}
	...
	public virtual bool vmethod_7(NpcShip npcShip_0)
	{
		...
		if (this.vmethod_9(npcShip_0) && this.C.NpcLockout.method_0(npcShip_0.Id))
		{
	...
	public virtual int vmethod_8(NpcShip npcShip_0)
	{
		SelectedNpcModel selectedNpcModel = this.RvcjkXariys(npcShip_0);
	...
	public virtual bool vmethod_9(NpcShip npcShip_0)
	{
		GClass187 gclass;
	...
	public virtual void vmethod_10(NpcShip npcShip_0)
	{
		MapProfile mapProfile = this.C.MapProfile;
	...
	public virtual bool udVjkhArbOf(NpcShip npcShip_0)
	{
		return npcShip_0.HpPercentage <= 24.75f;
	}

	public virtual bool JrfjkaWvhk8(Collectible collectible_0)
	{
		if (this.method_8())
		{
	...
	public virtual bool vmethod_11(Ship ship_0, Collectible collectible_0)
	{
		...
		return this.JrfjkaWvhk8(collectible_0) && !flag && num < Vector2.Distance(heroPosition, position2);
	}
	...
	public virtual bool frijklxAtwW()
	{
	...
	public virtual bool vmethod_15(GClass892 gclass892_0)
	{
		return true;
	}

	public virtual Vector2? vmethod_16(Vector2 vector2_1, out Gate gate_0, bool bool_3 = false, bool bool_4 = true)
	{
		GClass904.<>c__DisplayClass33_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass33_0();
		...
		if (bool_3)
		{
			GClass904.<>c__DisplayClass33_1 CS$<>8__locals2 = new GClass904.<>c__DisplayClass33_1();
			...
			if (ship != null)
			{
				...
				gate_0 = CS$<>8__locals2.<>c__DisplayClass33_0_0.map_0.Gates.Where(new Func<KeyValuePair<int, Gate>, bool>(GClass904.<>c.<>c_0.method_0)).OrderByDescending(new Func<KeyValuePair<int, Gate>, float>(CS$<>8__locals2.method_1)).FirstOrDefault<KeyValuePair<int, Gate>>().Value;
				Gate gate = gate_0;
		...
		while (CS$<>8__locals1.minHeap_0.Any<MapUtils.MapCheckpoint>())
		{
			...
			if (!CS$<>8__locals1.map_0.Hero.method_29(mapCheckpoint3.Edge, null))
			{
	...
	public virtual Vector2? vmethod_17(bool bool_3)
	{
		Gate gate;
		return this.vmethod_16(this.C.Hero.Position, out gate, bool_3, false);
	}

	public virtual Vector2? vmethod_18()
	{
		GClass904.<>c__DisplayClass35_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass35_0();
		CS$<>8__locals1.hero_0 = this.C.Hero;
	...
	protected virtual IEnumerable<Vector2> vmethod_19()
	{
		if (this.method_0() == GroupAttackMode.Assist)
		{
			yield return this.method_2();
		}
		Vector2 vector = this.vmethod_29();
	...
	public virtual bool vmethod_20(out Vector2? nullable_0)
	{
		nullable_0 = null;
		Vector2 position = this.Hero.Position;
		foreach (Vector2 vector in this.vmethod_19())
		{
			nullable_0 = new Vector2?(vector);
			if (this.Map.Grid.method_13(position, vector, 30, 0) != null)
			{
				return true;
			}
		}
	...
	public virtual Gate vmethod_21(int int_1)
	{
		GClass904.<>c__DisplayClass38_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass38_0();
		CS$<>8__locals1.gclass904_0 = this;
	...
	public virtual bool vmethod_23()
	{
		return true;
	}

	public virtual bool vmethod_24()
	{
		bool result = true;
		BotState state = this.C.State;
		int num;
		if (state == BotState.Logout || state == BotState.Travel || state == BotState.Repair || state == BotState.Default || this.C.VfoQqoxikXF(out num))
		{
			result = false;
		}
		return result;
	...
	protected virtual KamikazeState vmethod_25()
	{
		...
		if (!this.vmethod_24() || !this.Hero.Pet.CanKamikaze || !this.vmethod_26())
		{
	...
	public virtual bool vmethod_26()
	{
		...
		SelectedNpcModel selectedNpcModel = this.RvcjkXariys(npcShip);
		if (selectedNpcModel != null && selectedNpcModel.UseKamikaze)
		{
			Vector2 position = this.Hero.Position;
			return Vector2.Distance(npcShip.Position, position) < 750f && this.C.IsAttacking && this.C.AttackingId == npcShip.Id && (!this.udVjkhArbOf(npcShip) || npcShip.TemporarySpeed == 0f);
		}
		return false;
	}

	public virtual bool vmethod_27(out int int_1)
	{
		GClass904.<>c__DisplayClass44_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass44_0();
		CS$<>8__locals1.gclass904_0 = this;
		int_1 = 0;
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		...
		using (IEnumerator<SelectedNpcModel> enumerator = this.C.MapProfile.NpcWhitelist.GetEnumerator())
		{
			...
			{
				GClass904.<>c__DisplayClass44_1 CS$<>8__locals2 = new GClass904.<>c__DisplayClass44_1();
				...
				if (CS$<>8__locals2.selectedNpcModel_0.Enabled && CS$<>8__locals2.selectedNpcModel_0.Priority >= 0 && CS$<>8__locals2.selectedNpcModel_0.UsePetLocator)
				{
					...
					int item;
					if (NpcUtils.NpcById.TryGetValue(CS$<>8__locals2.selectedNpcModel_0.NpcId, out npcType) && NpcUtils.XmlNpcIds.TryGetValue(npcType.ToString(), out item) && this.Hero.Pet.method_21(PetMode.EnemyLocator, item))
					{
		...
		int_1 = list.OrderByDescending(new Func<ValueTuple<int, int>, bool>(CS$<>8__locals1.method_0)).ThenBy(new Func<ValueTuple<int, int>, DateTimeOffset>(CS$<>8__locals1.method_1)).ThenByDescending(new Func<ValueTuple<int, int>, int>(GClass904.<>c.<>c_0.method_1)).FirstOrDefault<ValueTuple<int, int>>().Item1;
		return int_1 != 0;
	}

	protected virtual bool vmethod_28()
	{
		GClass904.<>c__DisplayClass45_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass45_0();
		CS$<>8__locals1.gclass904_0 = this;
		...
		if (enemyLocatorResult_ != null && enemyLocatorResult_.Found)
		{
			...
			if (((enemyLocatorResult_2 != null) ? enemyLocatorResult_2.Type : null) != null && CS$<>8__locals1.enemyLocatorResult_0.Timestamp.smethod_0(3000))
			{
				...
				if (npcShip != null && (!this.vmethod_6(npcShip) || !this.vmethod_7(npcShip)))
				{
	...
	protected virtual Vector2 vmethod_29()
	{
	...
	public virtual PetMode vmethod_30(out int int_1)
	{
		int_1 = 0;
		if (!this.vmethod_24())
		{
	...
	{
		GClass904.<>c__DisplayClass56_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass56_0();
		CS$<>8__locals1.gclass904_0 = this;
		this.method_9(false);
		this.method_1(GroupAttackMode.Disabled);
		CS$<>8__locals1.vector2_0 = this.Hero.Position;
		List<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>> source = CS$<>8__locals1.method_0().OrderByDescending(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, int>(GClass904.<>c.<>c_0.method_2)).ToList<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>>();
		ValueTuple<GroupManager.GroupMember, SelectedNpcModel> valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass904.<>c.<>c_0.method_3));
		...
		IL_112:
		valueTuple = source.FirstOrDefault(new Func<ValueTuple<GroupManager.GroupMember, SelectedNpcModel>, bool>(GClass904.<>c.<>c_0.method_4));
		if (valueTuple.Item2 != null)
		{
			this.method_9(true);
			this.method_3(valueTuple.Item1.Position);
	...
	protected virtual float fwLjkcewkhW(Vector2 vector2_1)
	{
		float num = 0f;
	...
	protected virtual float vmethod_31(Vector2 vector2_1, [TupleElementNames(new string[]
	{
		"pos",
		"range"
	...
	protected virtual float vmethod_32(Vector2 vector2_1, Vector2 vector2_2, [TupleElementNames(new string[]
	{
		"pos",
		"range"
	})] List<ValueTuple<Vector2, int>> npcs)
	{
		...
		foreach (ValueTuple<Vector2, int> valueTuple in npcs)
		{
			float num2 = Math.Max(0f, (float)((double)valueTuple.Item2 - GClass878.smethod_13(vector2_1, vector2_2, valueTuple.Item1, true)));
			num -= (float)Math.Sqrt((double)num2);
		}
		return num;
	}

	public virtual Vector2? vmethod_33(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		if (!this.Map.Grid.method_7(vector2_2) && !this.Map.Grid.method_3(vector2_1, vector2_2))
		{
			return new Vector2?(vector2_2);
		}
		return this.vmethod_42(vector2_1, vector2_2, float_0);
	}

	public virtual Vector2? vmethod_34(Vector2 vector2_1, Vector2 vector2_2, float float_0, Vector2? nullable_0 = null, float float_1 = 0.5f)
	{
		Vector2 vector2_3 = GClass873.smethod_0(vector2_1, vector2_2, float_0, nullable_0, float_1);
		return this.vmethod_33(vector2_1, vector2_3, float_0);
	}

	public virtual int vmethod_35(Vector2 vector2_1, Vector2 vector2_2, float float_0, int int_1 = 10)
	{
		GClass904.<>c__DisplayClass62_0 CS$<>8__locals1;
	...
	public virtual Vector2? vmethod_36(Vector2 vector2_1, int int_1 = 1100)
	{
		float num = 0f;
		float num2 = 0f;
		int num3 = 0;
		Vector2 position = this.Hero.Position;
		foreach (ValueTuple<NpcShip, float, int> valueTuple in this.Map.method_7<NpcShip>(vector2_1, new Func<NpcShip, bool>(this.vmethod_9), null, 200))
		{
	...
	public virtual int vmethod_37(NpcShip npcShip_0)
	{
		int val = 590;
		int range = npcShip_0.Range;
		if (npcShip_0.TemporarySpeed != 0f && !this.udVjkhArbOf(npcShip_0))
		{
			return range;
		}
	...
	public virtual int vmethod_38(Vector2 vector2_1, NpcShip npcShip_0, out Vector2 vector2_2)
	{
		...
		int num2 = this.Hero.method_30();
		float num3 = (num + (float)npcShip_0.LastDistance) / 2f;
		int num4 = this.vmethod_37(npcShip_0) + num2;
		int num5 = num4 / 2;
	...
	public virtual Vector2? vmethod_39(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null)
	{
		if (this.method_10() >= KamikazeState.PullingEnemies)
		{
			return this.vmethod_40(vector2_1);
		}
		if (this.udVjkhArbOf(npcShip_0) || npcShip_0.TemporarySpeed == 0f)
		{
			nullable_0 = null;
		}
		return this.vmethod_41(vector2_1, npcShip_0, nullable_0, 0.5f);
	}

	public virtual Vector2? vmethod_40(Vector2 vector2_1)
	{
		if (this.method_10() == KamikazeState.PullingEnemies)
		{
			return null;
		...
		Vector2 vector2_2 = this.vmethod_36(vector2_1, 1100) ?? position;
		NpcShip npcShip = this.C.EnemyTarget as NpcShip;
		if (this.method_10() == KamikazeState.Activating && !this.Hero.LastTookDamage.smethod_0(2000))
		{
			Vector2? result = this.vmethod_34(vector2_1, vector2_2, 325f, null, 0.5f);
			bool flag;
			if (npcShip != null && this.Map.method_8(npcShip, out flag))
			{
				result = this.vmethod_34(vector2_1, vector2_2, 325f, new Vector2?(this.Map.Center), 0.5f);
			}
			return result;
		}
		...
		if ((lastControlDisabled > this.Hero.LastTookDamage || (this.Hero.LastTookDamage - lastControlDisabled).TotalMilliseconds <= (double)num) && (npcShip == null || !this.udVjkhArbOf(npcShip)))
		{
			Vector2 vector = this.Hero.Position - position;
			float num2 = (float)Math.Atan2((double)vector.X + 0.01, (double)vector.Y + 0.01);
			Vector2 vector2_3 = GClass873.smethod_8(position, 100f, num2 + 0.6f);
			return this.vmethod_33(vector2_1, vector2_3, 100f);
		}
		return this.vmethod_34(vector2_1, position, 650f, null, 0.5f);
	}

	public virtual Vector2? vmethod_41(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		if (npcShip_0 == null)
		{
		...
		Vector2 vector2_2;
		int num2 = this.vmethod_38(vector2_1, npcShip_0, out vector2_2);
		if (float_0 != 0f)
		{
			...
			float_0 *= (float)this.vmethod_35(vector2_1, vector2_2, (float)num2, 10);
		}
		return this.vmethod_34(vector2_1, vector2_2, (float)num2, nullable_0, float_0);
	}

	public virtual Vector2? vmethod_42(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		GClass904.<>c__DisplayClass69_0 CS$<>8__locals1;
		CS$<>8__locals1.gclass904_0 = this;
	...
	{
		GClass904.<>c__DisplayClass70_0 CS$<>8__locals1 = new GClass904.<>c__DisplayClass70_0();
		CS$<>8__locals1.gclass904_0 = this;
		if (this.method_12() != -1)
		{
			return;
		...
		}.Select(new Func<NpcUtils.NpcType, int>(GClass904.<>c.<>c_0.method_5)).ToList<int>();
	...
	public virtual bool vmethod_44(NpcShip npcShip_0)
	{
	...
	{
		this.method_13(-1);
		this.method_7(!this.C.method_72());
		this.method_4();
		this.method_11(this.vmethod_25());
		this.method_14().method_0();
		this.method_17(this.vmethod_28());
		this.method_5();
	}

	public virtual IEnumerable<string> vmethod_45()
	{
	...
	[CompilerGenerated]
	private void method_18(double double_0, ref GClass904.<>c__DisplayClass13_0 <>c__DisplayClass13_0_0)
	{
		this.C.NpcLockout.method_1(<>c__DisplayClass13_0_0.ship_0.Id, double_0 * 10000.0);
	}

	[CompilerGenerated]
	private Vector2 method_19(float float_0, ref GClass904.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return GClass873.smethod_8(<>c__DisplayClass62_0_0.vector2_0, <>c__DisplayClass62_0_0.float_0, <>c__DisplayClass62_0_0.float_1 + float_0);
	}

	[CompilerGenerated]
	private float method_20(Vector2 vector2_1, ref GClass904.<>c__DisplayClass62_0 <>c__DisplayClass62_0_0)
	{
		return this.fwLjkcewkhW(vector2_1) + this.vmethod_31(vector2_1, <>c__DisplayClass62_0_0.list_0);
	}

	[CompilerGenerated]
	private float method_21(ref GClass904.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
		return this.fwLjkcewkhW(<>c__DisplayClass69_0_0.vector2_0) + this.vmethod_32(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0, <>c__DisplayClass69_0_0.list_0) - Vector2.Distance(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0) * 2f;
	}

	[CompilerGenerated]
	private void method_22(ref GClass904.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
