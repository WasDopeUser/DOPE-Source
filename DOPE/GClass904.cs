...
public abstract class GClass904
{
	...
	protected virtual bool vmethod_0(Ship ship_0, out Ship ship_1, bool bool_3 = false)
	{
		...
		bool flag = bool_3 && this.C.Map.Grid.method_6(CS$<>8__locals1.ship_0.Position) && Vector2.Distance(this.Map.Hero.Position, CS$<>8__locals1.ship_0.Position) > 1000f;
		bool flag2 = false;
	...
	public virtual bool UntCgkpMdca(Ship ship_0, out Ship ship_1)
	{
		ship_1 = null;
		return this.vmethod_0(ship_0, out ship_1, false);
	}

	public virtual bool vmethod_1(NpcShip npcShip_0)
	{
	...
	{
		return this.vmethod_1(npcShip_0) && this.C.MapProfile.SecondaryCircleNpcs && npcShip_0.HpPercentage > 24.75f;
	}

	public virtual bool vmethod_3(bool bool_3 = false, bool bool_4 = false)
	{
	...
	public virtual SelectedNpcModel vmethod_4(Ship ship_0)
	{
	...
	public virtual bool vmethod_7(NpcShip npcShip_0)
	{
		...
		{
			return !this.C.Map.Grid.method_6(npcShip_0.Position);
		}
		return false;
	}
	...
	public virtual bool vmethod_11(NpcShip npcShip_0)
	{
		return npcShip_0.HpPercentage <= 24.75f;
	}

	public virtual bool vmethod_12(Collectible collectible_0)
	{
		if (this.method_8())
		{
	...
	public virtual bool vmethod_13(Ship ship_0, Collectible collectible_0)
	{
		...
		bool flag = this.vmethod_2(npcShip) && num2 < 1100f;
		return this.vmethod_12(collectible_0) && !flag && num < Vector2.Distance(heroPosition, position2);
	}

	public virtual bool vmethod_14()
	{
	...
	public virtual List<Rectangle> vmethod_16()
	{
		return this.C.Map.DefaultWorkArea;
	}

	public virtual BotState vmethod_17()
	{
		return BotState.Roam;
	}

	public virtual bool vmethod_18(GClass892 gclass892_0)
	{
		return true;
	}

	public virtual Vector2? vmethod_19(Vector2 vector2_1, out Gate gate_0, bool bool_3 = false, bool bool_4 = true)
	{
	...
	public virtual Vector2? vmethod_20(bool bool_3)
	{
		Gate gate;
		return this.vmethod_19(this.C.Hero.Position, out gate, bool_3, false);
	}
	...
	protected virtual IEnumerable<Vector2> vmethod_22()
	{
		...
		Vector2 vector = this.vmethod_32();
	...
	public virtual bool vmethod_29()
	{
		...
		SelectedNpcModel selectedNpcModel = this.vmethod_4(npcShip);
		if (selectedNpcModel != null && selectedNpcModel.UseKamikaze)
		{
			Vector2 position = this.Hero.Position;
			return Vector2.Distance(npcShip.Position, position) < 750f && this.C.IsAttacking && this.C.AttackingId == npcShip.Id && (!this.vmethod_11(npcShip) || npcShip.TemporarySpeed == 0f);
		}
		return false;
	}
	...
	protected virtual bool vmethod_31()
	{
	...
	protected virtual Vector2 vmethod_32()
	{
	...
	public virtual PetMode vmethod_33(out int int_1)
	{
		int_1 = 0;
		if (!this.vmethod_27())
		{
	...
	protected virtual float vmethod_34(Vector2 vector2_1)
	{
		float num = 0f;
		if (this.Map.Grid.method_6(vector2_1))
		{
			num -= 1000000f;
		}
	...
	protected virtual float vmethod_35(Vector2 vector2_1, [TupleElementNames(new string[]
	{
		"pos",
		"range"
	...
	protected virtual float vmethod_36(Vector2 vector2_1, Vector2 vector2_2, [TupleElementNames(new string[]
	{
		"pos",
		"range"
	})] List<ValueTuple<Vector2, int>> npcs)
	...
	public virtual Vector2? vmethod_37(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		if (!this.Map.Grid.method_6(vector2_2) && !this.Map.Grid.method_2(vector2_1, vector2_2))
		{
			return new Vector2?(vector2_2);
		}
		return this.vmethod_44(vector2_1, vector2_2, float_0);
	}

	public virtual Vector2? iOgCgYpyBdo(Vector2 vector2_1, Vector2 vector2_2, float float_0, Vector2? nullable_0 = null, float float_1 = 0.5f)
	{
		Vector2 vector2_3 = GClass873.smethod_0(vector2_1, vector2_2, float_0, nullable_0, float_1);
		return this.vmethod_37(vector2_1, vector2_3, float_0);
	}
	...
	public virtual int vmethod_40(NpcShip npcShip_0)
	{
		...
		if (npcShip_0.TemporarySpeed != 0f && !this.vmethod_11(npcShip_0))
		{
			return range;
		}
	...
	public virtual Vector2? DohCgwiIlt4(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null)
	{
		if (this.method_10() >= KamikazeState.PullingEnemies)
		{
			return this.vmethod_42(vector2_1);
		}
		if (this.vmethod_11(npcShip_0) || npcShip_0.TemporarySpeed == 0f)
		{
			nullable_0 = null;
		}
		return this.vmethod_43(vector2_1, npcShip_0, nullable_0, 0.5f);
	}

	public virtual Vector2? vmethod_42(Vector2 vector2_1)
	{
		if (this.method_10() == KamikazeState.PullingEnemies)
		{
			return null;
		...
		{
			Vector2? result = this.iOgCgYpyBdo(vector2_1, vector2_2, 325f, null, 0.5f);
			bool flag;
			if (npcShip != null && this.Map.method_8(npcShip, out flag))
			{
				result = this.iOgCgYpyBdo(vector2_1, vector2_2, 325f, new Vector2?(this.Map.Center), 0.5f);
			}
			return result;
		}
		...
		if ((lastControlDisabled > this.Hero.LastTookDamage || (this.Hero.LastTookDamage - lastControlDisabled).TotalMilliseconds <= (double)num) && (npcShip == null || !this.vmethod_11(npcShip)))
		{
			...
			return this.vmethod_37(vector2_1, vector2_3, 100f);
		}
		return this.iOgCgYpyBdo(vector2_1, position, 650f, null, 0.5f);
	}

	public virtual Vector2? vmethod_43(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		if (npcShip_0 == null)
		{
		...
		return this.iOgCgYpyBdo(vector2_1, vector2_2, (float)num2, nullable_0, float_0);
	}

	public virtual Vector2? vmethod_44(Vector2 vector2_1, Vector2 vector2_2, float float_0)
	{
		...
		for (double num4 = 0.0; num4 < 6.2831853071795862; num4 += num)
		{
			...
			int num5;
			int num6;
			if (this.Map.Grid.method_0(CS$<>8__locals1.vector2_0.X, CS$<>8__locals1.vector2_0.Y, out num5, out num6) && (num5 != num2 || num6 != num3))
			{
				num2 = num5;
				num3 = num6;
				if (!this.Map.Grid.method_8(num2, num3))
				{
	...
	public void method_5()
	{
		...
		CS$<>8__locals1.qIuMfsfpqiu = new NpcUtils.NpcType[]
		{
	...
	{
		this.method_13(-1);
		this.method_7(!this.C.method_74());
		this.method_4();
		this.method_11(this.vmethod_28());
		this.method_14().method_0();
		this.method_17(this.vmethod_31());
		this.method_5();
	}
	...
	{
		return this.vmethod_34(vector2_1) + this.vmethod_35(vector2_1, <>c__DisplayClass62_0_0.list_0);
	}

	[CompilerGenerated]
	private float method_21(ref GClass904.<>c__DisplayClass69_0 <>c__DisplayClass69_0_0)
	{
		return this.vmethod_34(<>c__DisplayClass69_0_0.vector2_0) + this.vmethod_36(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0, <>c__DisplayClass69_0_0.list_0) - Vector2.Distance(<>c__DisplayClass69_0_0.vector2_1, <>c__DisplayClass69_0_0.vector2_0) * 2f;
	}
