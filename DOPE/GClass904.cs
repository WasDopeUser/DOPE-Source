...
public class GClass904 : GClass903
{
	public GClass904(GClass889 gclass889_1)
	{
	...
	{
		GClass904.<>c__DisplayClass1_0 CS$<>8__locals1;
		...
		if (npcShip == null)
		{
			this.lyrwCrKunMo(1.0, ref CS$<>8__locals1);
			return true;
		}
		if ((!base.C.IsAttacking || base.C.AttackingId != CS$<>8__locals1.ship_0.Id) && CS$<>8__locals1.ship_0 == base.C.Map.SelectedShip && !this.vmethod_6(npcShip))
		{
			...
			{
				this.lyrwCrKunMo(2.0, ref CS$<>8__locals1);
				return true;
			}
		}
	...
	[CompilerGenerated]
	private void lyrwCrKunMo(double double_0, ref GClass904.<>c__DisplayClass1_0 <>c__DisplayClass1_0_0)
	{
