...
namespace DarkorbitAPI
{
	...
	{
		public static int ExixjgEkd3(Ship ship_0)
		{
			NpcShip npcShip = ship_0 as NpcShip;
			if (npcShip != null && npcShip.Type != null && npcShip.Type.Class != null)
			{
				return SecurityManager.smethod_0(npcShip.Type);
			}
			return 540;
		}

		public static int smethod_0(NpcUtils.NpcType npcType_0)
		{
		...
		public static int smethod_1(NpcUtils.NpcClass npcClass_0)
		{
			int result;
		...
		public static int smethod_2(Ship ship_0)
		{
			return SecurityManager.ExixjgEkd3(ship_0);
		}

		public string itZxNqgcms()
		{
			...
			return string.Format("{0} {1}x{2} {3}", new object[]
			{
				...
				1920,
				1080,
				this.Game.Settings.UIString ?? ".root1.instance472.MainClientApplication0.ApplicationSkin2.Group3.Group4._-nR5.instance25048 root1 false -1"
			});
		}
