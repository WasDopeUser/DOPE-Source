...
namespace DarkorbitAPI.Structures
{
	...
	{
		internal void method_0(GClass247 gclass247_0)
		{
			Vector2 value = new Vector2((float)gclass247_0.int_0, (float)gclass247_0.int_2);
		...
		public ConcurrentDictionary<int, GroupManager.GroupMember> Members
		{
			...
			private set
			{
				...
				this.method_12(Class5.propertyChangedEventArgs_74);
			}
		}
		...
		public bool IsInitialized
		{
			...
			private set
			{
				...
				this.method_12(Class5.IsOwner);
				this.method_12(Class5.propertyChangedEventArgs_45);
			}
		}
		...
		public int OwnerId
		{
			...
			set
			{
				...
				this.method_12(Class5.IsOwner);
				this.method_12(Class5.propertyChangedEventArgs_79);
			}
		}
		...
		public class GroupMember : Entity, INotifyPropertyChanged
		{
			...
			public bool IsInitialized
			{
				...
				set
				{
					...
					this.<IsInitialized>k__BackingField = value;
					this.method_6(Class5.propertyChangedEventArgs_45);
				}
			}
			...
			public GClass204 Location
			{
				...
				set
				{
					...
					this.method_6(Class5.propertyChangedEventArgs_80);
					this.method_6(Class5.MapId);
					this.method_6(Class5.propertyChangedEventArgs_70);
				}
			}
			...
			public GClass198 ShipInfo
			{
				...
				set
				{
					...
					this.method_6(Class5.propertyChangedEventArgs_103);
				}
			}
			...
			public GClass205 Target
			{
				...
				set
				{
					...
					this.method_6(Class5.propertyChangedEventArgs_108);
				}
			}
			...
			public int FactionId
			{
				...
				set
				{
					...
					this.method_6(Class5.propertyChangedEventArgs_24);
				}
			}
			...
			public bool IsCloaked
			{
				...
				set
				{
					...
					this.method_6(Class5.GybMlgtsfkl);
				}
			}
			...
			public DateTimeOffset LastPinged
			{
				...
				set
				{
					...
					this.method_6(Class5.propertyChangedEventArgs_60);
				}
			}

			public event PropertyChangedEventHandler PropertyChanged;

			public bool CoKbSjokMU(out GClass205 gclass205_0)
			{
