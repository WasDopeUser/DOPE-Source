...
namespace DarkorbitAPI.Structures
{
	public class Hero : Ship
	{
		...
		internal void method_13(GClass275 gclass275_0)
		{
			...
			{
				menuItem = (this.MenuItems[gclass275_0.Id] = new MenuItem());
			}
		...
		internal void method_15(GClass240 gclass240_0)
		{
			...
			if (string_ != null)
			{
				...
				{
					this.Credits = gclass240_0.double_1;
					return;
				}
				if (string_ == "currency_uridium")
				{
					this.Uridium = gclass240_0.double_1;
					return;
				}
				if (string_ == "currency_honour")
				{
					this.Honor = gclass240_0.double_1;
					return;
				}
				if (string_ == "currency_experience")
				{
					this.Experience = gclass240_0.double_1;
					return;
				}
				if (string_ == "currency_jackpotmoney")
				{
					this.Jackpot = gclass240_0.double_1;
					return;
				}
