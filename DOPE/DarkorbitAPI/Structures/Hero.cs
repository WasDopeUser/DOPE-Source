...
namespace DarkorbitAPI.Structures
{
	public class Hero : Ship
	{
		...
		internal void method_12(GClass235 gclass235_0)
		{
			...
			{
				this.ItemCooldown.method_1((CooldownType)gclass235_0.gclass178_0.uint_0, gclass235_0.double_1);
			}
		}
		...
		internal void method_15(GClass243 gclass243_0)
		{
			...
			if (string_ != null)
			{
				...
				{
					this.method_22(string_, gclass243_0.double_1);
					return;
				}
				string text = string_;
				if (text.StartsWith("resource_"))
				{
					this.method_24(text, (double)((int)gclass243_0.double_1));
					return;
				}
				string text2 = string_;
				if (text2.StartsWith("equipment_"))
				{
					this.method_23(text2, (int)gclass243_0.double_1);
				}
			}
		}
		...
		public bool method_18(string string_0, out MenuItem menuItem_0, bool bool_0 = false)
		{
			...
			{
				this.Game.Connection.Server.method_13(string_0, bool_0, false);
				return true;
			}
			return false;
		}
		...
		public bool IsInitialized
		{
			...
			set
			{
				...
				this.method_11(Class5.propertyChangedEventArgs_43);
			}
		}
		...
		public override void Init(GClass219 gclass219_0)
		{
			...
			this.Level = gclass219_0.int_12;
			this.CargoCapacity = gclass219_0.int_14;
		...
		{
			return (gate_0 != null && gate_0.FactionId == base.FactionId) || (portalEdge_0 != null && this.method_27(portalEdge_0, null) && !MapUtils.smethod_3(portalEdge_0.FromMapId).StartsWith("4-") && portalEdge_0.FactionId != 0 && portalEdge_0.FactionId == base.FactionId);
		}
		...
		public void method_30(GClass229 gclass229_0)
		{
