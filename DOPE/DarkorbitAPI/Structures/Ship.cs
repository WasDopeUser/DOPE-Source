	...
	public class Ship : MovingEntity, INotifyPropertyChanged
	{
		...
		public int Shield
		{
			...
			set
			{
				...
				this.method_11(Class5.ShieldPercentage);
				this.method_11(Class5.ShieldDisplay);
				this.method_11(Class5.propertyChangedEventArgs_101);
			}
		}
		...
		public int TargetId
		{
			...
			internal set
			{
				...
				this.method_11(Class5.propertyChangedEventArgs_109);
			}
		}

		public event PropertyChangedEventHandler PropertyChanged;

		public virtual void Init(GClass264 gclass264_0)
		{
			this.PosX = gclass264_0.int_1;
			this.PosY = gclass264_0.int_2;
			this.IsNpc = gclass264_0.bool_2;
			this.FactionId = gclass264_0.int_3;
			this.Id = gclass264_0.int_0;
			this.TypeId = gclass264_0.string_0;
			this.ClanTag = gclass264_0.string_1;
			this.Cloaked = gclass264_0.bool_3;
			this.Name = gclass264_0.string_2;
			this.ClanDiplomacy = gclass264_0.gclass139_0.int_0;
			this.Modifiers.Clear();
			this.Effects.Clear();
			foreach (GClass187 gclass187_ in gclass264_0.vector_0)
			{
		...
		{
			return this.Modifiers.TryGetValue(int_0, out gclass187_0) && gclass187_0.Count > 0 && gclass187_0.aJyunkjqRa;
		}
