	...
	public class DarkOrbitWebAPI : INotifyPropertyChanged
	{
		...
		public string Sid
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.propertyChangedEventArgs_103);
			}
		}
		...
		public DarkOrbitWebAPI.GalaxyGatesInfo GgInfo
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.propertyChangedEventArgs_27);
			}
		}
		...
		public EquipmentAPI Equipment
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.propertyChangedEventArgs_18);
			}
		}
		...
		public string Server
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.propertyChangedEventArgs_97);
			}
		}
		...
		public bool IsLoggedIn
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.IsLoggedIn);
			}
		}
		...
		public string ForcedUserAgent
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class5.propertyChangedEventArgs_23);
			}
		}
		...
		{
			return this.CheckedLoggedIn(this.Get(GClass879.smethod_1(this.Server, null), null).Content);
		}
		...
		private bool FixResponse(HttpResponseMessage response, out HttpResponseMessage newResponse)
		{
			newResponse = null;
			Uri location = response.Headers.Location;
			string text = (location != null) ? location.AbsolutePath : null;
			if (response.StatusCode == HttpStatusCode.Found && text.StartsWith("/"))
			{
				...
				newResponse = this.Get(url, null).Data;
				return true;
			}
		...
		public void FillServerInstances()
		{
			...
			MatchCollection matchCollection = Regex.Matches(JsonConvert.DeserializeObject<DarkOrbitWebAPI.ServerInstanceList>(this.Post(GClass879.smethod_8(this.Server), new Dictionary<string, string>
			{
				{
					"command",
					"getInstanceList"
		...
		public bool Login(string username, string password, string server, ProxySettings proxy = null)
		{
			DarkOrbitWebAPI.<>c__DisplayClass81_0 CS$<>8__locals1 = new DarkOrbitWebAPI.<>c__DisplayClass81_0();
			CS$<>8__locals1.username = username;
			CS$<>8__locals1.server = server;
			CS$<>8__locals1.<>4__this = this;
			if (this._handler.SupportsProxy)
			{
				GClass123 gclass = this._handler.Proxy as GClass123;
				if (gclass == null)
				{
					if (proxy != null)
					{
						this._handler.Proxy = new GClass123(new ProxySettings[]
						{
							proxy
						}, 0);
					}
				...
				{
					gclass.method_5();
					this._handler.Proxy = null;
				}
				else
				{
					gclass.method_2(new ProxySettings[]
					{
						proxy
					});
				}
			...
			try
			{
				...
				{
					CS$<>8__locals1.resp = this.Post(GClass879.smethod_8(text3), new Dictionary<string, string>
					{
						{
							"command",
							"getInstanceList"
		...
		{
			return this.GetFlashSettings(this.Get(GClass879.smethod_2(this.Server), null).Content);
		}
		...
		{
			return this.GetMapHosts(this.Get(GClass879.Maps(this.Server), null).Content);
		}
		...
		{
			return this.GetSpacemapConfig(this.Get(GClass879.smethod_3(), null).Content);
		}
		...
		public DarkOrbitWebAPI.NpcConstants GetNpcList()
		{
			return this.GetNpcList(this.Get("https://int1.darkorbit.com/spacemap/templates/en/resource_constants.xml", null).Content);
		}

		public DarkOrbitWebAPI.NpcConstants GetNpcList(string content)
		{
			XmlSerializer xmlSerializer = new XmlSerializer(typeof(DarkOrbitWebAPI.NpcConstants), new XmlRootAttribute("resource"));
			DarkOrbitWebAPI.NpcConstants result;
			using (StringReader stringReader = new StringReader(content))
			{
				try
				{
					return (DarkOrbitWebAPI.NpcConstants)xmlSerializer.Deserialize(stringReader);
				}
				catch
				{
				}
		...
		{
			return DarkOrbitWebAPI.GetMapList(this.Get(GClass879.smethod_0("int1") + "/spacemap/graphics/maps-config.xml", null).Content);
		}

		public static DarkOrbitWebAPI.MapConstants GetMapList(string content)
		{
			XmlSerializer xmlSerializer = new XmlSerializer(typeof(DarkOrbitWebAPI.MapConstants), new XmlRootAttribute("maps"));
			DarkOrbitWebAPI.MapConstants result;
			using (StringReader stringReader = new StringReader(content))
			{
				try
				{
					return (DarkOrbitWebAPI.MapConstants)xmlSerializer.Deserialize(stringReader);
				}
				catch
				{
				}
		...
		{
			return this.Get(GClass879.smethod_12(), null).Content;
		}
		...
		public DarkOrbitWebAPI.GalaxyGatesInfo GetGalaxyGatesInfo()
		{
			...
			DarkOrbitWebAPI.Response response = this.Get(GClass879.smethod_6(this.Server, this.Uid, this.Sid, "init"), delegate(HttpRequestMessage msg)
			{
		...
		public void Logout()
		{
			this.Get(GClass879.smethod_4(this.Server), null);
		}
		...
		public string Bid(int credits, DarkOrbitWebAPI.Item item, DarkOrbitWebAPI.AuctionType Type = DarkOrbitWebAPI.AuctionType.hour)
		{
			...
			new
			{
				TXLIklEe2EOcBpEPmcs = "hour",
				zsXcG9ExWtXYLwGNPAm = "bid",
				qf6ADmEWXyhvKVAw8Vj = item.lootId,
				UJXln6ENy8EpOVLWd49 = item.itemId,
				yUPd0pEFrZ4PCV2vmcN = credits,
				uFgyoxEp6b8dZs51M7O = DarkOrbitWebAPI.place_bet_btn,
				r9vqauEA5F6SbXe1QtL = reloadToken2
			};
			...
			string content = this.Post(GClass879.smethod_1(this.Server, "internalAuction") + "&reloadToken=" + reloadToken2, data, GClass879.smethod_1(this.Server, "internalAuction"), null).Content;
		...
		public bool BuyItem(string category, string itemId, int amount = 1, int level = -1, string selectedName = "")
		{
			new
			{
				zIgM6ZEhSiq8SMmKZ1A = "purchase",
				qaPZHIE3U0f9Evx0LJ3 = category,
				UJZyVnEdfKEeFwRdk9B = itemId,
				MqFVbmEjXJWRYEWP0kL = amount,
				ios0umErst8OTWgKxtQ = level,
				SgWb8RE7Zxxdtytjwu0 = selectedName
			};
			Dictionary<string, string> data = new Dictionary<string, string>
			{
				{
			...
			return this.Post(GClass879.smethod_5(this.Server), data, "https://darkorbit.com", null).Content.Contains("result: \"success\"");
		}
		...
		{
			[XmlElement("item")]
			public DarkOrbitWebAPI.resourceItem[] Npcs
			{
				get
				{
		...
		{
			[XmlElement("map")]
			public DarkOrbitWebAPI.MapConfig[] Maps
			{
				get
				{
					return this.mapField;
			...
			private DarkOrbitWebAPI.MapConfig[] mapField;
		}
		...
		public class MapConfig
		{
			...
			[XmlAttribute]
			public string groupSystemName
			{
				get
				{
					return this.groupSystemNameField;
				}
				set
				{
					this.groupSystemNameField = value;
				}
			}
			...
			private string groupSystemNameField;

			private double scaleFactorField;

			private string minimapField;
		}
	}
}
