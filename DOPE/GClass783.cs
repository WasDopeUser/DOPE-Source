...
public static class GClass783
{
	...
	public static bool smethod_0(int int_0, int int_1, string string_0, out DateTimeOffset dateTimeOffset_0, out GClass783.GEnum9 genum9_0, string string_1 = "basic")
	{
		...
		try
		{
			...
			HttpResponseMessage result = GClass783.httpClient_0.PostAsync(string.Format("https://powerofdark.space/license/verify/{0}/", string_1), new FormUrlEncodedContent(new Dictionary<string, string>
			{
				{
					"ServerId",
			...
			if (result.Headers.TryGetValues("X-Signature", out source) && result.IsSuccessStatusCode)
			{
				...
				byte[] byte_ = GClass790.smethod_1(source.First<string>());
				...
				{
					genum9_0 = (GClass783.GEnum9)int.Parse(dictionary["LicenseState"]);
					result3 = (genum9_0 == (GClass783.GEnum9)1);
				}
			}
			else
			{
	...
	private static bool smethod_1(byte[] byte_0, byte[] byte_1)
	{
		...
		using (RSACryptoServiceProvider rsacryptoServiceProvider = new RSACryptoServiceProvider())
		{
			...
			parameters.Modulus = GClass790.smethod_1("");
