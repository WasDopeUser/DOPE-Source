...
public class GClass918 : GClass915
{
	[CompilerGenerated]
	...
	public GClass918(GClass889 gclass889_1)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor(gclass889_1, "GgSpinner");
	}
	...
	protected void method_4()
	{
		foreach (DarkOrbitWebAPI.jumpgateGate jumpgateGate in this.method_2().gates)
		{
			if (jumpgateGate.current == jumpgateGate.total && !jumpgateGate.prepared)
			{
				bool argument = false;
				string text;
				string argument2 = GClass918.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
	...
	protected bool method_6(out string string_0, out int int_0)
	{
		...
		if (account != null && account.Spinner_StopABG)
		{
			...
			{
				string text;
				string a = GClass918.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
		...
		{
			string text3;
			string text2 = GClass918.dictionary_0.TryGetValue(jumpgateGate2.id, out text3) ? text3 : "unknown";
			bool flag2;
	...
	public int method_7()
	{
		...
		GClass889 context = base.Context;
	...
	{
		GClass918.<>c__DisplayClass12_0 CS$<>8__locals1 = new GClass918.<>c__DisplayClass12_0();
		int_0 = 0;
		int num;
		...
		{
			GClass879.smethod_6(web.Server, web.Uid, web.Sid, "multiEnergy"),
	...
	{
		DarkOrbitWebAPI web = base.Context.Game.Web;
		return web.Get(GClass879.smethod_6(web.Server, web.Uid, web.Sid, "setupGate") + "&gateID=" + int_0.ToString(), null).Data.IsSuccessStatusCode;
	}
	...
	protected bool method_11(DarkOrbitWebAPI.GalaxyGatesInfoUpdate galaxyGatesInfoUpdate_0)
	{
		...
		{
			GClass918.<>c__DisplayClass15_0 CS$<>8__locals1 = new GClass918.<>c__DisplayClass15_0();
		...
		{
			GClass918.<>c__DisplayClass15_1 CS$<>8__locals2 = new GClass918.<>c__DisplayClass15_1();
	...
	public override bool vmethod_0()
	{
		...
		AccountSettings account = base.Context.Account;
		return account == null || !account.Spinner_UsePhoenix || GClass892.list_0.Contains(activeHangarName);
	}
	...
	{
		Class13.xnk8ImWzpOt04();
		GClass918.dictionary_0 = new Dictionary<int, string>
		{
			{
				1,
				"alpha"
