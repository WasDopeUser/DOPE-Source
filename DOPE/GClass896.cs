...
public class GClass896 : GClass895
{
	...
	private GClass912 Behavior { get; }

	public GClass896(GClass889 gclass889_1)
	{
		Class13.xnk8ImWzpOt04();
		base..ctor(gclass889_1, TargetMap.X6);
		GClass896.<>c__DisplayClass7_0 CS$<>8__locals1 = new GClass896.<>c__DisplayClass7_0();
		CS$<>8__locals1.random_0 = base.C.Game.Random;
		this.dictionary_0 = GClass896.list_0.ToDictionary(new Func<Vector2, Vector2>(CS$<>8__locals1.method_0), new Func<Vector2, DateTimeOffset>(GClass896.<>c.<>c_0.method_0));
		this.Behavior = new GClass912(gclass889_1, this);
	}
	...
	public override MapProfile UpdateProfile(BotProfile botProfile_1)
	{
		...
		return maps.FirstOrDefault(new Func<MapProfile, bool>(GClass896.<>c.<>c_0.method_1));
	}
	...
	public override void UpdateState()
	{
		...
		{
			this.method_1()[vector] = GClass896.smethod_0(this.method_1()[vector], now.AddSeconds(60.0));
		}
		base.UpdateState();
	}
	...
	{
		return this.method_1().OrderBy(new Func<KeyValuePair<Vector2, DateTimeOffset>, DateTimeOffset>(GClass896.<>c.<>c_0.method_2)).First<KeyValuePair<Vector2, DateTimeOffset>>().Key;
	}
	...
	private void method_3(Map map_0, Ship ship_1, bool bool_0)
	{
		...
		if (flag && bool_0)
		{
			GClass896.<>c__DisplayClass20_0 CS$<>8__locals1 = new GClass896.<>c__DisplayClass20_0();
	...
	{
		Class13.xnk8ImWzpOt04();
		GClass896.list_0 = new List<Vector2>
		{
	...
	[CompilerGenerated]
	private readonly GClass912 gclass912_0;
