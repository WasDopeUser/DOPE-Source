...
public class GClass927
{
	[DllImport("user32")]
	[return: MarshalAs(UnmanagedType.Bool)]
	private static extern bool EnumChildWindows(IntPtr intptr_1, GClass927.Delegate0 delegate0_0, IntPtr intptr_2);

	public GClass927(IntPtr intptr_1)
	{
	...
	public List<IntPtr> method_0()
	{
		...
		try
		{
			GClass927.Delegate0 delegate0_ = new GClass927.Delegate0(this.method_1);
			GClass927.EnumChildWindows(this.intptr_0, delegate0_, intptr_);
		}
		finally
		{
			value.Free();
