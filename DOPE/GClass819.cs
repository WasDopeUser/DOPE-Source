...
public class GClass819 : StatisticsCategory
{
	...
	public GClass819(Hero hero_1, GClass815 gclass815_1)
	{
	...
	private void method_0(List<IRowEntry> list_2)
	{
		...
		using (IEnumerator<KeyValuePair<string, double>> enumerator = this.Hero.Ammo.GetEnumerator())
		{
			...
			{
				GClass819.<>c__DisplayClass9_0 CS$<>8__locals1 = new GClass819.<>c__DisplayClass9_0();
		...
		foreach (IRowEntry item in list.OrderBy(new Func<IRowEntry, double>(GClass819.<>c.<>c_0.method_0)).ThenBy(new Func<IRowEntry, string>(GClass819.<>c.<>c_0.method_1)))
		{
			list_2.Add(item);
		}
	}
	...
	{
		List<IRowEntry> list = new List<IRowEntry>();
		foreach (string text in GClass819.list_0)
		{
		...
		{
			if (!GClass819.list_0.Contains(keyValuePair.Key.Replace("resource_", "")))
			{
		...
		foreach (IRowEntry item in list.OrderBy(new Func<IRowEntry, string>(GClass819.<>c.<>c_0.method_2)))
		{
			list_2.Add(item);
		}
	}
	...
	{
		List<IRowEntry> list = new List<IRowEntry>();
		list.Add(this.method_3("In game", new Func<Hero, string>(GClass819.<>c.<>c_0.method_3)));
		list.Add(this.method_3("Name", new Func<Hero, string>(GClass819.<>c.<>c_0.method_4)));
		list.Add(this.method_3("Clan", new Func<Hero, string>(GClass819.<>c.<>c_0.method_5)));
		list.Add(this.method_3("Credits", new Func<Hero, string>(GClass819.<>c.<>c_0.method_6)));
		list.Add(this.method_3("Uridium", new Func<Hero, string>(GClass819.<>c.<>c_0.method_7)));
		list.Add(this.method_3("Level", new Func<Hero, string>(GClass819.<>c.<>c_0.method_8)));
		list.Add(this.method_3("Experience", new Func<Hero, string>(GClass819.<>c.<>c_0.method_9)));
		list.Add(this.method_3("Honor", new Func<Hero, string>(GClass819.<>c.<>c_0.method_10)));
		list.Add(this.method_3("Booty keys", new Func<Hero, string>(GClass819.<>c.<>c_0.method_11)));
		list.Add(this.method_3("Map", new Func<Hero, string>(GClass819.<>c.<>c_0.method_12)));
		list.Add(this.method_4("TypeId", new Func<Hero, string>(GClass819.<>c.<>c_0.method_13)));
		list.Add(this.method_4("Cloaked", new Func<Hero, string>(GClass819.<>c.<>c_0.method_14)));
		list.Add(this.method_4("Speed", new Func<Hero, string>(GClass819.<>c.<>c_0.method_15)));
		list.Add(this.method_4("HP", new Func<Hero, string>(GClass819.<>c.<>c_0.method_16)));
		list.Add(this.method_4("Shield", new Func<Hero, string>(GClass819.<>c.<>c_0.method_17)));
		list.Add(this.method_4("Config", new Func<Hero, string>(GClass819.<>c.<>c_0.method_18)));
		list.Add(this.method_4("Formation", new Func<Hero, string>(GClass819.<>c.<>c_0.method_19)));
		list.Add(this.method_4("Cargo", new Func<Hero, string>(GClass819.<>c.<>c_0.method_20)));
	...
	{
		Class13.Gj4N3WdzaR1LY();
		GClass819.list_0 = new List<string>
		{
			"prometium",
			"endurium",
			"terbium",
		...
		GClass819.list_1 = new List<string>
		{
	...
	{
		GClass819.<>c__DisplayClass10_0 CS$<>8__locals1 = new GClass819.<>c__DisplayClass10_0();
