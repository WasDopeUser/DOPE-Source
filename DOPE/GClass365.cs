...
public class GClass365 : GClass364, GInterface0
{
	...
	public override void imethod_1(BinaryStream binaryStream_0)
	{
		...
		this.SafTncoEgW = binaryStream_0.smethod_0();
		this.SafTncoEgW = (this.SafTncoEgW << 9 | U.smethod_0(this.SafTncoEgW, 23));
	...
	protected override void vmethod_2(BinaryStream binaryStream_0)
	{
		...
		binaryStream_0.smethod_4(U.smethod_0(this.SafTncoEgW, 9) | this.SafTncoEgW << 23);
		binaryStream_0.smethod_9(this.double_0);
		binaryStream_0.smethod_4(this.int_4 << 5 | U.smethod_0(this.int_4, 27));
	}

	public int SafTncoEgW;
