...
{
	public GClass791(ByteArray byteArray_0, ByteArray byteArray_1)
	{
		...
		this.method_0(byteArray_0, byteArray_1);
	}

	private void method_0(ByteArray byteArray_0, ByteArray byteArray_1)
	{
		this.OirzGcbxxC = new ByteArray();
		for (int i = 0; i < 16; i++)
		{
			this.OirzGcbxxC[i] = 0;
		}
		int num = this.method_3(byteArray_0, 0);
		int num2 = this.method_3(byteArray_0, 4);
		int num3 = this.method_3(byteArray_0, 8);
		int num4 = this.method_3(byteArray_0, 12);
		...
		int num5 = this.method_3(byteArray_1, 0);
		int num6 = this.method_3(byteArray_1, 4);
	...
	private int method_3(ByteArray byteArray_0, int int_0)
	{
		return (int)(byteArray_0[int_0] & byte.MaxValue) | (int)(byteArray_0[int_0 + 1] & byte.MaxValue) << 8 | (int)(byteArray_0[int_0 + 2] & byte.MaxValue) << 16 | (int)byteArray_0[int_0 + 3] << 24;
	}

	private void method_4(ByteArray byteArray_0, int int_0, int int_1)
	{
		byteArray_0[int_0] = (byte)(int_1 & 255);
		byteArray_0[int_0 + 1] = (byte)(U.smethod_0(int_1, 8) & 255);
		byteArray_0[int_0 + 2] = (byte)(U.smethod_0(int_1, 16) & 255);
		byteArray_0[int_0 + 3] = (byte)(U.smethod_0(int_1, 24) & 255);
	}
	...
	private int YjmznRafHr()
	{
		uint num = this.uint_1 + 1U;
		this.uint_1 = num;
		if ((ulong)num >= (ulong)((long)this.OirzGcbxxC.Length))
		{
			this.method_6();
			this.uint_1 = 0U;
		}
		return (int)this.OirzGcbxxC[(int)this.uint_1];
	}

	private void method_6()
	{
		this.method_1();
		this.method_4(this.OirzGcbxxC, 0, this.vector_0[0U] ^ this.vector_0[5U] >> 16 ^ this.vector_0[3U] << 16);
		this.method_4(this.OirzGcbxxC, 4, this.vector_0[2U] ^ this.vector_0[7U] >> 16 ^ this.vector_0[5U] << 16);
		this.method_4(this.OirzGcbxxC, 8, this.vector_0[4U] ^ this.vector_0[1U] >> 16 ^ this.vector_0[7U] << 16);
		this.method_4(this.OirzGcbxxC, 12, this.vector_0[6U] ^ this.vector_0[3U] >> 16 ^ this.vector_0[1U] << 16);
	}
	...
	public virtual void vmethod_0(byte[] byte_0, int int_0, int int_1)
	{
		...
		{
			byte_0[i + int_0] = (byte)(((int)byte_0[i + int_0] ^ this.YjmznRafHr()) & 255);
		}
	}
