...
public class GClass888 : INotifyPropertyChanged
{
	...
	public GClass890 Context
	{
		...
		private set
		{
			...
			this.method_14(Class10.rrtQjyivMlh);
			this.method_14(Class10.propertyChangedEventArgs_5);
			this.method_14(Class10.propertyChangedEventArgs_56);
			this.method_14(Class10.propertyChangedEventArgs_35);
			this.method_14(Class10.propertyChangedEventArgs_55);
	...
	public string NextBot
	{
		...
		set
		{
			...
			this.string_0 = value;
			this.method_14(Class10.propertyChangedEventArgs_39);
		}
	}
	...
	protected GClass892 method_9(GClass904 gclass904_0)
	{
		...
		foreach (GClass892 gclass2 in this.list_0)
		{
			if (gclass904_0.vmethod_15(gclass2) && (gclass2.Priority > num || gclass == null))
			{
				num = gclass2.Priority;
				gclass = gclass2;
			}
