...
public class GClass863 : INotifyPropertyChanged
{
	...
	public GClass84<GClass788<GInterface7>> method_0()
	{
	...
	protected void method_3<WtZX74EEpL6YHaPj9vS>(ref WtZX74EEpL6YHaPj9vS gparam_0, WtZX74EEpL6YHaPj9vS WgfM00EOjqWJF13tHyk, string string_1 = null, [CallerMemberName] string name = null)
	{
		if (!EqualityComparer<WtZX74EEpL6YHaPj9vS>.Default.Equals(gparam_0, WgfM00EOjqWJF13tHyk))
		{
			gparam_0 = WgfM00EOjqWJF13tHyk;
	...
	public void method_4(TcpClient tcpClient_0)
	{
		...
		this.gclass84_0 = new GClass84<GClass788<GInterface7>>(null);
		this.gclass84_0.method_3("PROXY");
		this.method_10();
		this.method_11();
		this.bool_0 = false;
		this.gclass84_0.method_9(this.gclass91_0, new GClass788<GInterface7>());
	...
	public bool method_8()
	{
		...
		try
		{
			bool flag = GClass857.smethod_1(foregroundWindow, new Action<int>(this.method_20));
	...
	private void method_9(GClass91 gclass91_1, BinaryStream binaryStream_0, byte[] byte_0, int int_0)
	{
		...
		{
			this.method_2(GClass858.GetForegroundWindow());
		}
		...
		{
			GClass84<GClass788<GInterface7>> gclass = this.gclass84_0;
			if (gclass == null)
			{
				return;
			}
	...
	private void method_11()
	{
		...
		if (gameManager != null)
		{
			...
			if (connection != null)
			{
				...
				if (socket != null)
				{
					GClass84<GClass789> gclass = socket.method_5();
					if (gclass != null)
					{
	...
	private void method_13(GClass241 gclass241_0)
	{
		this.bool_2 = false;
		IPErkavaBotController iperkavaBotController;
		if (!PErkava.smethod_0().TryGetValue(gclass241_0.int_1, out iperkavaBotController))
		{
			return;
		}
	...
	private void method_17(GClass215 gclass215_0)
	{
		...
		BigInteger value = GClass791.smethod_0(gclass215_0.NboSgGytuJ.Memory.ToArray());
		BigInteger exponent = GClass791.smethod_0(array);
		BigInteger value2 = GClass791.smethod_2("8abb0fba15a87dcf63686b96a362824eb85283942aa5b42e971543063a03e6f389bf3abcf4b4eb85430a699e0f3969e60dec9819bc81cc3ac905fbc8a90eb46b");
		...
		GClass791 gclass = new GClass791(GClass791.smethod_2("ef09b1bcec67808eeff374b1b51fb155edaac4fcc7a78ed75d5848d6e9eaabee41dec018bb5482d01acea8ce13688bfe33076dde70f06febb80cf3b7327953fb32c08889b815587ded2cdd056d0ec9965b894751848766c27fdee32c707b6fc9"), new BigInteger(65537), GClass791.smethod_2("0b7f1bdd4a41701d6fccf5bfd6463ff1320d148c53cdeb40d06c7e94578bc1d923b1e2eb4d9732f36f56a127c8272f1462f185708af8e56df795bc30c70a7ad52d12b950f35ae6f4103c738fccf485c31be178696560d39f1d9d71baeaed3941"));
	...
	{
		GClass280 gclass = new GClass280(0, 148, 1, false);
	...
	private void method_23(GClass147 gclass147_0)
	{
		...
		if (gclass147_0.string_0.StartsWith("!dope"))
		{
			...
			this.method_0().SendMessage(new GClass657());
			return;
		}
	...
	{
		this.Game.Hero.method_5(gclass161_0.int_1, gclass161_0.int_3, gclass161_0.int_0, gclass161_0.int_2, this.Game.Hero.Speed);
	}
	...
	private GClass84<GClass788<GInterface7>> gclass84_0;
