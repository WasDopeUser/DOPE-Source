...
public class GClass846 : GClass837
{
	public GClass846(GClass824 gclass824_1)
	{
	...
	public virtual bool vmethod_50(NpcShip npcShip_0)
	{
	...
	protected virtual bool vmethod_52(Ship ship_0, Ship ship_1)
	{
		int num = this.vmethod_51();
		bool flag = ship_1 != null && this.vmethod_12(ship_0 as NpcShip) && !this.vmethod_12(ship_1 as NpcShip);
		double num2 = (this.method_27() || flag) ? 0.0 : Math.Abs(GClass807.smethod_4(ship_0.Position - base.Context.HeroPosition, ship_1.Position - base.Context.HeroPosition));
	...
	public override bool vmethod_1(Ship ship_0, out Ship ship_1)
	{
		...
		if (ship_0 != null)
		{
			...
			if (npcShip != null && cooldowns.method_0(BotAction.SelectShip) && cooldowns.method_0(BotAction.TargetQuickSwitch) && npcShip != ship_0 && this.vmethod_52(ship_0, npcShip))
			{
		...
		if (base.C.AttackingId == ship_0.Id && this.vmethod_50(ship_0 as NpcShip) && ship_0.HpPercentage < 24.75f && base.C.float_0 >= 24.75f && base.C.method_73().Any(new Func<NpcShip, bool>(this.method_37)))
		{
	...
	{
		return base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(this.method_38)) && !this.vmethod_4(true, false);
	}

	public override bool vmethod_13(Collectible collectible_0)
	{
		return base.vmethod_13(collectible_0) && !this.method_22();
	}

	public override bool vmethod_15()
	{
		return !base.C.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass846.<>c.<>c_0.method_0)) && base.C.Map.Gates.Any<KeyValuePair<int, Gate>>() && !base.C.method_75() && base.C.DormantTargets.Count == 0 && base.C.Game.Web.GgInfo != null;
	}

	public override bool vmethod_24(out Vector2? nullable_0)
	{
		if (!base.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(GClass846.<>c.<>c_0.method_1)) && !base.Map.Collectibles.Any<KeyValuePair<string, Collectible>>() && !base.Map.Gates.Any<KeyValuePair<int, Gate>>())
		{
			nullable_0 = null;
			return true;
		}
	...
	public override bool vmethod_4(bool bool_8 = false, bool bool_9 = false)
	{
		...
		if (base.Context.Map.method_2(heroPosition, 100) && !base.Map.Collectibles.Any(new Func<KeyValuePair<string, Collectible>, bool>(this.method_39)))
		{
			return false;
		}
		Ship ship = base.C.Map.method_5<Ship>(heroPosition, new Func<Ship, bool>(GClass846.<>c.<>c_0.method_2), null, 0);
	...
	public override bool vmethod_19(GClass826 gclass826_0)
	{
		...
		{
			GClass833 gclass = gclass826_0 as GClass833;
			return gclass != null && gclass.GalaxyGateType == MapUtils.smethod_8(base.C.Map.MapId);
		}
		return true;
	}
	...
	{
		GClass846.<>c__DisplayClass16_0 CS$<>8__locals1 = new GClass846.<>c__DisplayClass16_0();
		Map map = base.C.Map;
		CS$<>8__locals1.OaYoVeargjl = MapUtils.smethod_11(MapUtils.smethod_8(map.MapId));
	...
	{
		GClass846.<>c__DisplayClass17_0 CS$<>8__locals1 = new GClass846.<>c__DisplayClass17_0();
		CS$<>8__locals1.gclass846_0 = this;
		Vector2? vector = null;
		CS$<>8__locals1.vector2_0 = base.C.HeroPosition;
		if (base.C.Map.method_5<Ship>(CS$<>8__locals1.vector2_0, new Func<Ship, bool>(GClass846.<>c.<>c_0.method_3), null, 0) == null)
		{
			vector = new Vector2?(base.C.Map.Center);
		}
		else if (this.method_27())
		{
			vector = this.vmethod_39(CS$<>8__locals1.vector2_0, base.C.Map.Center, (float)base.C.Map.MapSize.Height * 0.4f, null, this.method_29() ? -0.5f : 0.5f);
		}
		else
		{
	...
	public override int vmethod_9(NpcShip npcShip_0)
	{
		...
		if (base.method_9() == KamikazeState.PullingEnemies)
		{
			return Math.Min(0, num);
		}
		NpcUtils.NpcClass @class = npcShip_0.Type.Class;
		int num2;
		if (@class != null && GClass846.dictionary_0.TryGetValue(@class, out num2))
		{
			num = num2;
		}
		if (this.vmethod_53(npcShip_0))
		{
			num++;
		}
		return num;
	...
	public virtual bool vmethod_53(NpcShip npcShip_0)
	{
	...
	{
		int range;
		if (npcShip_0.Type.Class != null && GClass846.dictionary_1.TryGetValue(npcShip_0.Type.Class, out range))
		{
	...
	{
		GClass833 gclass = base.C.Module as GClass833;
		if (gclass == null)
		{
			return null;
		}
		return gclass.vmethod_1(ship_0);
	}

	private bool method_23(NpcShip npcShip_0, Vector2 vector2_1)
	{
	...
	{
		GClass846.<>c__DisplayClass29_0 CS$<>8__locals1 = new GClass846.<>c__DisplayClass29_0();
		CS$<>8__locals1.gclass846_0 = this;
		...
		return flag & (this.method_33() || base.Map.All<NpcShip>(CS$<>8__locals1.vector2_0, new Func<NpcShip, bool>(CS$<>8__locals1.wEhoVmsMeIr), null, 0).Any<NpcShip>());
	}

	[CompilerGenerated]
	protected DateTimeOffset method_24()
	{
		return this.dateTimeOffset_0;
	}

	[CompilerGenerated]
	protected void method_25(DateTimeOffset dateTimeOffset_2)
	{
		this.dateTimeOffset_0 = dateTimeOffset_2;
	}

	protected virtual bool vmethod_54()
	{
		GClass846.<>c__DisplayClass34_0 CS$<>8__locals1 = new GClass846.<>c__DisplayClass34_0();
		CS$<>8__locals1.gclass846_0 = this;
		...
		CS$<>8__locals1.vector2_0 = base.Hero.Position;
		Func<NpcShip, bool> selector = this.method_35() ? new Func<NpcShip, bool>(CS$<>8__locals1.method_1) : new Func<NpcShip, bool>(CS$<>8__locals1.method_0);
	...
	protected override KamikazeState vmethod_29()
	{
		...
		{
			if (base.method_9() != KamikazeState.PullingEnemies && this.method_24().Cooldown(25000))
			{
				this.method_25(DateTimeOffset.Now);
			}
			int int_ = this.method_35() ? 45000 : 10000;
			if (this.method_33() && this.method_24().smethod_0(int_))
			{
	...
	public override Vector2? vmethod_46(Vector2 vector2_1, NpcShip npcShip_0, Vector2? nullable_0 = null, float float_0 = 0.5f)
	{
		...
		if (vector != null && this.method_31().Cooldown(10000))
		{
			Vector2 value = vector.Value;
			bool flag = this.method_29();
			this.method_30(GClass807.smethod_2(vector2_1.Y - center.Y, vector2_1.X - center.X, value.Y - center.Y, value.X - center.X));
			if (flag != this.method_29())
			{
				this.method_32(DateTimeOffset.Now);
			}
		}
		float_0 = 0f;
		...
		PointF pointF;
		PointF pointF2;
		int num3 = GClass812.smethod_0(center.X, center.Y, num2, vector2.X, vector2.Y, (float)num, out pointF, out pointF2);
		double num4;
		if (num3 == 2)
		{
			num4 = GClass807.smethod_3(pointF.Y - center.Y, pointF.X - center.X, pointF2.Y - center.Y, pointF2.X - center.X, false);
		}
		else
		{
			num4 = Math.Atan2((double)(vector2.X - center.X), (double)(vector2.Y - center.Y)) + (double)(this.method_29() ? -0.5f : 0.5f);
		}
		Vector2 value2 = GClass807.smethod_8(center, num2, (float)num4);
		if (num3 != 0)
		{
			this.method_28(true);
	...
	[CompilerGenerated]
	public bool cqKoUqMvato()
	{
		return this.bool_3;
	}

	[CompilerGenerated]
	protected void method_26(bool bool_8)
	{
		this.bool_3 = bool_8;
	}
	...
	[CompilerGenerated]
	public DateTimeOffset method_31()
	{
		return this.dateTimeOffset_1;
	}

	[CompilerGenerated]
	protected void method_32(DateTimeOffset dateTimeOffset_2)
	{
	...
	[CompilerGenerated]
	protected void method_34(bool bool_8)
	{
		this.bool_6 = bool_8;
	}
	...
	{
		this.method_34(this.vmethod_54());
		base.Update();
		this.method_26(this.vmethod_55());
		this.method_28(this.method_27() & this.cqKoUqMvato());
		if (!base.Map.Gates.Any<KeyValuePair<int, Gate>>() && base.C.State == BotState.Roam && base.C.StateIters > 6000)
		{
			...
			base.C.method_66(BotState.Default);
	...
	{
		Class13.igxcIukzfpare();
		GClass846.dictionary_0 = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
		...
		GClass846.dictionary_1 = new Dictionary<NpcUtils.NpcClass, int>
		{
			{
	...
	[CompilerGenerated]
	private bool method_37(NpcShip npcShip_0)
	{
		bool flag;
	...
	[CompilerGenerated]
	private bool method_38(KeyValuePair<int, Ship> keyValuePair_0)
	{
		bool flag;
	...
	[CompilerGenerated]
	private bool method_39(KeyValuePair<string, Collectible> keyValuePair_0)
	{
