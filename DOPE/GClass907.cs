...
public class GClass907 : GClass905
{
	...
	public override bool vmethod_9(NpcShip npcShip_1)
	{
		...
		SelectedNpcModel selectedNpcModel = this.vmethod_4(npcShip_1);
	...
	public override Vector2? vmethod_20(bool bool_3)
	{
		...
		return this.iOgCgYpyBdo(position, this.method_24().Position, 1275f, null, 0.4f);
	}
	...
	public override Vector2? vmethod_19(Vector2 vector2_2, out Gate gate_0, bool bool_3 = false, bool bool_4 = true)
	{
	...
	{
		return base.vmethod_14() && (!base.C.method_77() || base.Hero.HpPercentage < 40f);
	}
	...
	{
		return (this.method_24() == null || Vector2.Distance(this.method_26(), collectible_0.Position) < 2250f) && base.vmethod_12(collectible_0);
	}

	public override bool vmethod_11(NpcShip npcShip_1)
	{
		return false;
	}
	...
	public override bool vmethod_13(Ship ship_0, Collectible collectible_0)
	{
		return this.vmethod_12(collectible_0);
	}

	protected override float vmethod_34(Vector2 vector2_2)
	{
		float num = base.vmethod_34(vector2_2);
	...
	public override int vmethod_45()
	{
		MapProfile mapProfile = base.C.MapProfile;
	...
	public override bool UntCgkpMdca(Ship ship_0, out Ship ship_1)
	{
		...
		{
			return base.UntCgkpMdca(CS$<>8__locals1.ship_0, out ship_1);
		}
		this.method_31(1.0, ref CS$<>8__locals1);
		return true;
	}

	public override Gate vmethod_24(int int_1)
	{
