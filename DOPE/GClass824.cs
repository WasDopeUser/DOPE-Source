...
public class GClass824 : INotifyPropertyChanged, ILogManager, IPErkavaBotController
{
	public Collectible CollectibleTarget
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_9);
		}
	}
	...
	public void Cloak()
	{
		...
		{
			this.BackgroundQueue.Enqueue(new Func<DarkOrbitWebAPI, object>(GClass824.<>c.<>c_0.method_0));
		}
	}
	...
	{
		GClass824.<>c__DisplayClass13_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass13_0();
		...
		if (this.Cooldowns.method_0(BotAction.Move))
		{
			...
			Vector2 vector2_3 = this.Game.Security.method_8(this.HeroPosition, (int)CS$<>8__locals1.vector2_0.X, (int)CS$<>8__locals1.vector2_0.Y, int_13, int_14, int_15, int_16, int_18);
	...
	public void method_7(Ship ship_1)
	{
		...
		while (laserType > LaserType.LCB_10 && this.Hero.NtagPxqlwQ(Ammo.smethod_1(laserType)) < 100.0)
		{
			laserType--;
		}
		while (rocketType > RocketType.PLT_2026 && this.Hero.NtagPxqlwQ(Ammo.smethod_2(rocketType)) < 10.0)
		{
			rocketType--;
		}
		while (hellstormType > HellstormType.ECO_10 && this.Hero.NtagPxqlwQ(Ammo.smethod_3(hellstormType)) < 10.0)
		{
			hellstormType--;
		}
	...
	public bool IsAttacking
	{
		...
		set
		{
			...
			this.bool_0 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_24);
		}
	}
	...
	public bool IsCollecting
	{
		...
		set
		{
			...
			this.bool_1 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_25);
		}
	}
	...
	public int AttackingId
	{
		...
		set
		{
			...
			this.int_0 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_0);
		}
	}
	...
	public void method_9()
	{
		...
		if (this.SelectedAmmo == "ammunition_laser_lcb-10" && this.Hero.NtagPxqlwQ(this.SelectedAmmo) < 1900.0)
		{
			this.Log.Debug("Buying {ammoType}", this.SelectedAmmo);
			this.Server.method_14("buy_" + this.SelectedAmmo, true, false);
		}
		if ((this.SelectedRockets == "ammunition_rocket_r-310" || this.SelectedRockets == "ammunition_rocket_plt-2026") && this.Hero.NtagPxqlwQ(this.SelectedRockets) < 90.0)
		{
			this.Log.Debug("Buying {ammoType}", this.SelectedAmmo);
			this.Server.method_14("buy_" + this.SelectedRockets, true, false);
		}
		if (this.SelectedHS == "ammunition_rocketlauncher_eco-10" && this.Hero.NtagPxqlwQ(this.SelectedHS) < 90.0)
		{
			this.Log.Debug("Buying {ammoType}", this.SelectedHS);
			bool flag;
			this.method_10<bool>("BuyAmmoHs", new Func<DarkOrbitWebAPI, bool>(this.method_82), out flag);
		}
	}

	public bool method_10<OsCXCSndY7tqh7ulU9u>(string string_3, Func<DarkOrbitWebAPI, OsCXCSndY7tqh7ulU9u> func_0, out OsCXCSndY7tqh7ulU9u gparam_0)
	{
		GClass824.<>c__DisplayClass33_0<OsCXCSndY7tqh7ulU9u> CS$<>8__locals1 = new GClass824.<>c__DisplayClass33_0<OsCXCSndY7tqh7ulU9u>();
		CS$<>8__locals1.f = func_0;
		CS$<>8__locals1.<>4__this = this;
		CS$<>8__locals1.key = string_3;
		gparam_0 = default(OsCXCSndY7tqh7ulU9u);
		object obj;
		...
		if (obj is OsCXCSndY7tqh7ulU9u)
		{
			OsCXCSndY7tqh7ulU9u osCXCSndY7tqh7ulU9u = (OsCXCSndY7tqh7ulU9u)((object)obj);
			object obj2;
			this.concurrentDictionary_0.TryRemove(CS$<>8__locals1.key, out obj2);
			gparam_0 = osCXCSndY7tqh7ulU9u;
			return true;
		}
		return false;
	}
	...
	public void method_12(bool bool_13, bool bool_14 = false)
	{
		...
		if (!bool_14)
		{
			GClass833 gclass = this.Module as GClass833;
			if (gclass != null)
			{
				int num4 = this.Map.Ships.Count(new Func<KeyValuePair<int, Ship>, bool>(GClass824.<>c.<>c_0.method_1));
				if (gclass.eypBpbBoFoK() && num4 == 0)
				{
					genum3 = GEnum4.Veteran;
				}
				else if (this.MapProfile.UseMothToKillCorners && this.Hero.method_16(GEnum4.Moth.smethod_0()) && this.method_83())
				{
					genum3 = GEnum4.Moth;
				}
			}
	...
	public bool method_13(bool bool_13, bool bool_14 = false)
	{
		...
		{
			vector = this.Behavior.vmethod_20(this.Map.Hero.Position, out gate_, bool_14, true);
		}
	...
	public void AutoRefine()
	{
		...
		foreach (ResourceType resourceType in GClass824.resourceType_0)
		{
	...
	private bool method_17(List<string> list_5)
	{
	...
	private string method_18(List<string> list_5)
	{
	...
	{
		return this.method_17(GClass824.list_0);
	}

	public bool method_20()
	{
		return this.method_17(GClass824.list_2);
	}

	public bool method_21()
	{
		return this.method_17(new List<string>
		{
	...
	{
		if (this.method_18(GClass824.list_0) == "ability_solace")
		{
			using (IEnumerator<GroupManager.GroupMember> enumerator = this.Hero.Group.method_10().GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					if (shipInfo != null)
					{
						float num = (float)shipInfo.int_3 / ((float)shipInfo.int_1 + 1f) * 100f;
	...
	{
		Ship ship = this.Map.method_5<Ship>(this.HeroPosition, new Func<Ship, bool>(this.method_84), null, 0);
		...
		if (this.IsAttacking && selectedShip != null && this.AttackingId == selectedShip.Id)
		{
			...
			{
				string text2 = this.method_18(GClass824.list_1);
	...
	public ErrorReason LastDisconnectReason
	{
		...
		set
		{
			...
			this.method_24();
			this.iIpojHigvGL(Class10.LastDisconnectReason);
		}
	}
	...
	public MapProfile MapProfile
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_35);
		}
	}
	...
	public AccountSettings Account
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_21);
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_33);
			this.iIpojHigvGL(Class10.Account);
		}
	}

	public GClass822 Scheduler
	{
		[CompilerGenerated]
		get
		{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.Scheduler);
		}
	}
	...
	public int RealDist
	{
		...
		set
		{
			...
			this.int_1 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_40);
		}
	}
	...
	public DateTime LastLogin
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_30);
		}
	}
	...
	public DateTime LastMapLogin
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_31);
		}
	}
	...
	public bool IsEnabled
	{
		...
		set
		{
			...
			this.bool_2 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_26);
		}
	}
	...
	public bool Run
	{
		...
		set
		{
			...
			this.bool_3 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_43);
		}
	}
	...
	public bool IsStopping
	{
		...
		set
		{
			...
			this.bool_4 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_27);
		}
	}
	...
	public Thread BotThread
	{
		...
		set
		{
			...
			this.thread_0 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_6);
		}
	}
	...
	public void method_25(string string_3)
	{
	...
	public ConcurrentQueue<Func<DarkOrbitWebAPI, object>> BackgroundQueue
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_1);
		}
	}
	...
	public Task LastBackgroundAction
	{
		...
		internal set
		{
			...
			this.task_0 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_28);
		}
	}
	...
	public Task LastBackgroundHandlerAction
	{
		...
		internal set
		{
			...
			this.task_1 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_29);
		}
	}
	...
	private bool ynhoZkQnaqN(PetState petState_0)
	{
	...
	public UsageCounter<int> EnemyLocated
	{
		...
		protected set
		{
			...
			this.iIpojHigvGL(Class10.ThyoxToKkYS);
		}
	}
	...
	public void method_28()
	{
		...
		if (petMode <= PetMode.Off)
		{
			if (this.Hero.Pet.IsEnabled)
			{
				...
				this.ynhoZkQnaqN(PetState.Deactivate);
			}
			return;
		}
		if (this.Hero.Pet.IsEnabled)
		{
			...
			{
				bool flag;
				this.method_10<bool>("BuyPetFuel", new Func<DarkOrbitWebAPI, bool>(GClass824.<>c.<>c_0.method_2), out flag);
			}
			bool flag2;
		...
		this.ynhoZkQnaqN(PetState.Activate);
	...
	public bool method_29()
	{
		...
		{
			if (GClass824.botState_2.HasFlag(this.State))
			{
				this.method_66(BotState.Flee);
			}
		}
		else if (this.Game.Hero.HpPercentage < (float)this.MapProfile.MinHp && this.Behavior.vmethod_27() && GClass824.botState_2.HasFlag(this.State))
		{
	...
	public Ship EnemyTarget
	{
		...
		set
		{
			...
			this.ship_0 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_18);
		}
	}
	...
	public void method_31()
	{
		...
		if (this.Behavior.vmethod_26() && ((this.Game.Hero.HpPercentage < 98f && this.Hero.method_16("equipment_extra_repbot_rep")) || (!this.ignoreShields && this.Game.Hero.ShieldPercentage < 90f)) && this.dateTimeOffset_3.Cooldown(10000))
		{
			this.method_66(BotState.Repair);
			return;
		}
		...
		if (num2 > 400)
		{
			this.method_64((GClass826.GEnum10)2);
			return;
		}
	}
	...
	public DateTime? Timeout
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_52);
		}
	}
	...
	public void method_33()
	{
		...
		if (!this.Behavior.vmethod_4(true, false))
		{
			...
			if (this.Map.IsGG || !this.method_13(false, false))
			{
				...
				if (this.nullable_1 != null && this.method_4(this.nullable_1.Value, 50, 300, false, 640, 360, 0, 0, 0, false, 0, new Action(this.method_85)))
				{
					this.nullable_1 = null;
				}
			}
	...
	public Vector2 RoamTarget
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_42);
		}
	}
	...
	public void method_35()
	{
		...
		this.method_4(this.RoamTarget, 5, 200, false, 640, 360, 10, 10, 30, false, 0, new Action(this.method_86));
	}
	...
	public Vector2? TravelTarget
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_55);
		}
	}
	...
	public PathSequence CurrentPath
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_14);
		}
	}

	public bool method_36(Vector2 vector2_2, Gate gate_1 = null, int int_11 = 15, bool bool_13 = false)
	{
		GClass824.<>c__DisplayClass173_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass173_0();
		CS$<>8__locals1.gclass824_0 = this;
		CS$<>8__locals1.vector2_0 = vector2_2;
		if (gate_1 != null)
		{
		...
		bool flag = Map.Navigators.method_4(new Action<MapNavigator>(CS$<>8__locals1.JcTomcsuxig), 30);
		...
		if (!this.MapProfile.FleeStopOnEnemyLost || !this.bool_9 || !this.Behavior.vmethod_4(false, false))
		{
			if (this.TravelTarget != null)
			{
				...
				if (Vector2.Distance(value, this.HeroPosition) > (float)this.int_6)
				{
					...
					{
						if (this.method_4(value, this.int_6, 300, false, 640, 360, 0, 0, 0, false, 0, new Action(this.method_87)))
						{
			...
			if (this.gate_0 != null)
			{
				...
				if (gate.Activatable)
				{
					if (!this.bool_9 || !this.Behavior.vmethod_4(true, false) || this.Map.Ships.Any(new Func<KeyValuePair<int, Ship>, bool>(this.method_89)))
					{
	...
	public UsageCounter<string> BoxTracker
	{
		...
		private set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_7);
		}
	}
	...
	public void method_38()
	{
		...
		this.method_75();
		if (this.CollectibleTarget != null && this.Game.Security.method_6(this.CollectibleTarget, false))
		{
	...
	{
		GClass824.<>c__DisplayClass185_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass185_0();
		CS$<>8__locals1.gclass824_0 = this;
	...
	{
		Rectangle rectangle = GClass843.list_0.First<Rectangle>();
		...
		Asset value = this.Map.Assets.FirstOrDefault(new Func<KeyValuePair<int, Asset>, bool>(GClass824.<>c.<>c_0.method_3)).Value;
		if (value == null)
		{
			this.method_66(BotState.Default);
			return;
		...
		{
			foreach (ResourceType resourceType in GClass824.list_3)
			{
	...
	public Vector2 HeroPosition
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_22);
		}
	}

	public GClass855 MainController
	{
		get
		{
	...
	public GClass854 Controller
	{
		...
		internal set
		{
			...
			this.iIpojHigvGL(Class10.hrGoxrgiOdy);
			this.iIpojHigvGL(Class10.Controller);
		}
	}
	...
	public Task LoginTask
	{
		...
		internal set
		{
			...
			this.task_2 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_34);
		}
	}
		...
		for (;;)
		{
			...
			while (this.Game.Connection.Socket.method_2() && !this.IsPaused && this.Run && this.Hero.IsInitialized)
			{
				...
				lock (obj)
				{
					...
					GClass826 gclass = this.Scheduler.method_12();
	...
	private void method_45(object object_1, GClass195 gclass195_0)
	{
		...
		{
			GClass824.<>c__DisplayClass204_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass204_0();
			CS$<>8__locals1.string_0 = gclass195_0.FromId.ToString();
			if (this.MainController.Bots.Any(new Func<GClass854, bool>(CS$<>8__locals1.method_0)))
			{
	...
	private void method_47(GameManager gameManager_1, GClass269 gclass269_0)
	{
		...
		if (array.Length != 3 || !(array[1] == "range") || !int.TryParse(array[2], out num))
		{
			if (array.Length == 2 && array[1] == "distance")
			{
				...
				if (selectedShip != null)
				{
					this.method_90(string.Format("Distance to {0}: {1}", selectedShip.Name, Vector2.Distance(this.Map.Hero.Position, selectedShip.Position)));
					return;
				}
			}
			else
			{
				...
				if (array.Length == 4 && array[1] == "trade" && int.TryParse(array[2], out num2) && double.TryParse(array[3], out num3))
				{
					...
					this.method_90(string.Format("Attempting to sell {0} of {1}", num3, num2));
					this.Server.method_21(resourceType, num3);
					return;
				}
				if (array.Length == 2 && array[1] == "help")
				{
					this.method_90("!dope range/<npc radius>");
					this.method_90("!dope distance");
					this.method_90("!dope trade/<ore>/<amount>");
					return;
				}
				if (array.Length == 2 && array[1] == "portals")
				{
					this.method_90("PORTALS OPEN");
				...
				{
					this.method_90(this.Game.Hero.Position.ToString());
					return;
				}
				int num4;
				...
				else
				{
					...
					if (array.Length == 3 && array[1] == "distance" && array[2] == "gate")
					{
						...
						this.method_90(string.Format("Gate #{0} dist={1:0.00} active={2}", gate.Id, num5, gate.Activatable));
					}
				}
			}
			return;
		...
		if (npcClass2 == null)
		{
			this.method_90("No npc");
			return;
		}
		SecurityManager.NpcRangesRegular[npcClass2] = num;
		this.method_90(string.Format("Set range for {0} to {1}", npcClass2.ToString(), num));
	}

	private void method_48(Map map_0, Ship ship_1, GClass267 gclass267_0)
	{
		GClass824.<>c__DisplayClass207_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass207_0();
		CS$<>8__locals1.gclass824_0 = this;
		...
		CS$<>8__locals1.collectible_0 = this.Map.method_5<Collectible>(CS$<>8__locals1.nullable_0.Value, new Func<Collectible, bool>(CS$<>8__locals1.KkwomrkFikD), null, 0);
	...
	{
		GClass824.<>c__DisplayClass209_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass209_0();
		CS$<>8__locals1.gclass824_0 = this;
		CS$<>8__locals1.ship_0 = ship_1;
	...
	private void method_55(Map map_0, string string_3, Collectible collectible_1, bool bool_13)
	{
		object obj = this.object_0;
		lock (obj)
		{
	...
	{
		DateTime now = DateTime.Now;
		if (!this.wdvoKamvDiv.Cooldown(60000))
		{
			this.int_8++;
		}
		else
		...
		if (this.int_8 > 4)
		{
			...
			this.wdvoKamvDiv = this.dateTime_2;
		}
	...
	{
		GClass824.<>c__DisplayClass224_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass224_0();
		CS$<>8__locals1.gameManager_0 = gameManager_1;
		CS$<>8__locals1.gclass824_0 = this;
		CS$<>8__locals1.bool_0 = bool_13;
		CS$<>8__locals1.gclass217_0 = gclass217_0;
		this.Log.Info<bool, string>("Hero died wasAlive={alive} killer={killer}", CS$<>8__locals1.bool_0, CS$<>8__locals1.gclass217_0.string_2);
		this.method_61<GClass849>().imethod_1();
		this.Timeout = null;
		if (this.IsPaused)
		{
			return;
		...
		{
			if (CS$<>8__locals1.gclass217_0.vector_0.Any(new Func<GClass560, bool>(GClass824.<>c.<>c_0.method_4)))
			{
		...
		MapProfile mapProfile2 = this.MapProfile;
		if (CS$<>8__locals1.bool_0 && mapProfile2 != null && mapProfile2.ReviveAtPortal && (this.Behavior is GClass840 || this.Behavior is GClass844))
		{
	...
	public GameManager Game
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.Hero);
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_23);
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_48);
			this.iIpojHigvGL(Class10.Map);
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_17);
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_49);
			this.iIpojHigvGL(Class10.Game);
		}
	}
	...
	public GClass816 Stats
	{
		...
		private set
		{
			if (object.Equals(this.gclass816_0, value))
			{
				return;
			}
			this.gclass816_0 = value;
			this.iIpojHigvGL(Class10.Stats);
		}
	}
	...
	public BotState State
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.State);
		}
	}
	...
	public BotState ReturnState
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_41);
		}
	}
	...
	public MaxStack<BotState> LastStates
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_32);
		}
	}
	...
	public CooldownTracker<BotAction> Cooldowns
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_13);
		}
	}
	...
	public bool ShouldBeDisabled
	{
		...
		set
		{
			...
			this.bool_10 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_50);
		}
	}
	...
	public bool ForceLogout
	{
		...
		set
		{
			...
			this.bool_11 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_20);
		}
	}
	...
	public bool IsPaused
	{
		...
		set
		{
			...
			this.bool_12 = value;
			this.iIpojHigvGL(Class10.IsPaused);
		}
	}
	...
	public GClass826 Module
	{
		...
		private set
		{
			...
			this.iIpojHigvGL(Class10.Module);
		}
	}

	public GClass837 Behavior
	{
		[CompilerGenerated]
		get
		{
			return this.iVeomhmqwqC;
		}
		[CompilerGenerated]
		private set
		{
			if (object.Equals(this.iVeomhmqwqC, value))
			{
				return;
			}
			this.iVeomhmqwqC = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_2);
		}
	}

	public GClass824(IDopeServiceProxy idopeServiceProxy_0, AccountSettings accountSettings_1)
	{
		...
		this.Stats = new GClass816(this);
		this.Scheduler = new GClass822(this);
		...
		this.gclass837_0 = new GClass838(this);
		this.gclass846_0 = new GClass846(this);
		this.smhomKoDhPA = new GClass844(this);
		this.gclass841_0 = new GClass841(this);
		this.gclass839_0 = new GClass839(this);
		this.Behavior = this.gclass837_0;
		this.method_63();
	}

	public CWk5TmnaS3CaiCWd2kE method_61<CWk5TmnaS3CaiCWd2kE>() where CWk5TmnaS3CaiCWd2kE : GClass848
	{
		return this.method_60().First(new Func<GInterface9, bool>(GClass824.<>c__295<CWk5TmnaS3CaiCWd2kE>.<>9.method_0)) as CWk5TmnaS3CaiCWd2kE;
	}
	...
	public void method_64(GClass826.GEnum10 genum10_0)
	{
		GClass826 module = this.Module;
		if (module == null)
		{
			return;
		}
	...
	public int StateIters
	{
		...
		set
		{
			...
			this.int_9 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_51);
		}
	}
	...
	public IEnumerable<string> fcDoZzaqUxq()
	{
		GClass824.<GetStatusText>d__312 <GetStatusText>d__ = new GClass824.<GetStatusText>d__312(-2);
	...
	public Logger method_69(string string_3)
	{
		string str = "Core-";
		string str2 = "-";
		AccountSettings account = this.Account;
	...
	public CooldownTracker<int> NpcLockout
	{
		...
		set
		{
			...
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_37);
		}
	}
	...
	public string SelectedAmmo
	{
		...
		get
		{
			return this.TpYomVpjrqu;
		}
		[CompilerGenerated]
		set
		{
			if (string.Equals(this.TpYomVpjrqu, value, StringComparison.Ordinal))
			{
				return;
			}
			this.TpYomVpjrqu = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_44);
		}
	}
	...
	public string SelectedRockets
	{
		...
		set
		{
			...
			this.string_1 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_46);
		}
	}
	...
	public string SelectedHS
	{
		...
		set
		{
			...
			this.string_2 = value;
			this.iIpojHigvGL(Class10.propertyChangedEventArgs_45);
		}
	}

	public GEnum6 method_70()
	{
	...
	public NpcShip method_71(int int_11 = 0)
	{
	...
	{
		return this.Map.method_7<NpcShip>(this.HeroPosition, new Func<NpcShip, bool>(this.Behavior.vmethod_10), new Func<NpcShip, int>(this.Behavior.vmethod_9), 0).Any(new Func<ValueTuple<NpcShip, float, int>, bool>(GClass824.<>c.<>c_0.method_5));
	}

	public IEnumerable<NpcShip> method_73()
	{
	...
	public bool method_74()
	{
		...
		this.EnemyTarget = this.method_71(0);
		return this.EnemyTarget != null;
	}

	public bool method_75()
	{
		GClass824.<>c__DisplayClass337_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass337_0();
		CS$<>8__locals1.gclass824_0 = this;
		if (!this.MapProfile.Collector)
		{
			return false;
		}
		CS$<>8__locals1.genum6_0 = this.method_70();
	...
	{
		GClass824.<>c__DisplayClass344_0 CS$<>8__locals1 = new GClass824.<>c__DisplayClass344_0();
		CS$<>8__locals1.vector2_0 = vector2_2;
		...
		Collectible collectible2 = this.DormantTargets.Select(new Func<KeyValuePair<string, Collectible>, Collectible>(GClass824.<>c.<>c_0.method_6)).OrderBy(new Func<Collectible, float>(CS$<>8__locals1.method_0)).FirstOrDefault<Collectible>();
	...
	public void method_80(NpcShip npcShip_0)
	{
	...
	static GClass824()
	{
		...
		GClass824.list_2 = new List<string>
		{
			"ability_lightning",
			"ability_sentinel",
			"ability_spectrum",
		...
		GClass824.list_3 = new List<ResourceType>
		{
		...
		GClass824.botState_2 = (BotState.Roam | BotState.Collect | BotState.Hunt | BotState.Dodge);
	}

	[CompilerGenerated]
	private bool method_82(DarkOrbitWebAPI darkOrbitWebAPI_0)
	{
	...
	[CompilerGenerated]
	private bool method_84(Ship ship_1)
	{
	...
	private void method_88()
	{
		...
		if (num > 500)
		{
			this.method_64((GClass826.GEnum10)1);
		}
	}

	[CompilerGenerated]
	private bool method_89(KeyValuePair<int, Ship> keyValuePair_0)
	{
		return this.method_79(keyValuePair_0.Value);
	}

	[CompilerGenerated]
	private void method_90(string string_3)
	{
		GInterface5 proxySocket = this.Game.Connection.ProxySocket;
		if (proxySocket == null)
		{
		...
		proxySocket.SendMessage(new GClass269(GClass90.Log(string_3)));
	}

	[GeneratedCode("PropertyChanged.Fody", "3.2.3.0")]
	[DebuggerNonUserCode]
	protected void iIpojHigvGL(PropertyChangedEventArgs propertyChangedEventArgs_0)
	{
		PropertyChangedEventHandler propertyChanged = this.PropertyChanged;
		if (propertyChanged != null)
		{
	...
	public DateTimeOffset wdvoKamvDiv;
	...
	public readonly GClass846 gclass846_0;

	public readonly GClass844 smhomKoDhPA;
