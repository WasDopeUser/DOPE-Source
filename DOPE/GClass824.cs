...
public static class GClass824
{
	...
	{
		return GClass824.smethod_5(color_0, string_0, 0, 0, nullable_0, args);
	}
	...
	private static EntityRenderFragment smethod_5(Color color_0, string string_0, int int_0, int int_1, Color? nullable_0 = null, params object[] args)
	{
		...
		entityRenderFragment.Fill = ((color_0 == Color.Transparent) ? "" : GClass824.smethod_0(color_0));
		entityRenderFragment.Stroke = ((nullable_0 != null) ? GClass824.smethod_0(nullable_0.Value) : "");
		entityRenderFragment.Shape = string_0;
		entityRenderFragment.Extra = args.Where(new Func<object, bool>(GClass824.<>c.<>c_0.method_0)).Select(new Func<object, string>(GClass824.<>c.<>c_0.method_1)).ToList<string>();
		entityRenderFragment.ExtraF = args.Where(new Func<object, bool>(GClass824.<>c.<>c_0.method_2)).Select(new Func<object, float>(GClass824.<>c.<>c_0.method_3)).ToList<float>();
	...
	{
		return GClass824.smethod_7(color_0, int_0, int_0, nullable_0);
	}

	private static EntityRenderFragment smethod_7(Color color_0, int int_0, int int_1, Color? nullable_0 = null)
	{
		return GClass824.smethod_4(color_0, "rect", nullable_0, new object[]
		{
			(float)int_0,
			(float)int_1
		});
	...
	{
		return GClass824.smethod_4(color_0, "circle", nullable_0, new object[]
		{
			(float)int_0,
			(float)int_1
		});
	...
	{
		return GClass824.smethod_4(color_0, "path", nullable_0, new object[]
		{
			(float)int_0,
			float_0,
			float_1
	...
	{
		return GClass824.smethod_4(color_0, "text", nullable_0, new object[]
		{
			string_0,
			string_1,
			string_2
	...
	private static EntityDataRoot smethod_12(GClass823 gclass823_0, Map map_0, Ship ship_0)
	{
		EntityDataRoot entityDataRoot = GClass824.smethod_2(map_0, ship_0);
		Color color_ = MapUtils.smethod_13(map_0, ship_0);
		NpcShip npcShip = ship_0 as NpcShip;
		if (npcShip != null && (!(gclass823_0.Behavior ?? gclass823_0.gclass836_0).vmethod_8(npcShip) || npcShip.LeashedBy > 0))
		{
			color_ = Color.Gray;
		}
		...
		{
			GClass824.smethod_6(color_, 4, nullable_)
		};
	...
	{
		EntityDataRoot entityDataRoot = GClass824.smethod_2(map_0, collectible_0);
		Color color_ = MapUtils.smethod_13(map_0, collectible_0);
		entityDataRoot.Data = new List<EntityRenderFragment>
		{
			GClass824.smethod_6(color_, 3, null)
		};
		return entityDataRoot;
	}
	...
	{
		EntityDataRoot entityDataRoot = GClass824.smethod_2(map_0, gate_0);
		Color color = MapUtils.smethod_13(map_0, gate_0);
		entityDataRoot.Data = new List<EntityRenderFragment>
		{
			GClass824.smethod_6(color, 3, null),
			GClass824.smethod_9(Color.Transparent, 12, 3, new Color?(color))
		};
		return entityDataRoot;
	}
	...
	{
		return GClass824.smethod_16(0.5f, 0.5f, new EntityRenderFragment[]
		{
			GClass824.smethod_11(Color.Gray, "60px Arial", "center", map_0.MapName, null)
		});
	}

	private static EntityDataRoot smethod_18(GClass823 gclass823_0, Map map_0)
	{
		string text = string.Join("\r\n", gclass823_0.method_70());
		if (string.IsNullOrWhiteSpace(text))
		{
			return null;
		}
		return GClass824.smethod_16(0.98f, 0.1f, new EntityRenderFragment[]
		{
			GClass824.smethod_11(Color.Red, "30px Arial", "right", text, null)
		});
	}

	private static EntityDataRoot smethod_19(GClass823 gclass823_0)
	{
		string text = string.Format("{0} | CFG: {1} | FRM: {2}", gclass823_0.State.ToString(), gclass823_0.Hero.Config, gclass823_0.Hero.Formation.ToString());
		HeroPet pet = gclass823_0.Hero.Pet;
		if (pet != null && pet.IsAvailable)
		{
			text += " | PET: ";
			if (gclass823_0.Hero.Pet.IsEnabled)
			{
				text += gclass823_0.Hero.Pet.Mode.ToString();
			}
			else
			{
				text += "Off";
		...
		return GClass824.smethod_16(0.02f, 0.95f, new EntityRenderFragment[]
		{
			GClass824.smethod_11(Color.Red, "16px Arial", "left", text, null)
		});
	}
	...
	private static EntityDataRoot smethod_20(Map map_0, Ship ship_0)
	{
		...
		entityDataRoot.Data = new List<EntityRenderFragment>
		{
			GClass824.smethod_7(Color.FromArgb(150, Color.LightSlateGray), 120, 20, null),
			GClass824.smethod_7(Color.FromArgb(150, Color.LawnGreen), num, 16, null),
			GClass824.smethod_11(Color.FromArgb(150, Color.White), "12px Arial", "center", hpDisplay, null),
			GClass824.smethod_7(Color.FromArgb(150, Color.LightSlateGray), 120, 20, null),
			GClass824.smethod_7(Color.FromArgb(150, Color.DodgerBlue), num2, 16, null),
			GClass824.smethod_11(Color.FromArgb(150, Color.White), "12px Arial", "center", shieldDisplay, null)
		};
		...
		entityDataRoot.Data.Add(GClass824.smethod_11(Color.DarkRed, "13px Arial", "center", string_, null));
	...
	{
		EntityDataRoot entityDataRoot = GClass824.smethod_2(map_0, map_0.Hero);
		...
		if (map_0.Hero.MovementDestination != null)
		{
			...
			entityDataRoot.Data.Add(GClass824.smethod_10(Color.Transparent, 2, float_, float_2, new Color?(Color.RoyalBlue)));
		}
		entityDataRoot.Data.Add(GClass824.smethod_6(color_, 8, null));
		return entityDataRoot;
	}
	...
	private static EntityDataRoot smethod_22(Map map_0, CollidableRect collidableRect_0)
	{
		...
		return GClass824.smethod_15(map_0, (float)rectangle.X, (float)rectangle.Y, new EntityRenderFragment[]
		{
			GClass824.smethod_8(color_, (float)rectangle.Width / (float)mapSize.Width, (float)rectangle.Height / (float)mapSize.Height, null)
		});
	}
	...
	private static EntityDataRoot smethod_23(Map map_0, Asset asset_0)
	{
		...
		EntityDataRoot entityDataRoot = GClass824.smethod_2(map_0, asset_0);
		entityDataRoot.Data.Add(GClass824.smethod_9(color_, 3, 1, new Color?(Color.DarkGray)));
		return entityDataRoot;
	}

	public static MapViewData smethod_24(GClass823 gclass823_0, bool bool_0)
	{
		Map map = gclass823_0.Map;
		MapViewData mapViewData = new MapViewData();
		mapViewData.Background = GClass824.smethod_0(Color.Black);
		mapViewData.MapId = map.MapId;
		List<EntityDataRoot> entities = mapViewData.Entities;
		entities.Add(GClass824.smethod_17(map));
		if (bool_0)
		{
			...
			foreach (KeyValuePair<string, ICollidable> keyValuePair in map.Collidables)
			{
				...
				{
					list.Add(GClass824.smethod_22(map, collidableRect));
				}
			}
			foreach (KeyValuePair<int, Asset> keyValuePair2 in map.Assets)
			{
				list.Add(GClass824.smethod_23(map, keyValuePair2.Value));
			}
		}
		foreach (KeyValuePair<int, Gate> keyValuePair3 in map.Gates)
		{
			entities.Add(GClass824.smethod_14(map, keyValuePair3.Value));
		}
		foreach (KeyValuePair<string, Collectible> keyValuePair4 in map.Collectibles)
		{
			entities.Add(GClass824.smethod_13(map, keyValuePair4.Value));
		}
		...
		foreach (KeyValuePair<int, Ship> keyValuePair5 in map.Ships)
		{
			...
			{
				entities.Add(GClass824.smethod_12(gclass823_0, map, keyValuePair5.Value));
			}
		}
		if (selectedShip != null)
		{
			entities.Add(GClass824.smethod_12(gclass823_0, map, selectedShip));
		}
		entities.Add(GClass824.smethod_21(map));
		EntityDataRoot entityDataRoot = GClass824.smethod_18(gclass823_0, map);
		if (entityDataRoot != null)
		{
			entities.Add(entityDataRoot);
		}
		entities.Add(GClass824.smethod_20(map, map.Hero));
		if (selectedShip != null)
		{
			entities.Add(GClass824.smethod_20(map, selectedShip));
		}
		entities.Add(GClass824.smethod_19(gclass823_0));
		return mapViewData;
	}
}
