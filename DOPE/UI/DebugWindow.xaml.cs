...
namespace DOPE.UI
{
	public partial class DebugWindow : Window, INotifyPropertyChanged, IStyleConnector
	{
		...
		public DebugWindow()
		{
			...
			{
				commandViewModel.PropertyChanged += this.icXiShotHs;
			}
		...
		private void icXiShotHs(object sender, PropertyChangedEventArgs e)
		{
		...
		public void method_0<wB9ydE6PTYILp8Sdlr>(GClass84<wB9ydE6PTYILp8Sdlr> gclass84_0) where wB9ydE6PTYILp8Sdlr : GInterface6
		{
		...
		public void method_1()
		{
			...
			lock (@lock)
			{
				...
				this.Filtered = new ObservableCollection<TreeNode>(this.Filtered.Where(new Func<TreeNode, bool>(this.method_10)));
				BindingOperations.EnableCollectionSynchronization(this.Filtered, this._lock);
			}
		}
		...
		void IStyleConnector.Connect(int connectionId, object target)
		{
			if (connectionId == 6)
			{
				((CheckBox)target).Click += this.method_8;
			}
		}
