	...
	public class BasicBotStateInfo : INotifyPropertyChanged
	{
		...
		public string BotStateName
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_6);
			}
		}
		...
		public string BotControlState
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_4);
			}
		}
		...
		public string SessionId
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_74);
			}
		}
		...
		public string MapName
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.MapName);
			}
		}
		...
		public string NextProfileName
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_60);
			}
		}
		...
		public bool HasNextProfile
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_46);
			}
		}
		...
		public bool HasLicense
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_45);
			}
		}
		...
		public string LastError
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_52);
			}
		}
		...
		public bool TimeTableActive
		{
			...
			set
			{
				...
				this.<>OnPropertyChanged(Class3.propertyChangedEventArgs_94);
			}
		}
