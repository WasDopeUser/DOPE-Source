...
public class GClass872
{
	...
	private void method_0()
	{
		...
		this.vQaQcDaDje8(vector, 0U, vector, 4U, 4U);
		int num5 = 0;
		...
		this.vQaQcDaDje8(vector, 8U, vector, 12U, 4U);
		...
		this.vQaQcDaDje8(vector, 256U, this.vector_0, 0U, 512U);
		this.vQaQcDaDje8(vector, 768U, this.vector_1, 0U, 512U);
		for (int j = 0; j < 512; j++)
		{
	...
	private void vQaQcDaDje8(Vector<uint> vector_5, uint uint_2, Vector<uint> vector_6, uint uint_3, uint uint_4)
	{
		uint num = uint_3;
