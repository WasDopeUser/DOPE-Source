...
public class GClass719 : GInterface0
{
	...
	public GClass719(Vector<GClass710> vector_3 = null, Vector<GClass632> vector_4 = null, Vector<GClass544> vector_5 = null)
	{
		...
		if (vector_4 == null)
		{
			this.vector_2 = new Vector<GClass632>();
		}
		else
		{
	...
	public virtual void imethod_1(BinaryStream binaryStream_0)
	{
		...
		while ((long)num < (long)((ulong)num2))
		{
			GClass632 gclass3 = GClass86.smethod_2((int)binaryStream_0.smethod_1()) as GClass632;
	...
	{
		binaryStream_0.smethod_7(24746);
		this.vmethod_2(binaryStream_0);
	}

	protected virtual void vmethod_2(BinaryStream binaryStream_0)
	{
		binaryStream_0.smethod_7(10055);
		...
		foreach (GClass632 gclass3 in this.vector_2)
		{
	...
	public Vector<GClass632> vector_2;
}
