...
public sealed class GClass861 : IDisposable
{
	...
	public GClass861()
	{
		...
		this.window_0 = new GClass861.Window();
		base..ctor();
	...
	{
		this.int_0++;
		if (!GClass861.RegisterHotKey(this.window_0.Handle, this.int_0, (uint)genum13_0, (uint)keys_0))
		{
	...
	public void Dispose()
	{
		...
		{
			GClass861.UnregisterHotKey(this.window_0.Handle, i);
		}
	...
	private GClass861.Window window_0;
	...
	private class Window : NativeWindow, IDisposable
	{
		...
		{
			base.WndProc(ref m);
			if (m.Msg == GClass861.Window.int_0)
			{
