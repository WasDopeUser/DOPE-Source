...
public class GClass778 : GInterface0
{
	...
	public GClass778(int int_4 = 0, int int_5 = 0, int int_6 = 0, int int_7 = 0, Vector<GClass326> vector_1 = null)
	{
		...
		if (vector_1 == null)
		{
			this.vector_0 = new Vector<GClass326>();
			return;
		}
	...
	public virtual void imethod_1(BinaryStream binaryStream_0)
	{
		...
		while (i < num)
		{
			GClass326 gclass = (GClass326)GClass86.smethod_2((int)binaryStream_0.smethod_1());
	...
	public virtual void imethod_2(BinaryStream binaryStream_0)
	{
		...
		foreach (GClass326 gclass in this.vector_0)
		{
	...
	public Vector<GClass326> vector_0;
}
