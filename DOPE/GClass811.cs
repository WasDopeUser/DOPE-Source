...
public static class GClass811
{
	...
	public static PointF smethod_1(float float_0, float float_1, float float_2, PointF pointF_0, PointF pointF_1)
	{
		PointF pointF;
		PointF pointF2;
		int num = GClass811.smethod_3(float_0, float_1, float_2, pointF_0, pointF_1, out pointF, out pointF2);
		if (num == 1)
		{
			return pointF;
		}
		...
		double num2 = GClass811.smethod_2(pointF, pointF_0);
		double num3 = GClass811.smethod_2(pointF2, pointF_0);
		if (num2 < num3)
		{
			return pointF;
		}
	...
	public static Vector2? smethod_5(Vector2 vector2_0, Vector2 vector2_1, Vector2 vector2_2, Vector2 vector2_3)
	{
		...
		float num4 = num2 / num;
		float num5 = num3 / num;
		if (GClass811.smethod_4(num4, vector2_0.X, vector2_1.X) && GClass811.smethod_4(num4, vector2_2.X, vector2_3.X) && GClass811.smethod_4(num5, vector2_0.Y, vector2_1.Y) && GClass811.smethod_4(num5, vector2_2.Y, vector2_3.Y))
		{
	...
	{
		Vector2? vector = GClass811.smethod_5(vector2_0, vector2_1, vector2_2, vector2_3);
	...
	public static bool smethod_7(Rectangle rectangle_0, Vector2 vector2_0, Vector2 vector2_1, out Vector2 vector2_2)
	{
		...
		if (!rectangle_0.Contains(new Point((int)vector2_0.X, (int)vector2_0.Y)) && !rectangle_0.Contains(new Point((int)vector2_1.X, (int)vector2_1.Y)))
		{
			...
			return GClass811.smethod_6(vector, vector2, vector2_0, vector2_1, out vector2_2) || GClass811.smethod_6(vector2, vector4, vector2_0, vector2_1, out vector2_2) || GClass811.smethod_6(vector4, vector3, vector2_0, vector2_1, out vector2_2) || GClass811.smethod_6(vector3, vector, vector2_0, vector2_1, out vector2_2);
		}
		return true;
	}
	...
	{
		GClass811.<>c__DisplayClass8_0 CS$<>8__locals1;
		...
		GClass811.smethod_14(GClass811.smethod_5(vector, vector2, CS$<>8__locals1.vector2_0, vector2_1), ref CS$<>8__locals1);
		GClass811.smethod_14(GClass811.smethod_5(vector2, vector4, CS$<>8__locals1.vector2_0, vector2_1), ref CS$<>8__locals1);
		GClass811.smethod_14(GClass811.smethod_5(vector4, vector3, CS$<>8__locals1.vector2_0, vector2_1), ref CS$<>8__locals1);
		GClass811.smethod_14(GClass811.smethod_5(vector3, vector, CS$<>8__locals1.vector2_0, vector2_1), ref CS$<>8__locals1);
	...
	public static float smethod_10(Vector2 vector2_0, Vector2 vector2_1, Vector2 vector2_2)
	{
		...
		float num2;
		float num3;
		if (!GClass811.smethod_9(vector2_0, vector2_1, out num, out num2, out num3))
		{
			return 0f;
		}
	...
	public static double smethod_13(Vector2 vector2_0, Vector2 vector2_1, Vector2 vector2_2, bool bool_0)
	{
		if (bool_0)
		{
			if (GClass811.smethod_11(vector2_0, vector2_1, vector2_2) > 0.0)
			{
				return (double)Vector2.Distance(vector2_1, vector2_2);
			}
			if (GClass811.smethod_11(vector2_1, vector2_0, vector2_2) > 0.0)
			{
		...
		return Math.Abs(GClass811.smethod_12(vector2_0, vector2_1, vector2_2) / (double)num);
	}

	[CompilerGenerated]
	internal static void smethod_14(Vector2? nullable_0, ref GClass811.<>c__DisplayClass8_0 <>c__DisplayClass8_0_0)
	{
