...
public class GClass849 : Interface0
{
	private static VNbQSUkNHIKoMW3elgq smethod_0<VNbQSUkNHIKoMW3elgq>(ManagementObject managementObject_0, string string_0)
	{
		GClass849.<>c__DisplayClass0_0<VNbQSUkNHIKoMW3elgq> CS$<>8__locals1 = new GClass849.<>c__DisplayClass0_0<VNbQSUkNHIKoMW3elgq>();
		CS$<>8__locals1.property = string_0;
		PropertyData propertyData = managementObject_0.Properties.Cast<PropertyData>().FirstOrDefault(new Func<PropertyData, bool>(CS$<>8__locals1.rNtiDiErnGa));
		return (VNbQSUkNHIKoMW3elgq)((object)((propertyData != null) ? propertyData.Value : null));
	}
	...
	public void imethod_0(HashSet<string> hashSet_0 = null)
	{
		...
		foreach (ManagementBaseObject managementBaseObject in new ManagementObjectSearcher(scope, new ObjectQuery("SELECT * FROM MSFT_NetIPAddress")).Get())
		{
			...
			string item = GClass849.smethod_0<string>(managementObject, "IPAddress");
			if ((long)NetworkInterface.LoopbackInterfaceIndex == (long)((ulong)GClass849.smethod_0<uint>(managementObject, "InterfaceIndex")) & (GClass849.smethod_1(GClass849.smethod_0<string>(managementObject, "PreferredLifetime"), TimeSpan.FromHours(24.0)) && (hashSet_0 == null || hashSet_0.Contains(item))))
			{
	...
	public void imethod_1(string[] string_0)
	{
		...
		foreach (ManagementBaseObject managementBaseObject in new ManagementObjectSearcher(scope, new ObjectQuery("SELECT * FROM MSFT_NetIPAddress")).Get())
		{
			string item = GClass849.smethod_0<string>((ManagementObject)managementBaseObject, "IPAddress");
			hashSet.Remove(item);
		}
