...
public static class GClass879
{
	public static string smethod_0(string string_1)
	{
		return string.Format(GClass879.string_0, string_1);
	}
	...
	public static string smethod_1(string string_1, string string_2 = null)
	{
		if (string_2 == null)
		{
			return GClass879.smethod_0(string_1) + "/indexInternal.es";
		}
		return GClass879.smethod_0(string_1) + "/indexInternal.es?action=" + string_2;
	}

	public static string smethod_2(string string_1)
	{
		return GClass879.smethod_1(string_1, "internalMapRevolution");
	}

	public static string Maps(string server)
	{
		return GClass879.smethod_0(server) + "/spacemap/xml/maps.php";
	}
	...
	{
		return GClass879.smethod_1(string_1, "externalLogout");
	}

	public static string smethod_5(string string_1)
	{
		return GClass879.smethod_0(string_1) + "/ajax/shop.php";
	}
	...
	{
		return GClass879.smethod_0(string_1) + "/flashAPI/dailyLogin.php?doBook=1";
	}

	public static string smethod_8(string string_1)
	{
		return GClass879.smethod_0(string_1) + "/ajax/instances.php";
	}

	public static string smethod_9(string string_1)
	{
		return GClass879.smethod_0(string_1) + "/flashAPI/inventory.php";
	}

	public static string smethod_10(string string_1)
	{
		return GClass879.smethod_1(string_1, "internalNanoTechFactory");
	}

	public static string smethod_11(string string_1)
	{
		return GClass879.smethod_0(string_1) + "/ajax/nanotechFactory.php";
	}
	...
	static GClass879()
	{
		...
		GClass879.string_0 = "https://{0}.darkorbit.com";
	}
