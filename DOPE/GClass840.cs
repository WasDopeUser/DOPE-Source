...
public class GClass840 : GClass838
{
	...
	public override Vector2? vmethod_20(Vector2 vector2_1, out Gate gate_0, bool bool_2 = false, bool bool_3 = true)
	{
		gate_0 = null;
		List<KeyValuePair<int, Gate>> list = base.C.Map.Gates.Where(new Func<KeyValuePair<int, Gate>, bool>(this.method_17)).OrderBy(new Func<KeyValuePair<int, Gate>, int>(GClass840.<>c.<>c_0.method_0)).ToList<KeyValuePair<int, Gate>>();
		if (list.Count != 2)
		{
			return null;
		}
	...
	[CompilerGenerated]
	private bool method_17(KeyValuePair<int, Gate> keyValuePair_0)
	{
