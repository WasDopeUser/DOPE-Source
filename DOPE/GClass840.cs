...
public static class GClass840
{
	...
	public static extern void GetSystemInfo(out GClass840.GStruct0 gstruct0_0);

	[DllImport("kernel32.dll", SetLastError = true)]
	public static extern int VirtualQueryEx(IntPtr intptr_0, IntPtr intptr_1, out GClass840.GStruct1 gstruct1_0, uint uint_0);

	[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx", SetLastError = true)]
	public static extern int VirtualQueryEx_1(IntPtr intptr_0, IntPtr intptr_1, out GClass840.GStruct2 gstruct2_0, uint uint_0);
	...
	{
		bool flag;
		return !Environment.Is64BitOperatingSystem || ((Environment.OSVersion.Version.Major > 5 || (Environment.OSVersion.Version.Major == 5 && Environment.OSVersion.Version.Minor >= 1)) && (GClass840.IsWow64Process(intptr_0, out flag) && flag));
	}
	...
	public static GClass840.GStruct2 smethod_2(IntPtr intptr_0, IntPtr intptr_1, out int int_0)
	{
		int_0 = 0;
		GClass840.GStruct2 result = default(GClass840.GStruct2);
		if (GClass840.smethod_1())
		{
			GClass840.GStruct1 gstruct = default(GClass840.GStruct1);
			if (GClass840.VirtualQueryEx(intptr_0, intptr_1, out gstruct, (uint)Marshal.SizeOf(typeof(GClass840.GStruct1))) != 0)
			{
		...
		{
			if (GClass840.VirtualQueryEx_1(intptr_0, intptr_1, out result, (uint)Marshal.SizeOf(typeof(GClass840.GStruct2))) != 0)
			{
				return result;
			}
			int_0 = Marshal.GetLastWin32Error();
