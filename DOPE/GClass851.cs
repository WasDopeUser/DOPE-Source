...
public class GClass851 : GClass847
{
	public GClass851(GClass823 gclass823_1)
	{
		Class13.Gj4N3WdzaR1LY();
		base..ctor(gclass823_1, "HangarInfoProvider");
	}
	...
	public override void Execute()
	{
		...
		List<string> list = hangarList.data.ret.hangars.Select(new Func<GClass28.GClass32, string>(GClass851.<>c.<>c_0.method_0)).ToList<string>();
		if (list != null && list.Any<string>() && hangar != null)
		{
			...
			GClass28.GClass32 gclass = hangarList.data.ret.hangars.FirstOrDefault(new Func<GClass28.GClass32, bool>(GClass851.<>c.<>c_0.method_1));
			string activeHangar;
			if (gclass == null)
			{
				activeHangar = null;
