...
public class GClass851 : GClass848
{
	[CompilerGenerated]
	...
	public GClass851(GClass824 gclass824_1)
	{
		Class13.igxcIukzfpare();
		base..ctor(gclass824_1, "GgSpinner");
	}
	...
	protected void method_4()
	{
		foreach (DarkOrbitWebAPI.jumpgateGate jumpgateGate in this.method_2().gates)
		{
			if (jumpgateGate.current == jumpgateGate.total && !jumpgateGate.prepared)
			{
				bool argument = false;
				string text;
				string argument2 = GClass851.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
	...
	protected bool method_6(out string string_0, out int int_0)
	{
		...
		if (account != null && account.Spinner_StopABG)
		{
			...
			{
				string text;
				string a = GClass851.dictionary_0.TryGetValue(jumpgateGate.id, out text) ? text : "unknown";
		...
		{
			string text3;
			string text2 = GClass851.dictionary_0.TryGetValue(jumpgateGate2.id, out text3) ? text3 : "unknown";
			bool flag2;
	...
	public int method_7()
	{
		...
		GClass824 context = base.Context;
	...
	{
		GClass851.<>c__DisplayClass12_0 CS$<>8__locals1 = new GClass851.<>c__DisplayClass12_0();
		int_0 = 0;
		int num;
		...
		{
			GClass814.smethod_6(web.Server, web.Uid, web.Sid, "multiEnergy"),
	...
	{
		DarkOrbitWebAPI web = base.Context.Game.Web;
		return web.Get(GClass814.smethod_6(web.Server, web.Uid, web.Sid, "setupGate") + "&gateID=" + int_0.ToString(), null).Data.IsSuccessStatusCode;
	}
	...
	protected bool method_11(DarkOrbitWebAPI.GalaxyGatesInfoUpdate galaxyGatesInfoUpdate_0)
	{
		...
		{
			GClass851.<>c__DisplayClass15_0 CS$<>8__locals1 = new GClass851.<>c__DisplayClass15_0();
		...
		{
			GClass851.<>c__DisplayClass15_1 CS$<>8__locals2 = new GClass851.<>c__DisplayClass15_1();
	...
	public override bool vmethod_0()
	{
		...
		AccountSettings account = base.Context.Account;
		return account == null || !account.Spinner_UsePhoenix || GClass827.list_0.Contains(activeHangarName);
	}
	...
	{
		Class13.igxcIukzfpare();
		GClass851.dictionary_0 = new Dictionary<int, string>
		{
			{
				1,
				"alpha"
