...
{
	public static bool LtmpSfVly7(this byte[] byte_0, int int_0, int int_1, out int int_2)
	{
		bool flag = false;
	...
	public static bool smethod_0(this string string_1)
	{
		return Class4.string_0.Contains(string_1, StringComparer.OrdinalIgnoreCase);
	}

	public static Class4.Enum0 nMapjOjryE(string string_1)
	{
		IPAddress ipaddress;
	...
	public static void smethod_1(this Socket socket_0)
	{
		if (socket_0 == null)
		{
			return;
	...
	public static void smethod_2(this SocketAsyncEventArgs socketAsyncEventArgs_0)
	{
